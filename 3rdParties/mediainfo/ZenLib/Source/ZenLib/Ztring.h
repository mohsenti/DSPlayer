...
//***************************************************************************
    ...
    class Ztring
            : public tstring  //for details about undocumented methods see http://www.sgi.com/tech/stl/basic_string.html
    {
    public :
        ...
        Ztring &
        Date_From_Numbers(const int8u Year, const int8u Month, const int8u Day, const int8u Hour, const int8u Minute,
                          const int8u Second);
        ...
        static Ztring ToZtring_From_Local(const char *S, size_type Start, size_type Length) {
            return Ztring().From_Local(S, Start, Length);
        };
        ...
        ///         "" if not found
        Ztring
        SubString(const tstring &Begin, const tstring &End, size_type Pos = 0, ztring_t Options = Ztring_Nothing) const;
        ...
        size_type FindAndReplace(const tstring &ToFind, const tstring &ReplaceBy, size_type Pos = 0,
                                 ztring_t Options = Ztring_Nothing); //Remplace une chaine par une autre
        ...
        bool
        Compare(const Ztring &ToCompare, const Ztring &Comparator = __T("=="), ztring_t Options = Ztring_Nothing) const;
    };
