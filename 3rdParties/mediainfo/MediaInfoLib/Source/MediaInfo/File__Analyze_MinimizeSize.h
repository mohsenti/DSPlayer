...
public :
    ...
    void Open_Buffer_OutOfBand(File__Analyze *Sub) {
        if (Element_Offset <= Element_Size)
            Open_Buffer_OutOfBand(Sub, Buffer + Buffer_Offset + (size_t) Element_Offset, (size_t)(
    ...
    void Open_Buffer_Continue(File__Analyze *Sub) {
        if (Element_Offset <= Element_Size)
            Open_Buffer_Continue(Sub, Buffer + Buffer_Offset + (size_t) Element_Offset, (size_t)(
                    Element_Size - Element_Offset));
        Element_Offset = Element_Size;
    }
...
#define Info_DFP4(_DITS, _INFO, _NAME) Element_Offset+=4
    ...
    inline void Skip_GUID(const char *) {
        if (Element_Offset + 16 > Element_Size) {
            Trusted_IsNot();
            return;
        }
        Element_Offset += 16;
...
#define Info_GUID(_INFO, _NAME) int128u _INFO; Get_GUID(_INFO, _NAME)
    ...
    inline void Skip_UUID(const char *) {
        if (Element_Offset + 16 > Element_Size) {
            Trusted_IsNot();
            return;
        }
...
#define Info_VL(Vlc, Info, Name) Skip_VL_(Vlc)
    ...
    inline void Skip_C1(const char *) {
    ...
    inline void Skip_C2(const char *) {
    ...
    inline void Skip_C3(const char *) {
    ...
    inline void Skip_C4(const char *) {
    ...
    inline void Skip_C5(const char *) {
    ...
    inline void Skip_C6(const char *) {
    ...
    inline void Skip_C7(const char *) {
    ...
    inline void Skip_C8(const char *) {
...
#define Info_C8(_INFO, _NAME) int64u _INFO; Get_C8(_INFO, _NAME)
    ...
    void Skip_Local(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
    ...
    void Skip_ISO_6937_2(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
    ...
    void Skip_String(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
    ...
    void Skip_UTF8(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
    ...
    void Skip_UTF16B(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
    ...
    void Skip_UTF16L(int64u Bytes, const char *) {
        if (Element_Offset + Bytes > Element_Size) {
            Trusted_IsNot();
            return;
        }
...
#define TEST_TB_END() \
    ...
    inline void
    Fill(stream_t StreamKind, size_t StreamPos, size_t Parameter, const wchar_t *Value, size_t Value_Size = Unlimited,
         bool Replace = false) {
    ...
    inline void Fill(stream_t StreamKind, size_t StreamPos, size_t Parameter, float32 Value, int8u AfterComma = 3,
                     bool Replace = false);
    ...
    inline void
    Fill(stream_t StreamKind, size_t StreamPos, const char *Parameter, const char *Value, size_t Value_Size = Unlimited,
         bool Utf8 = true, bool Replace = false) {
        if (Utf8)
            Fill(StreamKind, StreamPos, Parameter, Ztring().From_UTF8(Value, Value_Size), Replace);
        else Fill(StreamKind, StreamPos, Parameter, Ztring().From_Local(Value, Value_Size), Replace);
    ...
    inline void Fill(stream_t StreamKind, size_t StreamPos, const char *Parameter, float32 Value, int8u AfterComma = 3,
                     bool Replace = false) {
        Fill(StreamKind, StreamPos, Parameter, Ztring::ToZtring(Value, AfterComma), Replace);
    }

    inline void Fill(stream_t StreamKind, size_t StreamPos, const char *Parameter, float64 Value, int8u AfterComma = 3,
                     bool Replace = false) {
        Fill(StreamKind, StreamPos, Parameter, Ztring::ToZtring(Value, AfterComma), Replace);
    }

    inline void Fill(stream_t StreamKind, size_t StreamPos, const char *Parameter, float80 Value, int8u AfterComma = 3,
                     bool Replace = false) {
        Fill(StreamKind, StreamPos, Parameter, Ztring::ToZtring(Value, AfterComma), Replace);
    }
...
public:
    void
    TestContinuousFileNames(size_t CountOfFiles = 24, Ztring FileExtension = Ztring(), bool SkipComputeDelay = false);
