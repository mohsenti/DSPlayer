...
//---------------------------------------------------------------------------
    void File_Eia608::Streams_Fill() {
        ...
        if (!HasContent && ServiceDescriptors && ServiceDescriptors->ServiceDescriptors608.find(cc_type) !=
                                                 ServiceDescriptors->ServiceDescriptors608.end()) {
            TextMode = 0;
            DataChannelMode = 0;
            ...
            if (Streams[Pos] || (Pos < 2 && Config->File_Eia608_DisplayEmptyStream_Get())) {
                ...
                if (Config->ParseSpeed >= 1.0) {
                    Fill(Stream_Text, StreamPos_Last, "CaptionServiceContent_IsPresent",
                         DataDetected[Pos + 1] ? "Yes" : "No", Unlimited, true,
                         true); //1 bit per service, starting at 1
                    (*Stream_More)[Stream_Text][StreamPos_Last](Ztring().From_Local("CaptionServiceContent_IsPresent"),
                                                                Info_Options) = __T("N NT");
                }
                if (ServiceDescriptors) {
                    servicedescriptors608::iterator ServiceDescriptor = ServiceDescriptors->ServiceDescriptors608.find(
                            cc_type);
    ...
    void File_Eia608::Read_Buffer_Init() {
        ...
        if (MuxingMode == (int8u) -1) {
            ...
            if (StreamIDs_Size >= 2 && ParserIDs[StreamIDs_Size - 2] == MediaInfo_Parser_Scc)
                MuxingMode = 10; //SCC
            if (StreamIDs_Size >= 3 && ParserIDs[StreamIDs_Size - 3] == MediaInfo_Parser_Mpeg4 &&
                ParserIDs[StreamIDs_Size - 2] == MediaInfo_Parser_Mpeg4)
    ...
    void File_Eia608::XDS(int8u cc_data_1, int8u cc_data_2) {
        if (cc_data_1 && cc_data_1 < 0x10 && cc_data_1 % 2 == 0) {
            ...
            for (XDS_Level = 0; XDS_Level < XDS_Data.size(); XDS_Level++)
                if (XDS_Data[XDS_Level].size() >= 2 && XDS_Data[XDS_Level][0] == cc_data_1 &&
                    XDS_Data[XDS_Level][1] == cc_data_2)
                    break;
...
//---------------------------------------------------------------------------
    void File_Eia608::XDS_Current() {
        switch (XDS_Data[XDS_Level][1]) {
            case 0x03 :
                XDS_Current_ProgramName();
                break;
            case 0x05 :
                XDS_Current_ContentAdvisory();
                break;
            case 0x08 :
                XDS_Current_CopyAndRedistributionControlPacket();
                break;
            default   :;
        }
    }
            ...
            case 1:
                switch (XDS_Data[XDS_Level][3] & 0x7) //g2g1g0
                {
                    case 0 :
                        ...
                        break;
                    case 1 :
                        ContentAdvisory = "TV-Y";
                        break;
                    case 2 :
                        ContentAdvisory = "TV-Y7";
                        break;
                    case 3 :
                        ContentAdvisory = "TV-G";
                        break;
                    case 4 :
                        ContentAdvisory = "TV-PG";
                        break;
                    case 5 :
...
//---------------------------------------------------------------------------
    void File_Eia608::XDS_PublicService() {
        switch (XDS_Data[XDS_Level][1]) {
            case 0x01 :
                XDS_PublicService_NationalWeatherService();
                break;
            default   :;
        }
    }
...
//---------------------------------------------------------------------------
    void File_Eia608::Special(int8u cc_data_1, int8u cc_data_2) {
        ...
        if (cc_data_1 >= 0x10 && cc_data_1 <= 0x17 && cc_data_2 >= 0x40) {
            ...
            switch (cc_data_1) {
                case 0x10 :
                    Special_10(cc_data_2);
                    break;
                case 0x11 :
                    Special_11(cc_data_2);
                    break;
                case 0x12 :
                    Special_12(cc_data_2);
                    break;
                case 0x13 :
                    Special_13(cc_data_2);
                    break;
                case 0x14 :
                    Special_14(cc_data_2);
                    break;
                case 0x17 :
                    Special_17(cc_data_2);
                    break;
                default   :
                    Illegal(cc_data_1, cc_data_2);
            }
        }
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_10(int8u cc_data_2) {
        switch (cc_data_2) {
            ...
            case 0x20 :
                break;  //Background White, Opaque
            case 0x21 :
                break;  //Background White, Semi-transparent
            case 0x22 :
                break;  //
            case 0x23 :
                break;  //
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_11(int8u cc_data_2) {
        ...
        switch (cc_data_2) {
            ...
            case 0x33 :
                Character_Fill(L'\u00BF');
                break;  //interogation mark inverted
            case 0x34 :
                Character_Fill(L'\u00A9');
                break;  //Trademark symbol
            case 0x35 :
                Character_Fill(L'\u00A2');
                break;  //Cents sign
            case 0x36 :
                Character_Fill(L'\u00A3');
                break;  //Pounds Sterling sign
            case 0x37 :
                Character_Fill(L'\u266A');
                break;  //Music note
            case 0x38 :
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_12(int8u cc_data_2) {
        ...
        switch (cc_data_2) {
            ...
            case 0x24 :
                Character_Fill(L'\u00DC');
                break;  //U withdiaeresis or umlaut
            case 0x25 :
                Character_Fill(L'\u00FC');
                break;  //u with diaeresis or umlaut
            case 0x26 :
                Character_Fill(L'\'');
                break;  //opening single quote
            case 0x27 :
                Character_Fill(L'\u00A1');
            ...
            case 0x2E :
                Character_Fill(L'\u2120');
                break;  //opening double quotes
            case 0x2F :
                Character_Fill(L'\u2121');
                break;  //closing double quotes
            case 0x30 :
                Character_Fill(L'\u00C0');
                break;  //A with grave accent
            case 0x31 :
                Character_Fill(L'\u00C2');
                break;  //A with circumflex accent
            case 0x32 :
                Character_Fill(L'\u00C7');
                break;  //C with cedilla
            case 0x33 :
                Character_Fill(L'\u00C8');
                break;  //E with grave accent
            case 0x34 :
                Character_Fill(L'\u00CA');
                break;  //E with circumflex accent
            case 0x35 :
                Character_Fill(L'\u00CB');
                break;  //E with diaeresis or umlaut mark
            case 0x36 :
                Character_Fill(L'\u00EB');
                break;  //e with diaeresis or umlaut mark
            case 0x37 :
                Character_Fill(L'\u00CE');
                break;  //I with circumflex accent
            case 0x38 :
                Character_Fill(L'\u00CF');
                break;  //I with diaeresis or umlaut mark
            case 0x39 :
                Character_Fill(L'\u00EF');
                break;  //i with diaeresis or umlaut mark
            case 0x3A :
                Character_Fill(L'\u00D4');
                break;  //O with circumflex
            case 0x3B :
                Character_Fill(L'\u00D9');
                break;  //U with grave accent
            case 0x3C :
                Character_Fill(L'\u00F9');
                break;  //u with grave accent
            case 0x3D :
                Character_Fill(L'\u00D9');
                break;  //U with circumflex accent
            case 0x3E :
                Character_Fill(L'\u00AB');
                break;  //opening guillemets
            case 0x3F :
                Character_Fill(L'\u00BB');
                break;  //closing guillemets
            default   :
                Illegal(0x12, cc_data_2);
        }
    }
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_13(int8u cc_data_2) {
        ...
        switch (cc_data_2) {
            ...
            case 0x22 :
                Character_Fill(L'\u00CD');
                break;  //I with acute accent
            case 0x23 :
                Character_Fill(L'\u00CC');
                break;  //I with grave accent
            case 0x24 :
                Character_Fill(L'\u00EC');
                break;  //i with grave accent
            case 0x25 :
                Character_Fill(L'\u00D2');
                break;  //O with grave accent
            case 0x26 :
                Character_Fill(L'\u00E2');
                break;  //o with grave accent
            case 0x27 :
            ...
            case 0x30 :
                Character_Fill(L'\u00C4');
                break;  //A with diaeresis or umlaut mark
            case 0x31 :
                Character_Fill(L'\u00E4');
                break;  //a with diaeresis or umlaut mark
            case 0x32 :
                Character_Fill(L'\u00D6');
                break;  //o with diaeresis or umlaut mark
            case 0x33 :
                Character_Fill(L'\u00F6');
                break;  //o with diaeresis or umlaut mark
            case 0x34 :
                Character_Fill(L'\u00DF');
                break;  //eszett (mall sharp s)
            case 0x35 :
                Character_Fill(L'\u00A5');
                break;  //yen
            case 0x36 :
                Character_Fill(L'\u00A4');
                break;  //non-specific currency sign
            case 0x37 :
                Character_Fill(L'\u23D0');
                break;  //Vertical bar
            case 0x38 :
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_14(int8u cc_data_2) {
        ...
        switch (cc_data_2) {
            ...
            case 0x21 :
                if (Streams[StreamPos]->x)
                    Streams[StreamPos]->x--;
                (Streams[StreamPos]->InBack ? Streams[StreamPos]->CC_NonDisplayed
                                            : Streams[StreamPos]->CC_Displayed)[Streams[StreamPos]->y][Streams[StreamPos]->x].Value = L' '; //Clear the character
                if (!Streams[StreamPos]->InBack)
                    HasChanged();
                break; //BS  - Backspace
            case 0x22 :
                Special_14(0x2D); //Found 1 file with AOF and non CR
                break; //AOF - Alarm Off
            case 0x23 :
                break; //AON - Alarm On
            case 0x24 :
                for (size_t Pos = Streams[StreamPos]->x; Pos < Eia608_Columns; Pos++)
                    (Streams[StreamPos]->InBack ? Streams[StreamPos]->CC_NonDisplayed
                                                : Streams[StreamPos]->CC_Displayed)[Streams[StreamPos]->y][Pos].Value = L' '; //Clear up to the end of line
                if (!Streams[StreamPos]->InBack)
                    HasChanged();
            ...
            case 0x2D :
                for (size_t Pos = 1; Pos < Streams[StreamPos]->RollUpLines; Pos++) {
                    if (Streams[StreamPos]->y >= Streams[StreamPos]->RollUpLines - Pos &&
                        Streams[StreamPos]->y - Streams[StreamPos]->RollUpLines + Pos + 1 < Eia608_Rows)
                        Streams[StreamPos]->CC_Displayed[Streams[StreamPos]->y - Streams[StreamPos]->RollUpLines +
                                                         Pos] = Streams[StreamPos]->CC_Displayed[Streams[StreamPos]->y -
                                                                                                 Streams[StreamPos]->RollUpLines +
                                                                                                 Pos + 1];
                }
                for (size_t Pos_X = 0; Pos_X < Eia608_Columns; Pos_X++) {
            ...
            case 0x2E :
                for (size_t Pos_Y = 0; Pos_Y < Streams[StreamPos]->CC_NonDisplayed.size(); Pos_Y++)
            ...
            case 0x2F :
                Streams[StreamPos]->CC_Displayed.swap(Streams[StreamPos]->CC_NonDisplayed);
                HasChanged();
                Streams[StreamPos]->Synched = false;
                break; //EOC - End of Caption
            default   :
                Illegal(0x14, cc_data_2);
        }
    }
...
//---------------------------------------------------------------------------
    void File_Eia608::Special_17(int8u cc_data_2) {
        ...
        switch (cc_data_2) {
            ...
            case 0x24 :
                break;  //Select the standard line 21 character set in normal size
            case 0x25 :
                break;  //Select the standard line 21 character set in double size
            case 0x26 :
                break;  //Select the first private character set
            case 0x27 :
                break;  //Select the second private character set
            case 0x28 :
                break;  //Select the People's Republic of China character set: GB 2312-80
            case 0x29 :
                break;  //Select the Korean Standard character set: KSC 5601-1987
            case 0x2A :
                break;  //Select the first registered character set
                //CEA-608-E, section 6.2
            case 0x2D :
            ...
            case 0x2F :
                break;  //Foreground Black Underline
            default   :
                Illegal(0x17, cc_data_2);
        }
    }
    ...
    void File_Eia608::Standard(int8u Character) {
        switch (Character) {
            ...
            case 0x7E :
                ...
                break; //n tilde
            case 0x7F :
                Character_Fill(L'\x25A0');
                break; //Solid block
            default   :
                Illegal(0x00, Character);
        }
    }
...
#if MEDIAINFO_EVENTS
        size_t StreamPos = TextMode * 2 + DataChannelMode;
        if (StreamPos < Streams.size() && Streams[StreamPos]) EVENT_BEGIN (Eia608, CC_Content, 0)
