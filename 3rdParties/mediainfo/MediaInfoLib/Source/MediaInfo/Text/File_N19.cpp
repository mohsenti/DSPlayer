...
//---------------------------------------------------------------------------
    static const char *N19_CharacterCodeTable(int16u CCT) {
        switch (CCT) {
            case 0x3030 :
                return "Latin, ISO 6937-2";
            case 0x3031 :
                return "Latin/Cyrillic, ISO 8859-5";
            case 0x3032 :
                return "Latin/Arabic, ISO 8859-6";
            case 0x3033 :
                return "Latin/Greek, ISO 8859-7";
            case 0x3034 :
...
//---------------------------------------------------------------------------
    static float64 N19_DiskFormatCode_FrameRate(int64u DFC) {
        switch (DFC) {
            case 0x53544C32332E3031LL :
                return (float64) 24000 / (float64) 1001;
            case 0x53544C32342E3031LL :
                return (float64) 24;
            case 0x53544C32352E3031LL :
                return (float64) 25;
            case 0x53544C32392E3031LL :
                return (float64) 30000 / (float64) 1001;
            case 0x53544C33302E3031LL :
                return (float64) 30;
            case 0x53544C34372E3031LL :
                return (float64) 48000 / (float64) 1001;
            case 0x53544C34382E3031LL :
                return (float64) 48;
            case 0x53544C35350E3031LL :
                return (float64) 50;
            case 0x53544C35392E3031LL :
                return (float64) 60000 / (float64) 1001;
            case 0x53544C36302E3031LL :
                return (float64) 60;
            default                   :
                return (float64) 0;
        }
...
//---------------------------------------------------------------------------
    void File_N19::FileHeader_Parse() {
        ...
        int16u LC;
        int8u DSC, TCS;
        Info_C3   (CPN, "CPN - Code Page Number");
        Param_Info1(N19_CodePageNumber(CPN));
        Get_C8(DFC, "DFC - Disk Format Code");
        Param_Info1(N19_DiskFormatCode_FrameRate(DFC));
        Get_C1(DSC, "DSC - Display Standard Code");
        Param_Info1(N19_DisplayStandardCode(DSC));
        Get_C2(CCT, "CCT - Character Code Table number");
        Param_Info1(N19_CharacterCodeTable(CCT));
        Get_C2(LC, "LC - Language Code");
        Param_Info1(N19_LanguageCode(LC));
        ...
        FILLING_BEGIN() ;
            ...
            if (TCO_Latest != (int64u) -1 && TCI != TCO_Latest) {
                EVENT_BEGIN (Global, SimpleText, 0)
                    Event.DTS = ((int64u) (TCO_Latest)) *
                                1000000; // "-TCP_Offset" removed for the moment. TODO: find a way for when TCP_Offset should be removed and when it should not
                    Event.PTS = Event.DTS;
            ...
            for (; Row_Pos < Row_Max; ++Row_Pos) {
                ...
                switch (JC) {
                    ...
                    case 0 :    //Unchanged
                        ...
                        break;
                    case 2 :    //Centered
                        for (int8u Column_Pos = (Column_Max - (int8u) List[Row_Pos - VP].size()) / 2;
                             Column_Pos < Column_Max; ++Column_Pos) {
                            List[Row_Pos - VP].Trim();
                            ...
                            if (List[Row_Pos - VP][Column_Pos - (Column_Max - List[Row_Pos - VP].size()) / 2] >= 0x20)
                                Row_Values[Row_Pos][Column_Pos] = List[Row_Pos - VP][Column_Pos - (Column_Max -
                                                                                                   List[Row_Pos -
                                                                                                        VP].size()) /
                                                                                                  2];
                        }
                    ...
                    case 3 :    //Right-justified
                        for (int8u Column_Pos = Column_Max - (int8u) List[Row_Pos - VP].size();
                             Column_Pos < Column_Max; ++Column_Pos) {
                            List[Row_Pos - VP].Trim();
