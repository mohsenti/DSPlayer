...
//---------------------------------------------------------------------------
    void File_Ac3::Streams_Fill() {
        if (HD_MajorSync_Parsed) {
            ...
            if (HD_BitRate_Max)
                Fill(Stream_Audio, 0, Audio_BitRate_Maximum,
                     (HD_BitRate_Max * AC3_HD_SamplingRate(HD_SamplingRate2) + 8) >> 4);
        ...
        if (bsid_Max <= 0x09) {
            ...
            if (acmod_Max[0][0] != (int8u) -1) {
                ...
                ChannelPositions.From_Local(AC3_ChannelPositions[acmod_Max[0][0]]);
                Ztring ChannelPositions2;
                ChannelPositions2.From_Local(AC3_ChannelPositions2[acmod_Max[0][0]]);
                Ztring ChannelLayout;
                ChannelLayout.From_Local(lfeon_Max[0][0] ? AC3_ChannelLayout_lfeon[acmod_Max[0][0]]
                                                         : AC3_ChannelLayout_lfeoff[acmod_Max[0][0]]);
                if (lfeon_Max[0][0]) {
                    Channels += 1;
                ...
                if (acmod_Max[Pos][0] != (int8u) -1) {
                    ...
                    if (numblks) {
                        ...
                        if (frmsizplus1_Max[Pos][1]) //If dependand substreams
                            Fill(Stream_Audio, 0, Audio_BitRate,
                                 ((frmsizplus1_Max[Pos][0] * 2) * 8 * (750 / ((int16u) numblks))) / 4);
                    ...
                    if (acmod_Max[Pos][1] != (int8u) -1) {
                        ...
                        Fill(Stream_Audio, 0, Audio_ChannelLayout,
                             AC3_chanmap_ChannelLayout(chanmap_Final, ChannelLayout));
                    }
                    if (acmod_Max[Pos][0] == 0) {
                        ...
                        Ztring ChannelPositions;
                        ChannelPositions.From_Local(AC3_ChannelPositions[acmod_Max[Pos][0]]);
                        if (lfeon_Max[Pos][0]) {
                            Channels += 1;
                            ChannelPositions += __T(", LFE");
                        }
                        ...
                        Fill(Stream_Audio, 0, Audio_ChannelPositions, ChannelPositions);
                        Fill(Stream_Audio, 0, Audio_ChannelLayout,
                             lfeon_Max[0][0] ? AC3_ChannelLayout_lfeon[acmod_Max[0][0]]
                                             : AC3_ChannelLayout_lfeoff[acmod_Max[0][0]]);
                    }
                }
        }
        ...
        if (Core_IsPresent) {
            ...
            Fill(Stream_Audio, 0, "dialnorm/String",
                 Ztring::ToZtring(FirstFrame_Dolby.dialnorm == 0 ? -31 : -FirstFrame_Dolby.dialnorm) + __T(" dB"));
            (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dialnorm/String"), Info_Options) = __T("N NT");
            if (FirstFrame_Dolby.compre) {
                float64 Value = AC3_compr[FirstFrame_Dolby.compr >> 4] +
                                20 * std::log10(((float) (0x10 + (FirstFrame_Dolby.compr & 0x0F))) / 32);
            ...
            if (FirstFrame_Dolby.dynrnge) {
                ...
                if (FirstFrame_Dolby.dynrng == 0)
                    ...
                    Value = AC3_dynrng[FirstFrame_Dolby.dynrng >> 5] +
                            20 * std::log10(((float) (0x20 + (FirstFrame_Dolby.dynrng & 0x1F))) / 64);
                ...
                for (int8u Pos2 = 0; Pos2 < 9; Pos2++) {
                    ...
                    if (acmod_Max[Pos][Pos2] != (int8u) -1) {
                        if (acmod_Max[Pos][Pos2] == 2) {
                            ...
                            (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dsurmod/String"), Info_Options) = __T(
                                    "N NT");
                        }
        ...
        if (TimeStamp_IsPresent) {
            ...
            if (TimeStamp_DropFrame_IsValid)
                Fill(Stream_Audio, 0, Audio_Delay_Settings,
                     TimeStamp_DropFrame_Content ? "drop_frame_flag=1" : "drop_frame_flag=0");
        }
    ...
    void File_Ac3::Streams_Finish() {
        ...
        if (!dialnorms.empty()) {
            ...
            if (Count) {
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dialnorm_Average/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dialnorm_Minimum/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dialnorm_Maximum/String"), Info_Options) = __T(
                        "N NT");
        ...
        if (!comprs.empty()) {
            ...
            if (Count) {
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("compr_Average/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("compr_Minimum/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("compr_Maximum/String"), Info_Options) = __T(
                        "N NT");
        ...
        if (dynrnge_Exists && !dynrngs.empty()) {
            ...
            if (Count) {
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dynrng_Average/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dynrng_Minimum/String"), Info_Options) = __T(
                        "N NT");
                ...
                (*Stream_More)[Stream_Audio][0](Ztring().From_Local("dynrng_Maximum/String"), Info_Options) = __T(
                        "N NT");
        ...
        if (!IsSub) {
            ...
            if (MediaInfoLib::Config.ParseSpeed_Get() == 1) {
                ...
                Fill(Stream_Audio, 0, Audio_StreamSize,
                     File_Offset + Buffer_Offset + Element_Size - File_Offset_FirstSynched);
                ...
                if (Frame_Count_HD) {
                    ...
                    if (HD_SamplingRate) {
                        ...
                        if (FrameDuration) {
                            ...
                            Fill(Stream_Audio, 0, Audio_Duration, SamplingCount / (((float64) HD_SamplingRate) / 1000),
                                 0);
                            Fill(Stream_Audio, 0, Audio_SamplingCount, SamplingCount);
                            Fill(Stream_Audio, 0, Audio_BitRate, (File_Size - File_Offset_FirstSynched) /
                                                                 (SamplingCount /
                                                                  (((float64) HD_SamplingRate) / 1000)) * 8, 0);
                        }
                ...
                if (Core_IsPresent) {
                    ...
                    if (AC3_SamplingRate[fscod]) {
                        ...
                        if (bsid_Max <= 0x08)
                            ...
                            FrameDuration = 0;
                        if (FrameDuration) {
                            FrameDuration *= ((float64) 48000) /
                                             AC3_SamplingRate[fscod]; //32 ms for 48 KHz, else proportional (34.83 for 44.1 KHz, 48 ms for 32 KHz)
                            ...
                            int32u BitRate = AC3_BitRate[frmsizecod / 2] * 1000;
                            int32u Divider =
                                    bsid_Max == 9 ? 2 : 1; // Unofficial hack for low sample rate (e.g. 22.05 kHz)
                            Fill(Stream_Audio, 0, Audio_BitRate, BitRate / Divider);
                        }
                    }
                }
            ...
            if (bsid_Max <= 0x08)
                ...
                FrameDuration = 0;
            if (FrameDuration)
                Fill(Stream_Audio, 0, Audio_FrameCount,
                     float64_int64s(((float64) (FrameInfo.PTS - PTS_Begin)) / 1000000 / FrameDuration));
        }
    }
...
//---------------------------------------------------------------------------
    bool File_Ac3::Synchronize() {
        ...
        if (Buffer_Offset + 8 > Buffer_Size) {
            ...
            if (Buffer_Offset + 7 == Buffer_Size && CC3(Buffer + Buffer_Offset + 4) != 0xF8726F &&
                CC2(Buffer + Buffer_Offset) != 0x0B77 && CC2(Buffer + Buffer_Offset) != 0x770B)
                Buffer_Offset++;
            if (Buffer_Offset + 6 == Buffer_Size && CC2(Buffer + Buffer_Offset + 4) != 0xF872 &&
                CC2(Buffer + Buffer_Offset) != 0x0B77 && CC2(Buffer + Buffer_Offset) != 0x770B)
                Buffer_Offset++;
            if (Buffer_Offset + 5 == Buffer_Size && CC1(Buffer + Buffer_Offset + 4) != 0xF8 &&
                CC2(Buffer + Buffer_Offset) != 0x0B77 && CC2(Buffer + Buffer_Offset) != 0x770B)
                Buffer_Offset++;
            if (Buffer_Offset + 4 == Buffer_Size && CC2(Buffer + Buffer_Offset) != 0x0B77 &&
                CC2(Buffer + Buffer_Offset) != 0x770B)
                Buffer_Offset++;
        ...
        if (Buffer_Offset >= 16) {
            if (Buffer[Buffer_Offset - 0x10 + 0x00] == 0x01      //Magic value? Always 0x01
                ...
                && !(Buffer[Buffer_Offset - 0x10 + 0x00] ==
                     0x00     //We want at least a byte not zero, in order to differentiate TimeStamp from padding
...
//---------------------------------------------------------------------------
    void File_Ac3::Core_Frame() {
        ...
        if (bsid <= 0x09) {
            ...
            Skip_B2("crc1");
            BS_Begin();
            Get_S1(2, fscod, "fscod - Sample Rate Code");
            Param_Info2(AC3_SamplingRate[fscod], " Hz");
            Get_S1(6, frmsizecod, "frmsizecod - Frame Size Code");
            if (frmsizecod / 2 < 19) { Param_Info2(AC3_BitRate[frmsizecod / 2] * 1000, " bps"); }
            Element_End0();
            Element_Begin1("bsi");
            Get_S1(5, bsid, "bsid - Bit Stream Identification");
            Get_S1(3, bsmod, "bsmod - Bit Stream Mode");
            Param_Info1(AC3_Mode[bsmod]);
            Get_S1(3, acmod, "acmod - Audio Coding Mode");
            Param_Info1(AC3_ChannelPositions[acmod]);
            ...
            if (acmod == 2)
                Get_S1(2, dsurmod, "dsurmod - Dolby Surround Mode");
            Param_Info1(AC3_Surround[dsurmod]);
            ...
            if (fscod == 3) {
                ...
                Param_Info2(AC3_SamplingRate2[fscod2], " Hz");
                numblkscod = 3;
            } else
            ...
            if (strmtyp == 1) //dependent stream
            {
                TEST_SB_GET (chanmape, "chanmape");
                        ...
                        Param_Info1(AC3_chanmap_ChannelPositions(chanmap));
                TEST_SB_END();
            }
            Element_End0();
...
//---------------------------------------------------------------------------
    void File_Ac3::HD() {
        ...
        */
            ...
            Skip_B3("Synch");
            Get_B1(HD_StreamType, "Stream type");
            Param_Info1(AC3_HD_StreamType(HD_StreamType));

            if (HD_StreamType == 0xBA) {
                BS_Begin();
                Get_S1(4, HD_SamplingRate1, "Sampling rate");
                Param_Info2(AC3_HD_SamplingRate(HD_SamplingRate1), " Hz");
                Skip_S1(8, "Unknown");
                Get_S1(5, HD_Channels1, "Channels (1st substream)");
                Param_Info1(AC3_TrueHD_Channels(HD_Channels1));
                Param_Info1(Ztring().From_Local(AC3_TrueHD_Channels_Positions(HD_Channels1)));
                Skip_S1(2, "Unknown");
                Get_S2(13, HD_Channels2, "Channels (2nd substream)");
                Param_Info1(AC3_TrueHD_Channels(HD_Channels2));
                Param_Info1(Ztring().From_Local(AC3_TrueHD_Channels_Positions(HD_Channels2)));
                BS_End();
                HD_Resolution2 = HD_Resolution1 = 24; //Not sure
                HD_SamplingRate2 = HD_SamplingRate1;
            } else if (HD_StreamType == 0xBB) {
                BS_Begin();
                Get_S1(4, HD_Resolution1, "Resolution1");
                Param_Info2(AC3_MLP_Resolution[HD_Resolution1], " bits");
                Get_S1(4, HD_Resolution2, "Resolution2");
                Param_Info2(AC3_MLP_Resolution[HD_Resolution2], " bits");
                Get_S1(4, HD_SamplingRate1, "Sampling rate");
                Param_Info2(AC3_HD_SamplingRate(HD_SamplingRate1), " Hz");
                Get_S1(4, HD_SamplingRate2, "Sampling rate");
                Param_Info2(AC3_HD_SamplingRate(HD_SamplingRate2), " Hz");
                Skip_S1(11, "Unknown");
                Get_S1(5, HD_Channels1, "Channels");
                Param_Info1(AC3_MLP_Channels[HD_Channels1]);
                BS_End();
            ...
            Get_S2(15, HD_BitRate_Max, "Maximum bitrate");
            Param_Info2((HD_BitRate_Max * (AC3_HD_SamplingRate(HD_SamplingRate2) ? AC3_HD_SamplingRate(HD_SamplingRate2)
                                                                                 : AC3_HD_SamplingRate(
                            HD_SamplingRate1)) + 8) >> 4, " bps");
...
//---------------------------------------------------------------------------
    void File_Ac3::dac3() {
        ...
        Get_S1(5, frmsizecod, "bit_rate_code");
        frmsizecod *= 2;
        Skip_S1(5, "reserved");
        BS_End();
...
//---------------------------------------------------------------------------
    bool File_Ac3::CRC_Compute(size_t Size) {
        ...
        const int8u *CRC_16_Buffer_5_8 = Buffer + Buffer_Offset + (((Size >> 2) + (Size >> 4))
                << 1); //Magic formula to meet 5/8 frame size from Dolby
        ...
        while (CRC_16_Buffer < CRC_16_Buffer_End) {
            ...
            //CRC bytes inversion
            if (CRC_16_Buffer == CRC_16_Buffer_EndMinus3 && bsid <= 0x09 &&
                ((*CRC_16_Buffer) & 0x01)) //CRC inversion bit
            {
                CRC_16_Buffer++;
