...
//---------------------------------------------------------------------------
    ...
    public:
        ...
        HashWrapper(const HashFunctions &Functions, const int8u *Buffer, const size_t Buffer_Size) {
            Init(Functions);
        ...
        static string Generate(const HashFunction Function, const int8u *Buffer, const size_t Buffer_Size) {
            return HashWrapper(1 << Function, Buffer, Buffer_Size).Generate(Function);
        }
