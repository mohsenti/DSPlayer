...
//---------------------------------------------------------------------------
    ...
    Ztring Fims_VideoCompressionCodeCS_Name(int32u termID, MediaInfo_Internal &MI,
                                            size_t StreamPos) //xxyyzz: xx=main number, yy=sub-number, zz=sub-sub-number
    {
        switch (termID / 10000) {
            case 1 :
                return __T("MPEG-1 Video");
            case 2 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video Simple Profile @ Main Level");
                            default:
                                return __T("MPEG-2 Video Simple Profile");
                        }
                    case 2 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video Main Profile @ Low Level");
                            case 2 :
                                return __T("MPEG-2 Video Main Profile @ Main Level");
                            case 3 :
                                return __T("MPEG-2 Video Main Profile @ High 1440 Level");
                            case 4 :
                                return __T("MPEG-2 Video Main Profile @ High Level");
                            default:
                                return __T("MPEG-2 Video Main Profile");
                        }
                    case 3 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video SNR Scalable Profile @ Low Level");
                            case 2 :
                                return __T("MPEG-2 Video SNR Scalable Profile @ Main Level");
                            default:
                                return __T("MPEG-2 Video SNR Scalable Profile");
                        }
                    case 4 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video Spatial Scalable Profile @ Main Level");
                            case 2 :
                                return __T("MPEG-2 Video Spatial Scalable Profile @ High 1440 Level");
                            case 3 :
                                return __T("MPEG-2 Video Spatial Scalable Profile @ High Level");
                            default:
                                return __T("MPEG-2 Video Spatial Scalable Profile");
                        }
                    case 5 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video High Profile @ Main Level");
                            case 2 :
                                return __T("MPEG-2 Video High Profile @ High 1440 Level");
                            case 3 :
                                return __T("MPEG-2 Video High Profile @ High Level");
                            default:
                                return __T("MPEG-2 Video High Profile");
                        }
                    case 6 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video Multiview Profile @ Main Level");
                            default:
                                return __T("MPEG-2 Video Multiview Profile");
                        }
                    case 7 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Video 4:2:2 Profile @ Main Level");
                            default:
                                return __T("MPEG-2 Video 4:2:2 Profile");
                        }
                    default:
                        return __T("MPEG-2 Video");
                }
            case 3 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Simple Profile @ Level 0");
                            case 2 :
                                return __T("MPEG-4 Visual Simple Profile @ Level 1");
                            case 3 :
                                return __T("MPEG-4 Visual Simple Profile @ Level 2");
                            case 4 :
                                return __T("MPEG-4 Visual Simple Profile @ Level 3");
                            default:
                                return __T("MPEG-4 Visual Simple Profile");
                        }
                    case 2 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Simple Scalable Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Simple Scalable Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Visual Simple Scalable Profile");
                        }
                    case 3 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 0");
                            case 2 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 1");
                            case 3 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 2");
                            case 4 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 3");
                            case 5 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 4");
                            case 6 :
                                return __T("MPEG-4 Advanced Visual Simple Profile @ Level 5");
                            default:
                                return __T("MPEG-4 Advanced Visual Simple Profile");
                        }
                    case 4 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Core Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Core Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Visual Core Profile");
                        }
                    case 5 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Core-Scalable Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Core-Scalable Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Core-Scalable Profile @ Level 3");
                            default:
                                return __T("MPEG-4 Visual Core-Scalable Profile");
                        }
                    case 6 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual AdvancedCore Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual AdvancedCore Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Visual AdvancedCore Profile");
                        }
                    case 7 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Main Profile @ Level 2");
                            case 2 :
                                return __T("MPEG-4 Visual Main Profile @ Level 3");
                            case 3 :
                                return __T("MPEG-4 Visual Main Profile @ Level 4");
                            default:
                                return __T("MPEG-4 Visual Main Profile");
                        }
                    case 8 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual N-bit Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Visual Main Profile");
                        }
                    case 9 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Advanced Real Time Simple Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Advanced Real Time Simple Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Advanced Real Time Simple Profile @ Level 3");
                            case 4 :
                                return __T("MPEG-4 Visual Advanced Real Time Simple Profile @ Level 4");
                            default:
                                return __T("MPEG-4 Visual Advanced Real Time Simple Profile");
                        }
                    case 10 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Advanced Coding Efficiency Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Advanced Coding Efficiency Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Advanced Coding Efficiency Profile @ Level 3");
                            case 4 :
                                return __T("MPEG-4 Visual Advanced Coding Efficiency Profile @ Level 4");
                            default:
                                return __T("MPEG-4 Visual Advanced Coding Efficiency Profile");
                        }
                    case 11 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Simple Studio Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Simple Studio Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Simple Studio Profile @ Level 3");
                            case 4 :
                                return __T("MPEG-4 Visual Simple Studio Profile @ Level 4");
                            default:
                                return __T("MPEG-4 Visual Simple Studio Profile");
                        }
                    case 12 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Core Studio Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Core Studio Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Core Studio Profile @ Level 3");
                            case 4 :
                                return __T("MPEG-4 Visual Core Studio Profile @ Level 4");
                            default:
                                return __T("MPEG-4 Visual Core Studio Profile");
                        }
                    case 13 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 0");
                            case 2 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 1");
                            case 3 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 2");
                            case 4 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 3");
                            case 5 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 4");
                            case 6 :
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile @ Level 5");
                            default:
                                return __T("MPEG-4 Visual Fine Granularity Scalable Profile");
                        }
                    case 14 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Simple Face Animation Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Simple Face Animation Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Simple Face Animation Profile");
                        }
                    case 15 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Simple FBA Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Simple FBA Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Simple FBA Profile");
                        }
                    case 16 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Basic Animated Texture Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Basic Animated Texture Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Basic Animated Texture Profile");
                        }
                    case 17 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Advanced Scalable Texture Profile @ Level 1");
                            default:
                                return __T("MPEG-4 Advanced Scalable Texture Profile");
                        }
                    case 18 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Advanced Scalable Texture Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Advanced Scalable Texture Profile @ Level 2");
                            case 3 :
                                return __T("MPEG-4 Visual Advanced Scalable Texture Profile @ Level 3");
                            default:
                                return __T("MPEG-4 Visual Advanced Scalable Texture Profile");
                        }
                    case 19 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-4 Visual Hybrid Profile @ Level 1");
                            case 2 :
                                return __T("MPEG-4 Visual Hybrid Profile @ Level 2");
                            default:
                                return __T("MPEG-4 Visual Hybrid Profile");
                        }
                    default:
                        return __T("MPEG-4 Visual");
                }
            case 4 :
                return __T("JPEG");
            case 5 :
            ...
            case 8 :
                return __T("H263");
            default:
                return MI.Get(Stream_Video, StreamPos, Video_Format);
        }
    }
...
//---------------------------------------------------------------------------
    ...
    Ztring Fims_AudioCompressionCodeCS_Name(int32u termID, MediaInfo_Internal &MI,
                                            size_t StreamPos) //xxyyzz: xx=main number, yy=sub-number, zz=sub-sub-number
    {
        switch (termID / 10000) {
            case 4 :
            ...
            case 7 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        return __T("MPEG-1 Audio Layer I");
                    case 2 :
                        return __T("MPEG-1 Audio Layer II");
                    case 3 :
                        return __T("MPEG-1 Audio Layer III");
                    default:
                        return __T("MPEG-1 Audio");
                }
            case 9 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        return __T("MPEG-2 Audio Layer I");
                    case 2 :
                        return __T("MPEG-2 Audio Layer II");
                    case 3 :
                        return __T("MPEG-2 Audio Layer III");
                    default:
                        return __T("MPEG-2 Audio");
                }
            default:
                return MI.Get(Stream_Audio, StreamPos, Video_Format);
        }
    }
...
//---------------------------------------------------------------------------
    Ztring
    Fims_Transform_Video(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos, Export_Fims::version Version) {
        ...
        if (!MI.Get(Stream_Video, StreamPos, Video_Format_Version).empty())
            ToReturn += __T(" <!-- videoFormatVersionId=\"") + MI.Get(Stream_Video, StreamPos, Video_Format_Version) +
                        __T("\" -->");
        ToReturn += __T("\n");
        ...
        if (!MI.Get(Stream_Video, StreamPos, Video_ActiveFormatDescription).empty())
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"ActiveFormatDescription\">") +
                    MI.Get(Stream_Video, StreamPos, Video_ActiveFormatDescription) + __T("</bms:technicalAttribute>\n");

        //technicalAttributeString - Standard
        if (!MI.Get(Stream_Video, StreamPos, Video_Standard).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"Standard\">") +
                        MI.Get(Stream_Video, StreamPos, Video_Standard) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - ColorSpace
        if (!MI.Get(Stream_Video, StreamPos, Video_ColorSpace).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"ColorSpace\">") +
                        MI.Get(Stream_Video, StreamPos, Video_ColorSpace) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - ChromaSubsampling
        if (!MI.Get(Stream_Video, StreamPos, Video_ChromaSubsampling).empty()) {
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"ChromaSubsampling\">") +
                    MI.Get(Stream_Video, StreamPos, Video_ChromaSubsampling) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - colour_primaries
        if (!MI.Get(Stream_Video, StreamPos, __T("colour_primaries")).empty()) {
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"colour_primaries\">") +
                    MI.Get(Stream_Video, StreamPos, __T("colour_primaries")) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - transfer_characteristics
        if (!MI.Get(Stream_Video, StreamPos, __T("transfer_characteristics")).empty()) {
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"transfer_characteristics\">") +
                    MI.Get(Stream_Video, StreamPos, __T("transfer_characteristics")) +
                    __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - matrix_coefficients
        if (!MI.Get(Stream_Video, StreamPos, __T("matrix_coefficients")).empty()) {
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"matrix_coefficients\">") +
                    MI.Get(Stream_Video, StreamPos, __T("matrix_coefficients")) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - colour_range
        if (!MI.Get(Stream_Video, StreamPos, __T("colour_range")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"colour_range\">") +
                        MI.Get(Stream_Video, StreamPos, __T("colour_range")) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - StreamSize
        if (!MI.Get(Stream_Video, StreamPos, Video_StreamSize).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"integer\" typeLabel=\"StreamSize\"") +
                        (Version >= Export_Fims::Version_1_2 ? Ztring(__T(" unit=\"byte\"")) : Ztring()) + __T(">") +
                        MI.Get(Stream_Video, StreamPos, Video_StreamSize) + __T("</bms:technicalAttribute>") +
                        (Version < Export_Fims::Version_1_2 ? Ztring(__T(" <!-- unit=\"byte\" -->")) : Ztring()) +
                        __T("\n");
        }

        //technicalAttributeString - BitDepth
        if (!MI.Get(Stream_Video, StreamPos, Video_BitDepth).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"integer\" typeLabel=\"BitDepth\"") +
                        (Version >= Export_Fims::Version_1_2 ? Ztring(__T(" unit=\"bit\"")) : Ztring()) + __T(">") +
                        MI.Get(Stream_Video, StreamPos, Video_BitDepth) + __T("</bms:technicalAttribute>") +
                        (Version < Export_Fims::Version_1_2 ? Ztring(__T(" <!-- unit=\"bit\" -->")) : Ztring()) +
                        __T("\n");
        }

        //technicalAttributeString
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaManufacturer")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"FPAManufacturer\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaManufacturer")) +
                        __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaVersion")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"FPAVersion\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaVersion")) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeBoolean - Format_Settings_CABAC
        if (MI.Get(Stream_Video, StreamPos, Video_Format) == __T("AVC") &&
            !MI.Get(Stream_Video, StreamPos, Video_Format_Settings_CABAC).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"boolean\" typeLabel=\"CABAC\">") +
                        Ztring(MI.Get(Stream_Video, StreamPos, Video_Format_Settings_CABAC) == __T("Yes") ? __T("true")
                                                                                                          : __T(
                                       "false")) + __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeBoolean - Format_Settings_MBAFF
        if (MI.Get(Stream_Video, StreamPos, Video_Format) == __T("AVC") &&
            !MI.Get(Stream_Video, StreamPos, Video_ScanType).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"boolean\" typeLabel=\"MBAFF\">") +
                        Ztring(MI.Get(Stream_Video, StreamPos, Video_ScanType) == __T("MBAFF") ? __T("true") : __T(
                                "false")) + __T("</bms:technicalAttribute>\n");
        }
        ...
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaPass")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"boolean\" typeLabel=\"MBAFF\">") +
                        Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("FpaPass")) == __T("Yes") ? __T("true") : __T(
                                "false")) + __T("</bms:technicalAttribute>\n");
        }
        ...
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("VideoComments")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"VideoComments\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("VideoComments")) + __T("</bms:technicalAttribute>\n");
        }
        ...
        if (!MI.Get(Stream_Video, StreamPos, Video_Width).empty()) {
            ...
            ToReturn +=
                    __T("\t\t\t\t\t<bms:displayWidth unit=\"pixel\">") + MI.Get(Stream_Video, StreamPos, Video_Width) +
                    __T("</bms:displayWidth>\n");
        }
        ...
        if (!MI.Get(Stream_Video, StreamPos, Video_DisplayAspectRatio).empty()) {
            ...
            ToReturn += __T(" denominator=\"") + factorDenominator + __T("\"");
            ToReturn += __T(">") +
                        Ztring::ToZtring(MI.Get(Stream_Video, StreamPos, Video_DisplayAspectRatio).To_float64(), 0);
            ToReturn += __T("</bms:aspectRatio>\n");
        }
        ...
        //if (!MI.Get(Stream_Video, StreamPos, Video_Format_Profile).empty())
        {
            ...
            if (!MI.Get(Stream_Video, StreamPos, Video_Format).empty())
                ToReturn += __T("\t\t\t\t\t\t<bms:family>") + MI.Get(Stream_Video, StreamPos, Video_Format) +
                            __T("</bms:family>\n");
            if (!MI.Get(Stream_Video, StreamPos, Video_CodecID).empty()) {
                ToReturn += __T("\t\t\t\t\t\t<!-- <bms:identifier>") + MI.Get(Stream_Video, StreamPos, Video_CodecID) +
                            __T("</dc:identifier> -->\n");
            }
            if (!MI.Get(Stream_Video, StreamPos, Video_Format_Commercial_IfAny).empty())
                ToReturn += __T("\t\t\t\t\t\t<!-- <ebucore:name>") +
                            MI.Get(Stream_Video, StreamPos, Video_Format_Commercial_IfAny) +
                            __T("</ebucore:name> -->\n");
        ...
        //videoTrack
        if (!MI.Get(Stream_Video, StreamPos, Video_ID).empty() ||
            !MI.Get(Stream_Video, StreamPos, Video_Title).empty()) {
        ...
        if (!MI.Get(Stream_Video, StreamPos, Video_BitRate).empty())
            ToReturn += __T("\t\t\t\t\t<bms:bitRate>") + MI.Get(Stream_Video, StreamPos, Video_BitRate) +
                        __T("</bms:bitRate>\n");

        //bitRateMax
        if (!MI.Get(Stream_Video, StreamPos, Video_BitRate_Maximum).empty())
            ToReturn +=
                    __T("\t\t\t\t\t <!-- <bms:bitRateMax>") + MI.Get(Stream_Video, StreamPos, Video_BitRate_Maximum) +
                    __T("</bms:bitRateMax> -->\n");
        ...
        //lines
        if (!MI.Get(Stream_Video, StreamPos, Video_Height_Original).empty())
            ToReturn += __T("\t\t\t\t<bms:lines>") + MI.Get(Stream_Video, StreamPos, Video_Height_Original) +
                        __T("</bms:lines>\n");
...
//---------------------------------------------------------------------------
    Ztring
    Fims_Transform_Audio(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos, Export_Fims::version Version) {
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_Format_Version).empty())
            ToReturn += __T(" <!-- audioFormatVersionId=\"") + MI.Get(Stream_Audio, StreamPos, Audio_Format_Version) +
                        __T("\" -->");
        ToReturn += __T("\n");
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_ChannelPositions).empty()) {
            ToReturn +=
                    __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"ChannelPositions\">") +
                    MI.Get(Stream_Audio, StreamPos, Audio_ChannelPositions) + __T("</bms:technicalAttribute>\n");
        }

        //format - technicalAttributeString - ChannelLayout
        if (!MI.Get(Stream_Audio, StreamPos, Audio_ChannelLayout).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"ChannelLayout\">") +
                        MI.Get(Stream_Audio, StreamPos, Audio_ChannelLayout) + __T("</bms:technicalAttribute>\n");
        }
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_Format_Settings_Endianness).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"Endianness\">") +
                        MI.Get(Stream_Audio, StreamPos, Audio_Format_Settings_Endianness) +
                        __T("</bms:technicalAttribute>\n");
        }

        //technicalAttributeString - Format_Settings_Wrapping
        if (!MI.Get(Stream_Audio, StreamPos, Audio_Format_Settings_Wrapping).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"Wrapping\">") +
                        MI.Get(Stream_Audio, StreamPos, Audio_Format_Settings_Wrapping) +
                        __T("</bms:technicalAttribute>\n");
        }
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_StreamSize).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"integer\" typeLabel=\"StreamSize\"") +
                        (Version >= Export_Fims::Version_1_2 ? Ztring(__T(" unit=\"byte\"")) : Ztring()) + __T(">") +
                        MI.Get(Stream_Audio, StreamPos, Audio_StreamSize) + __T("</bms:technicalAttribute>") +
                        (Version < Export_Fims::Version_1_2 ? Ztring(__T(" <!-- unit=\"byte\" -->")) : Ztring()) +
                        __T("\n");
        }
        ...
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioComments")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:comment typeLabel=\"AudioComments\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioComments")) + __T("</bms:comment>\n");
        }

        //samplingRate
        if (!MI.Get(Stream_Audio, StreamPos, Audio_SamplingRate).empty())
            ToReturn += __T("\t\t\t\t\t<bms:samplingRate>") + MI.Get(Stream_Audio, StreamPos, Audio_SamplingRate) +
                        __T("</bms:samplingRate>\n");
        ...
        //if (!MI.Get(Stream_Audio, StreamPos, Audio_Format_Profile).empty())
        {
            ...
            if (!MI.Get(Stream_Audio, StreamPos, Audio_Format).empty())
                ToReturn += __T("\t\t\t\t\t\t<bms:family>") + MI.Get(Stream_Audio, StreamPos, Audio_Format) +
                            __T("</bms:family>\n");
            if (!MI.Get(Stream_Audio, StreamPos, Audio_CodecID).empty()) {
                ToReturn += __T("\t\t\t\t\t\t<!-- <dc:identifier>") + MI.Get(Stream_Audio, StreamPos, Audio_CodecID) +
                            __T("</dc:identifier> -->\n");
            }
            if (!MI.Get(Stream_Audio, StreamPos, Audio_Format_Commercial_IfAny).empty())
                ToReturn += __T("\t\t\t\t\t\t<!-- <ebucore:name>") +
                            MI.Get(Stream_Audio, StreamPos, Audio_Format_Commercial_IfAny) +
                            __T("</ebucore:name> -->\n");
        ...
        if (As11_Core_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_Core_Pos, __T("AudioTrackLayout")).empty()) {
            ToReturn += __T("\t\t\t\t\t<bms:trackConfiguration typeLabel=\"") +
                        MI.Get(Stream_Other, As11_Core_Pos, __T("AudioTrackLayout")) + __T("\"/>\n");
        }

        //audioTrack
        if (!MI.Get(Stream_Audio, StreamPos, Audio_ID).empty() ||
            !MI.Get(Stream_Audio, StreamPos, Audio_Title).empty() ||
            !MI.Get(Stream_Audio, StreamPos, Audio_Language).empty()) {
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_Channel_s_).empty())
            ToReturn += __T("\t\t\t\t\t<bms:channels>") + MI.Get(Stream_Audio, StreamPos, Audio_Channel_s_) +
                        __T("</bms:channels>\n");

        //bitRate
        if (!MI.Get(Stream_Audio, StreamPos, Audio_BitRate).empty())
            ToReturn += __T("\t\t\t\t\t<bms:bitRate>") + MI.Get(Stream_Audio, StreamPos, Audio_BitRate) +
                        __T("</bms:bitRate>\n");

        //bitRateMax
        if (!MI.Get(Stream_Audio, StreamPos, Audio_BitRate_Maximum).empty())
            ToReturn += __T("\t\t\t\t\t<-- <bms:bitRateMax>") + MI.Get(Stream_Audio, StreamPos, Audio_BitRate_Maximum) +
                        __T("</bms:bitRateMax> -->\n");
        ...
        if (!MI.Get(Stream_Audio, StreamPos, Audio_BitDepth).empty())
            ToReturn += __T("\t\t\t\t\t<bms:sampleSize>") + MI.Get(Stream_Audio, StreamPos, Audio_BitDepth) +
                        __T("</bms:sampleSize>\n");
...
//---------------------------------------------------------------------------
    Ztring Fims_Transform_Text(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos) {
        ...
        if (!MI.Get(Stream_Text, StreamPos, Text_Format_Version).empty())
            ToReturn +=
                    __T(" dataFormatVersionId=\"") + MI.Get(Stream_Text, StreamPos, Text_Format_Version) + __T("\"");
        ...
        //subtitlingTrack
        {
            ...
            if (!MI.Get(Stream_Text, StreamPos, Text_CodecID).empty() ||
                !MI.Get(Stream_Text, StreamPos, Text_Format_Commercial_IfAny).empty()) {
                ToReturn += __T("\t\t\t\t\t<ebucore:codec>\n");
                if (!MI.Get(Stream_Text, StreamPos, Text_CodecID).empty()) {
                    ToReturn += __T("\t\t\t\t\t\t<ebucore:codecIdentifier>\n");
                    ToReturn += __T("\t\t\t\t\t\t\t<dc:identifier>") + MI.Get(Stream_Text, StreamPos, Text_CodecID) +
                                __T("</dc:identifier>\n");
                    ToReturn += __T("\t\t\t\t\t\t</ebucore:codecIdentifier>\n");
                }
                if (!MI.Get(Stream_Text, StreamPos, Text_Format_Commercial_IfAny).empty())
                    ToReturn += __T("\t\t\t\t\t\t<ebucore:name>") +
                                MI.Get(Stream_Text, StreamPos, Text_Format_Commercial_IfAny) + __T("</ebucore:name>\n");
                ToReturn += __T("\t\t\t\t\t</ebucore:codec>\n");
            }
        }
...
//---------------------------------------------------------------------------
    Ztring Fims_Transform_TimeCode(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos, bool Is1_2) {
        ...
        //start
        {
            ...
            ToReturn +=
                    __T("\t\t\t\t\t\t<ebucore:timecode>") + MI.Get(Stream_Other, StreamPos, Other_TimeCode_FirstFrame) +
                    __T("</ebucore:timecode>\n");
            ToReturn += __T("\t\t\t\t\t</ebucore:timecodeStart>\n");
        }

        if (!MI.Get(Stream_Other, StreamPos, Other_ID).empty() ||
            !MI.Get(Stream_Other, StreamPos, Other_Title).empty()) {
        ...
        if (!MI.Get(Stream_Other, StreamPos, Other_ID).empty())
            ToReturn += __T("\t\t\t\t\t<ebucore:technicalAttributeBoolean typeLabel=\"Stripped\">") +
                        Ztring(MI.Get(Stream_Other, StreamPos, __T("TimeCode_Striped")) == __T("Yes") ? __T("true")
                                                                                                      : __T("false")) +
                        __T("</ebucore:technicalAttributeBoolean>\n");
...
//---------------------------------------------------------------------------
    Ztring Export_Fims::Transform(MediaInfo_Internal &MI, version Version) {
        ...
        Ztring DateTime;
        DateTime.Date_From_Seconds_1970((int32u) Seconds);
        ...
        if (!MI.Get(Stream_General, 0, General_Encoded_Date).empty()) {
            ...
            ToReturn += __T("\t\t\t<bms:resourceCreationDate>") + Date + __T('T') + Time +
                        __T("Z</bms:resourceCreationDate>\n");
        }
        ...
        if (!MI.Get(Stream_General, 0, General_Tagged_Date).empty()) {
            ...
            ToReturn += __T("\t\t\t<bms:resourceModifiedDate>") + Date + __T('T') + Time +
                        __T("Z</bms:resourceModifiedDate>\n");
        }
        ...
        if (!MI.Get(Stream_General, 0, General_CompleteName).empty()) {
            ...
            ToReturn += __T("\t\t\t\t\t<bms:resourceID/>\n");
            ToReturn += __T("\t\t\t\t\t<bms:locatorInfo>") +
                        Fims_XML_Encode(MI.Get(Stream_General, 0, General_CompleteName)) + __T("</bms:locatorInfo>\n");
        ...
        //bmContentFormats - per stream
        {
            ...
            for (size_t Pos = 0; Pos < MI.Count_Get(Stream_Video); Pos++) {
                if (Version < Version_1_2 && Pos == 1) {
                    ...
                    ToReturn += __T("\t\t\t\t") + Ztring::ToZtring(MI.Count_Get(Stream_Video) - 1) +
                                __T(" additional video streams\n");
                    ToReturn += __T("\t\t\t\t-->\n");
                    break;
                }
            ...
            for (size_t Pos = 0; Pos < MI.Count_Get(Stream_Audio); Pos++) {
                if (Version < Version_1_2 && Pos == 1) {
                    ToReturn += __T("\t\t\t\t<!-- Not valid in XSD\n");
                    ToReturn += __T("\t\t\t\t") + Ztring::ToZtring(MI.Count_Get(Stream_Audio) - 1) +
                                __T(" additional audio streams\n");
                    ToReturn += __T("\t\t\t\t-->\n");
                    break;
                }
            ...
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("SigningPresent")).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<bms:resourceID/>\n");
                ToReturn += __T("\t\t\t\t\t<!-- <ebucore:signingFormat signingPresenceFlag=\"") +
                            Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("SigningPresent")) == __T("Yes") ? __T(
                                    "true") : __T("false")) + __T("\"/>-->\n");
                ToReturn += __T("\t\t\t\t</bms:dataFormat>\n");
            }

            //format - ClosedCaptionsPresent
            if (As11_Core_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_Core_Pos, __T("ClosedCaptionsPresent")).empty()) {
                if (Version < Version_1_2)
                    ToReturn += __T("\t\t\t\t<!-- Not valid in XSD\n");
                ToReturn += __T("\t\t\t\t<bms:dataFormat>\n");
                ToReturn += __T("\t\t\t\t\t<bms:resourceID/>\n");
                if (Version < Version_1_2)
                    ToReturn += __T("\t\t\t\t\t<bms:captioningFormat captioningPresenceFlag=\"") +
                                Ztring(MI.Get(Stream_Other, As11_Core_Pos, __T("OpenCaptionsPresent")) == __T("Yes")
                                       ? __T("true") : __T("false")) + __T("\" closed=\"true\"/>\n");
                else
                    ToReturn += __T("\t\t\t\t\t<bms:captioningFormat/> <!-- captioningPresenceFlag=\"") +
                                Ztring(MI.Get(Stream_Other, As11_Core_Pos, __T("OpenCaptionsPresent")) == __T("Yes")
                                       ? __T("true") : __T("false")) + __T("\" closed=\"true\"/> -->\n");
            ...
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OpenCaptionsPresent")).empty()) {
                if (Version < Version_1_2)
                    ToReturn += __T("\t\t\t\t<!-- Not valid in XSD\n");
                ToReturn += __T("\t\t\t\t<bms:dataFormat>\n");
                ToReturn += __T("\t\t\t\t\t<bms:resourceID/>\n");
                if (Version < Version_1_2)
                    ToReturn += __T("\t\t\t\t\t<bms:captioningFormat captioningPresenceFlag=\"") +
                                Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OpenCaptionsPresent")) == __T("Yes")
                                       ? __T("true") : __T("false")) + __T("\" closed=\"false\"/>\n");
                else
                    ToReturn += __T("\t\t\t\t\t<bms:captioningFormat/> <!-- captioningPresenceFlag=\"") +
                                Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OpenCaptionsPresent")) == __T("Yes")
                                       ? __T("true") : __T("false")) + __T("\" closed=\"false\"/> -->\n");
            ...
            if (As11_Core_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_Core_Pos, __T("ShimName")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"AS11ShimName\">") +
                        MI.Get(Stream_Other, As11_Core_Pos, __T("ShimName")) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (As11_Core_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_Core_Pos, __T("ShimVersion")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"AS11ShimVersion\">") +
                        MI.Get(Stream_Other, As11_Core_Pos, __T("ShimVersion")) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_General, 0, __T("Format_Profile")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"FormatProfile\">") +
                        MI.Get(Stream_General, 0, __T("Format_Profile")) + __T("</bms:technicalAttribute>\n");
            }

            //format - containerFormat - technicalAttribute formatLabel=\"string\" - Format_Settings
            if (!MI.Get(Stream_General, 0, __T("Format_Profile")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"FormatSettings\">") +
                        MI.Get(Stream_General, 0, __T("Format_Settings")) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_General, 0, __T("Encoded_Application")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"WritingApplication\">") +
                        MI.Get(Stream_General, 0, __T("Encoded_Application")) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_General, 0, __T("Encoded_Library/String")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"WritingLibrary\">") +
                        MI.Get(Stream_General, 0, __T("Encoded_Library/String")) + __T("</bms:technicalAttribute>\n");
            }
        ...
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("LineUpStart")).empty()) {
            ...
            ToReturn += __T("\t\t\t\t<ebucore:timecode>") + MI.Get(Stream_Other, As11_UkDpp_Pos, __T("LineUpStart")) +
                        __T("</ebucore:timecode>\n");
        ...
        if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("IdentClockStart")).empty()) {
            ...
            ToReturn +=
                    __T("\t\t\t\t<ebucore:timecode>") + MI.Get(Stream_Other, As11_UkDpp_Pos, __T("IdentClockStart")) +
                    __T("</ebucore:timecode>\n");
            ToReturn += __T("\t\t\t</ebucore:start>\n");
            ToReturn += __T("\t\t\t-->\n");
        }
        ...
        //duration
        if (As11_UkDpp_Pos != (size_t) -1 &&
            !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("TotalProgrammeDuration")).empty()) {
            if (Version < Version_1_2 && durationDone)
                ToReturn += __T("\t\t\t<!-- Not valid in XSD\n");
            ToReturn += __T("\t\t\t<bms:duration typeLabel=\"TotalProgrammeDuration\">\n");
            ToReturn += __T("\t\t\t\t<tim:timecode>") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("TotalProgrammeDuration")) + __T("</tim:timecode>\n");
            ToReturn += __T("\t\t\t</bms:duration>\n");
            if (Version < Version_1_2 && durationDone)
                ToReturn += __T("\t\t\t-->\n");
        }
        ...
        if (!MI.Get(Stream_General, 0, General_FileSize).empty())
            ToReturn += __T("\t\t\t<bms:packageSize>") + MI.Get(Stream_General, 0, General_FileSize) +
                        __T("</bms:packageSize>\n");
        ...
        if (As11_UkDpp_Pos != (size_t) -1) {
            ...
            if (!MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioLoudnessStandard")).empty()) {
                ToReturn +=
                        __T("\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"AudioLoudnessStandard\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioLoudnessStandard")) +
                        __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioDescriptionType")).empty()) {
                ToReturn +=
                        __T("\t\t\t<bms:technicalAttribute formatLabel=\"string\" typeLabel=\"AudioDescriptionType\">") +
                        MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioDescriptionType")) +
                        __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_General, 0, General_OverallBitRate).empty()) {
                ToReturn +=
                        __T("\t\t\t<bms:technicalAttribute formatLabel=\"integer\" typeLabel=\"OverallBitRate\" unit=\"bps\">") +
                        MI.Get(Stream_General, 0, General_OverallBitRate) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_Other, As11_Core_Pos, __T("ProgrammeHasText")).empty()) {
                ToReturn +=
                        __T("\t\t\t<bms:technicalAttribute formatLabel=\"boolean\" typeLabel=\"ProgrammeHasText\">") +
                        Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProgrammeHasText")) == __T("Yes") ? __T("true")
                                                                                                           : __T(
                                       "false")) + __T("</bms:technicalAttribute>\n");
            }
            ...
            if (!MI.Get(Stream_Other, As11_Core_Pos, __T("AudioDescriptionPresent")).empty()) {
                ToReturn +=
                        __T("\t\t\t<bms:technicalAttribute formatLabel=\"boolean\" typeLabel=\"AudioDescriptionPresent\">") +
                        Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("AudioDescriptionPresent")) == __T("Yes") ? __T(
                                "true") : __T("false")) + __T("</bms:technicalAttribute>\n");
            }
        ...
        if (true) {
            ...
            if (As11_Core_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_Core_Pos, __T("ProgrammeTitle")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:title>") +
                            (Version >= Version_1_2 ? Ztring(__T(" typeLabel=\"PROGRAMME TITLE\"")) : Ztring()) +
                            MI.Get(Stream_Other, As11_Core_Pos, __T("ProgrammeTitle")) + __T("</desc:title>") +
                            (Version < Version_1_2 ? Ztring(__T(" <!-- typeLabel=\"PROGRAMME TITLE\" -->"))
                                                   : Ztring()) + __T("\n");
            } else if (As11_Core_Pos != (size_t) -1 &&
                       !MI.Get(Stream_Other, As11_Core_Pos, __T("EpisodeTitleNumber")).empty()) {
                ToReturn +=
                        __T("\t\t\t\t<desc:title>") + MI.Get(Stream_Other, As11_Core_Pos, __T("EpisodeTitleNumber")) +
                        __T("</desc:title> <!-- typeLabel=\"EPISODE TITLE NUMBER\" -->\n");
            }

            //alternativeTitle
            if (As11_Core_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_Core_Pos, __T("SeriesTitle")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:alternativeTitle typeLabel=\"SERIES TITLE\">") +
                            MI.Get(Stream_Other, As11_Core_Pos, __T("SeriesTitle")) + __T("</desc:alternativeTitle>\n");
            }
            if (As11_Core_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_Core_Pos, __T("EpisodeTitleNumber")).empty() &&
                !MI.Get(Stream_Other, As11_Core_Pos, __T("ProgrammeTitle")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:alternativeTitle typeLabel=\"EPISODE TITLE NUMBER\">") +
                            MI.Get(Stream_Other, As11_Core_Pos, __T("EpisodeTitleNumber")) +
                            __T("</desc:alternativeTitle>\n");
            }

            //description
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Synopsis")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:description typeLabel=\"SYNOPSIS\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Synopsis")) + __T("</desc:description>\n");
            }

            //ProductPlacement
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProductPlacement")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:description typeLabel=\"PRODUCT PLACEMENT\">") +
                            Ztring(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProductPlacement")) == __T("Yes") ? __T(
                                    "true") : __T("false")) + __T("</desc:description>\n");
            }

            //ContactEmail / ContactTelephoneNumber
            if (As11_UkDpp_Pos != (size_t) -1 && (!MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ContactEmail")).empty() ||
                                                  !MI.Get(Stream_Other, As11_UkDpp_Pos,
                                                          __T("ContactTelephoneNumber")).empty())) {
                ...
                if (!MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ContactEmail")).empty())
                    ToReturn += __T("\t\t\t\t\t\t\t<desc:emailAddress>") +
                                Fims_XML_Encode(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ContactEmail"))) +
                                __T("</desc:emailAddress>\n");
                if (!MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ContactTelephoneNumber")).empty())
                    ToReturn += __T("\t\t\t\t\t\t\t<desc:telephoneNumber>") +
                                Fims_XML_Encode(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ContactTelephoneNumber"))) +
                                __T("</desc:telephoneNumber>\n");
                ToReturn += __T("\t\t\t\t\t\t</desc:details>\n");
                ToReturn += __T("\t\t\t\t\t</desc:contactDetails>\n");
            ...
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Originator")).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t\t<desc:organisationName>") +
                            Fims_XML_Encode(MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Originator"))) +
                            __T("</desc:organisationName>\n");
                ToReturn += __T("\t\t\t\t\t</desc:organisationDetails>\n");
            ...
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Distributor")).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<desc:organisationDetails>\n");
                ToReturn += __T("\t\t\t\t\t\t<desc:organisationName>") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Distributor")) +
                            __T("</desc:organisationName>\n");
                ToReturn += __T("\t\t\t\t\t</desc:organisationDetails>\n");
            ...
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("CopyrightYear")).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<desc:alternative typeLabel=\"copyrighted\" startYear=\"") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("CopyrightYear")) + __T("\"/>\n");
                ToReturn += __T("\t\t\t\t</desc:date>\n");
            }
            ...
            if (As11_UkDpp_Pos != (size_t) -1 && !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Genre")).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<desc:genre typeDefinition=\"") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("Genre")) + __T("\"/>\n");
                ToReturn += __T("\t\t\t\t</desc:type>\n");
            }

            //identifier
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProductionNumber")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:identifier typeLabel=\"PRODUCTION NUMBER\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProductionNumber")) + __T("</desc:identifier>\n");
            }
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OtherIdentifier")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:identifier typeLabel=\"INTERNAL IDENTIFIER\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OtherIdentifier")) + __T("</desc:identifier>\n");
            }
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OtherIdentifierType")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:identifier typeLabel=\"INTERNAL IDENTIFIER TYPE\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("OtherIdentifierType")) +
                            __T("</desc:identifier>\n");
            }

            //format - PrimaryAudioLanguage
            if (As11_Core_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_Core_Pos, __T("PrimaryAudioLanguage")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:language typeLabel=\"PrimaryAudioLanguage\" xml:lang=\"") +
                            MI.Get(Stream_Other, As11_Core_Pos, __T("PrimaryAudioLanguage")) + __T("\"/>\n");
            }

            //format - SecondaryAudioLanguage
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("SecondaryAudioLanguage")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:language typeLabel=\"SecondaryAudioLanguage\" xml:lang=\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("SecondaryAudioLanguage")) + __T("<\"/>\n");
            }

            //format - TertiaryAudioLanguage
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("TertiaryAudioLanguage")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:language typeLabel=\"TertiaryAudioLanguage\" xml:lang=\">") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("TertiaryAudioLanguage")) + __T("\"/>\n");
            }

            //language
            if (As11_UkDpp_Pos != (size_t) -1 &&
                !MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProgrammeTextLanguage")).empty()) {
                ToReturn += __T("\t\t\t\t<desc:language typeLabel=\"ProgrammeTextLanguage\" xml:lang=\"") +
                            MI.Get(Stream_Other, As11_UkDpp_Pos, __T("ProgrammeTextLanguage")) + __T("\"/>\n");
            }
            ...
            if (As11_Segmentation_Pos != (size_t) -1) {
                ...
                for (;;) {
                    ...
                    ToReturn += __T("\t\t\t\t<desc:part partNumber=\"") + Ztring::ToZtring(Pos) +
                                __T("\" partTotalNumber=\"") +
                                MI.Get(Stream_Other, As11_Segmentation_Pos, __T("PartTotal")) + __T("\">\n");
