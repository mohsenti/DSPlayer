...
//---------------------------------------------------------------------------
    const Char *Mpeg7_Type(MediaInfo_Internal &MI) //TO ADAPT
    {
        ...
        if (Format == __T("AVI") || Format == __T("DV") || Format == __T("MPEG-4") || Format == __T("MPEG-PS") ||
            Format == __T("MPEG-TS") || Format == __T("QuickTime") || Format == __T("Windows Media"))
            return __T("Video");
        if (Format == __T("MPEG Audio") || Format == __T("Wave"))
            return __T("Audio");
        if (Format == __T("BMP") || Format == __T("GIF") || Format == __T("JPEG") || Format == __T("JPEG 2000") ||
            Format == __T("PNG") || Format == __T("TIFF"))
            return __T("Image");
        return __T("Multimedia");
    }
...
//---------------------------------------------------------------------------
    ...
    Ztring
    Mpeg7_ContentCS_Name(int32u termID, MediaInfo_Internal &) //xxyyzz: xx=main number, yy=sub-number, zz=sub-sub-number
    {
        switch (termID / 10000) {
            case 1 :
                return __T("Audio");
...
//---------------------------------------------------------------------------
    ...
    Ztring Mpeg7_FileFormatCS_Name(int32u termID,
                                   MediaInfo_Internal &MI) //xxyyzz: xx=main number, yy=sub-number, zz=sub-sub-number
    {
        switch (termID / 10000) {
            case 1 :
                return __T("jpeg");
            case 2 :
                return __T("JPEG 2000");
            case 3 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        return __T("mpeg-ps");
            ...
            case 53 :
                return __T("wave64");
            default :
                return MI.Get(Stream_General, 0, General_Format);
        }
    }
...
//---------------------------------------------------------------------------
    ...
    Ztring Mpeg7_VisualCodingFormatCS_Name(int32u termID, MediaInfo_Internal &MI,
...
//---------------------------------------------------------------------------
    ...
    Ztring Mpeg7_AudioCodingFormatCS_Name(int32u termID, MediaInfo_Internal &MI,
                                          size_t StreamPos) //xxyyzz: xx=main number, yy=sub-number, zz=sub-sub-number
    {
        switch (termID / 10000) {
            case 1 :
            ...
            case 4 :
                switch ((termID % 10000) / 100) {
                    case 1 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Audio Low Sampling Rate Layer I");
                            case 2 :
                                return __T("MPEG-2 Audio Low Sampling Rate Layer II");
                            case 3 :
                                return __T("MPEG-2 Audio Low Sampling Rate Layer III");
                            default:
                                return __T("MPEG-2 Audio Low Sampling Rate");
                        }
                    case 2 :
                        switch (termID % 100) {
                            case 1 :
                                return __T("MPEG-2 Backward Compatible Multi-Channel Layer I");
                            case 2 :
                                return __T("MPEG-2 Backward Compatible Multi-Channel Layer II");
                            case 3 :
                                return __T("MPEG-2 Backward Compatible Multi-Channel Layer III");
                            default:
                                return __T("MPEG-2 Backward Compatible Multi-Channel");
                        }
                    default:
                        return __T("MPEG-2 Audio");
                }
            case 8 :
                return __T("Linear PCM");
            default:
    ...
    Ztring Mpeg7_AudioPresentationCS_Name(int32u termID, MediaInfo_Internal &, size_t) {
        switch (termID / 10000) {
            ...
            case 3 :
                return __T("stereo");
            case 5 :
                return __T("Home theater 5.1");
            case 6 :
                return __T("Movie theater");
            default:
                return Ztring();
        }
    }
...
//---------------------------------------------------------------------------
    Ztring Mpeg7_Transform_Visual(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos) {
        ...
        ToReturn += __T(">\n");
        ToReturn += __T("\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
        ToReturn += Mpeg7_VisualCodingFormatCS_Name((VisualCodingFormatCS_termID / 10000) * 10000, MI, StreamPos);
        ToReturn += __T("</mpeg7:Name>\n");
        if (VisualCodingFormatCS_termID % 10000) {
            ...
            ToReturn += __T("\">\n");
            ToReturn += __T("\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
            ToReturn += Mpeg7_VisualCodingFormatCS_Name((VisualCodingFormatCS_termID / 100) * 100, MI, StreamPos);
            ToReturn += __T("</mpeg7:Name>\n");
            if (VisualCodingFormatCS_termID % 100) {
                ...
                ToReturn += __T("\">\n");
                ToReturn += __T("\t\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
                ToReturn += Mpeg7_VisualCodingFormatCS_Name(VisualCodingFormatCS_termID, MI, StreamPos);
                ToReturn += __T("</mpeg7:Name>\n");
        ...
        //Frame
        ToReturn +=
                __T("\t\t\t\t\t\t\t\t<mpeg7:Frame aspectRatio=\"") + MI.Get(Stream_Video, 0, Video_DisplayAspectRatio);
        ToReturn += __T("\" height=\"");
        ToReturn += MI.Get(Stream_Video, 0, Video_Height);
        ToReturn += __T("\" width=\"");
        ToReturn += MI.Get(Stream_Video, 0, Video_Width);
        ToReturn += __T("\" rate=\"");
        ToReturn += MI.Get(Stream_Video, 0, Video_FrameRate);
        ToReturn += __T("\" structure=\"");
        ToReturn += MI.Get(Stream_Video, 0, Video_ScanType).MakeLowerCase();
        ToReturn += __T("\"/>\n");
...
//---------------------------------------------------------------------------
    Ztring Mpeg7_Transform_Audio(Ztring &ToReturn, MediaInfo_Internal &MI, size_t StreamPos) {
        ...
        ToReturn += __T(">\n");
        ToReturn += __T("\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
        ToReturn += Mpeg7_AudioCodingFormatCS_Name((AudioCodingFormatCS_termID / 10000) * 10000, MI, StreamPos);
        ToReturn += __T("</mpeg7:Name>\n");
        if (AudioCodingFormatCS_termID % 10000) {
            ...
            ToReturn += __T("\">\n");
            ToReturn += __T("\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
            ToReturn += Mpeg7_AudioCodingFormatCS_Name((AudioCodingFormatCS_termID / 100) * 100, MI, StreamPos);
            ToReturn += __T("</mpeg7:Name>\n");
            if (AudioCodingFormatCS_termID % 100) {
                ...
                ToReturn += __T("\">\n");
                ToReturn += __T("\t\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
                ToReturn += Mpeg7_AudioCodingFormatCS_Name(AudioCodingFormatCS_termID, MI, StreamPos);
                ToReturn += __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t\t\t\t\t\t</mpeg7:Term>\n");
            }
            ToReturn += __T("\t\t\t\t\t\t\t\t\t</mpeg7:Term>\n");
        ...
        //AudioChannels
        ToReturn += __T("\t\t\t\t\t\t\t\t<mpeg7:AudioChannels>");
        ToReturn += MI.Get(Stream_Audio, StreamPos, Audio_Channel_s_);
        ToReturn += __T("</mpeg7:AudioChannels>\n");

        //Sample
        ToReturn += __T("\t\t\t\t\t\t\t\t<mpeg7:Sample rate=\"");
        ToReturn += MI.Get(Stream_Audio, StreamPos, Audio_SamplingRate);
        ToReturn += __T("\"");
        if (!MI.Get(Stream_Audio, StreamPos, Audio_BitDepth).empty()) {
            ToReturn += __T(" bitsPer=\"");
            ToReturn += MI.Get(Stream_Audio, StreamPos, Audio_BitDepth);
            ToReturn += __T("\"");
        }
        ToReturn += __T("/>\n");
        ...
        if (MI.Get(Stream_Audio, StreamPos, Audio_Format) == __T("MPEG Audio"))
            ToReturn += __T("\t\t\t\t\t\t\t\t<mpeg7:Emphasis>") + Mpeg7_AudioEmphasis(MI, StreamPos) +
                        __T("</mpeg7:Emphasis>\n");
        ...
        if (AudioPresentationCS_termID) {
            ...
            ToReturn += __T("\">\n");
            ToReturn += __T("\t\t\t\t\t\t\t\t\t<mpeg7:Name>") +
                        Mpeg7_AudioPresentationCS_Name(AudioPresentationCS_termID, MI, StreamPos) +
                        __T("</mpeg7:Name>\n");
...
//---------------------------------------------------------------------------
    Ztring Export_Mpeg7::Transform(MediaInfo_Internal &MI) {
        ...
        Ztring TimeS;
        TimeS.Date_From_Seconds_1970((int32u) Time);
        ...
        ToReturn += __T("<!-- Generated at ") + TimeS + __T(" by ") + MediaInfoLib::Config.Info_Version_Get() +
                    __T(" -->\n");
        ToReturn += __T(
        ...
        if (!MI.Get(Stream_General, 0, General_Movie).empty()
            ...
            if (!MI.Get(Stream_General, 0, General_Movie).empty())
                ToReturn += __T("\t\t\t\t<mpeg7:Title type=\"songTitle\">") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Movie)) + __T("</mpeg7:Title>\n");
            if (!MI.Get(Stream_General, 0, General_Track).empty())
                ToReturn += __T("\t\t\t\t<mpeg7:Title type=\"songTitle\">") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Title)) + __T("</mpeg7:Title>\n");
            if (!MI.Get(Stream_General, 0, General_Album).empty())
                ToReturn += __T("\t\t\t\t<mpeg7:Title type=\"albumTitle\">") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Album)) + __T("</mpeg7:Title>\n");
            if (!MI.Get(Stream_General, 0, General_WrittenBy).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_WrittenBy)) + __T("</mpeg7:Name>\n");
            ...
            if (!MI.Get(Stream_General, 0, General_Performer).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Performer)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_ExecutiveProducer).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_ExecutiveProducer)) +
                            __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_Producer).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Producer)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_Director).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Director)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_Composer).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Composer)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_CostumeDesigner).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_CostumeDesigner)) +
                            __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_ProductionDesigner).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_ProductionDesigner)) +
                            __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_Publisher).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Publisher)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_DistributedBy).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Agent xsi:type=\"PersonGroupType\">\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_DistributedBy)) + __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Agent>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:Creator>\n");
            }
            if (!MI.Get(Stream_General, 0, General_Encoded_Library).empty()) {
                ...
                ToReturn += __T("\t\t\t\t\t<mpeg7:Tool>\n");
                ToReturn += __T("\t\t\t\t\t\t<mpeg7:Name>") +
                            Mpeg7_XML_Encode(MI.Get(Stream_General, 0, General_Encoded_Library)) +
                            __T("</mpeg7:Name>\n");
                ToReturn += __T("\t\t\t\t\t</mpeg7:Tool>\n");
                ToReturn += __T("\t\t\t\t</mpeg7:CreationTool>\n");
            }
        ...
        //MultimediaContent
        ToReturn += __T("\t\t<mpeg7:MultimediaContent xsi:type=\"");
        ToReturn += Mpeg7_Type(MI);
        ToReturn += __T("Type\">\n");
        ...
        ToReturn += __T(">\n");
        ToReturn += __T("\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
        ToReturn += Mpeg7_ContentCS_Name(ContentCS_termID, MI);
        ToReturn += __T("</mpeg7:Name>\n");
        ToReturn += __T("\t\t\t\t\t\t\t</mpeg7:Content>\n");
        ...
        if (!MI.Get(Stream_General, 0, General_Format).empty()) {
            ...
            ToReturn += __T(">\n");
            ToReturn += __T("\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
            ToReturn += Mpeg7_FileFormatCS_Name((FileFormatCS_termID / 10000) * 10000, MI);
            ToReturn += __T("</mpeg7:Name>\n");
            if (FileFormatCS_termID % 10000) {
                ...
                ToReturn += __T("\">\n");
                ToReturn += __T("\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
                ToReturn += Mpeg7_FileFormatCS_Name((FileFormatCS_termID / 100) * 100, MI);
                ToReturn += __T("</mpeg7:Name>\n");
                if (FileFormatCS_termID % 100) {
                    ...
                    ToReturn += __T("\">\n");
                    ToReturn += __T("\t\t\t\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
                    ToReturn += Mpeg7_FileFormatCS_Name(FileFormatCS_termID, MI);
                    ToReturn += __T("</mpeg7:Name>\n");
                    ToReturn += __T("\t\t\t\t\t\t\t\t\t\t</mpeg7:Term>\n");
                }
                ToReturn += __T("\t\t\t\t\t\t\t\t\t</mpeg7:Term>\n");
        ...
        if (!MI.Get(Stream_Video, 0, Video_Standard).empty()) {
            ...
            ToReturn += __T(">\n");
            ToReturn += __T("\t\t\t\t\t\t\t\t<mpeg7:Name xml:lang=\"en\">");
            ToReturn += Mpeg7_SystemCS_Name(SystemCS_termID);
            ToReturn += __T("</mpeg7:Name>\n");
            ToReturn += __T("\t\t\t\t\t\t\t</mpeg7:System>\n");
        }
        ...
        if (MI.Count_Get(Stream_Video) == 1 || MI.Count_Get(Stream_Audio) == 1) {
            ...
            ToReturn += __T("\t\t\t\t\t<mpeg7:MediaTimePoint>") + Mpeg7_MediaTimePoint(MI) +
                        __T("</mpeg7:MediaTimePoint>\n");

            //MediaDuration
            ToReturn += __T("\t\t\t\t\t<mpeg7:MediaDuration>");
            ToReturn += Mpeg7_MediaDuration(MI);
            ToReturn += __T("</mpeg7:MediaDuration>\n");
            ToReturn += __T("\t\t\t\t</mpeg7:MediaTime>\n");
        }
