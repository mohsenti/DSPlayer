...
//---------------------------------------------------------------------------
    void File_Vc3::CodingControlA() {
        ...
        Mark_0();
        Mark_0();
        Get_S1(2, FFC, "Field/Frame Count");
        Param_Info1(Vc3_FFC[FFC]);
...
//---------------------------------------------------------------------------
    void File_Vc3::CodingControlB() {
        ...
        Info_S1(1, FFE, "Field/Frame Count");
        Param_Info1(Vc3_FFE[FFE]);
        if (HVN == 1) {
            Mark_0();
            SSC = false;
        } else {
            Get_SB(SSC, "SSC: Sub Sampling Control");
            Param_Info1(Vc3_SSC[SSC]);
        }
        Mark_0();
        Mark_0();
        Mark_0();
        if (HVN == 1) {
            ...
            Get_S1(3, CLR, "CLR: Color");
            Param_Info1(Vc3_CLR[CLR]);
        }
...
//---------------------------------------------------------------------------
    void File_Vc3::UserData() {
        ...
        switch (UserDataLabel) {
            case 0x00:
                Skip_XX(260, "Reserved");
                break;
            case 0x08:
                UserData_8();
                break;
            default  :
                Skip_XX(260, "Reserved for future use");
        }
