    ...
    const char *Mpeg4v_Profile_Level(int32u Profile_Level) {
        switch (Profile_Level) {
            ...
            case B8(00001001) :
                return "Simple@L0b";
            case B8(00010000) :
                return "Simple Scalable@L0";
            case B8(00010001) :
                return "Simple Scalable@L1";
            case B8(00010010) :
                return "Simple Scalable@L2";
            case B8(00010101) :
                return "AVC"; //For descriptors
            case B8(00100001) :
                return "Core@L1";
            case B8(00100010) :
                return "Core@L2";
            ...
            case B8(01000010) :
                return "N-bit@L2";
            case B8(01010001) :
                return "Scalable Texture@L1";
            case B8(01100001) :
                return "Simple Face Animation@L1";
            case B8(01100010) :
                return "Simple Face Animation@L2";
            case B8(01100011) :
                return "Simple FBA@L1";
            case B8(01100100) :
                return "Simple FBA@L2";
            case B8(01110001) :
                return "Basic Animated Texture@L1";
            case B8(01110010) :
                return "Basic Animated Texture@L2";
            case B8(01111111) :
                return "AVC"; //For descriptors
            case B8(10000001) :
                return "Hybrid@L1";
            case B8(10000010) :
                return "Hybrid@L2";
            case B8(10010001) :
                return "Advanced Real Time Simple@L1";
            case B8(10010010) :
                return "Advanced Real Time Simple@L2";
            case B8(10010011) :
                return "Advanced Real Time Simple@L3";
            case B8(10010100) :
                return "Advanced Real Time Simple@L4";
            case B8(10100001) :
                return "Core Scalable@L1";
            case B8(10100010) :
                return "Core Scalable@L2";
            case B8(10100011) :
                return "Core Scalable@L3";
            case B8(10110001) :
                return "Advanced Coding Efficiency@L1";
            case B8(10110010) :
                return "Advanced Coding Efficiency@L2";
            case B8(10110011) :
                return "Advanced Coding Efficiency@L3";
            case B8(10110100) :
                return "Advanced Coding Efficiency@L4";
            case B8(11000001) :
                return "Advanced Core@L1";
            case B8(11000010) :
                return "Advanced Core@L2";
            case B8(11010001) :
                return "Advanced Scalable Texture@L1";
            case B8(11010010) :
                return "Advanced Scalable Texture@L2";
            case B8(11010011) :
                return "Advanced Scalable Texture@L3";
            case B8(11100001) :
                return "Simple Studio@L1";
            case B8(11100010) :
                return "Simple Studio@L2";
            case B8(11100011) :
                return "Simple Studio@L3";
            case B8(11100100) :
                return "Simple Studio@L4";
            case B8(11100101) :
                return "Core Studio@L1";
            case B8(11100110) :
                return "Core Studio@L2";
            case B8(11100111) :
                return "Core Studio@L3";
            case B8(11101000) :
                return "Core Studio@L4";
            case B8(11101011) :
                return "Simple Studio@L5";
            case B8(11101100) :
                return "Simple Studio@L6";
            case B8(11110000) :
            ...
            case B8(11111000) :
                return "Fine Granularity Scalable@L0";
            case B8(11111001) :
                return "Fine Granularity Scalable@L1";
            case B8(11111010) :
                return "Fine Granularity Scalable@L2";
            case B8(11111011) :
                return "Fine Granularity Scalable@L3";
            case B8(11111100) :
                return "Fine Granularity Scalable@L4";
            case B8(11111101) :
                return "Fine Granularity Scalable@L5";
            default :
                return "";
        }
    }
    ...
    void File_Mpeg4v::Streams_Fill() {
        ...
        if (fixed_vop_time_increment && vop_time_increment_resolution)
            Fill(Stream_Video, StreamPos_Last, Video_FrameRate,
                 ((float) vop_time_increment_resolution) / fixed_vop_time_increment);
        if (object_layer_height) {
            ...
            else if (aspect_ratio_info == 0x0F && par_height)
                PixelAspectRatio_Value = ((float32) par_width) / par_height;
            Fill(Stream_Video, 0, Video_PixelAspectRatio, PixelAspectRatio_Value, 3, true);
            Fill(Stream_Video, StreamPos_Last, Video_DisplayAspectRatio,
                 ((float) object_layer_width) / object_layer_height * PixelAspectRatio_Value, 3, true);
        }
        ...
        if (colour_description) {
            ...
            Fill(Stream_Video, 0, Video_transfer_characteristics,
                 Mpegv_transfer_characteristics(transfer_characteristics));
        ...
        if (no_of_sprite_warping_points) {
            Fill(Stream_Video, 0, Video_Format_Settings,
                 Ztring(__T("GMC")) + Ztring::ToZtring(no_of_sprite_warping_points));
        ...
        for (size_t Pos = 0; Pos < user_data_start_SNC_Data.size(); Pos++) {
            if (user_data_start_SNC_Data[Pos][0] == __T("CamTim"))
                Fill(Stream_General, 0, General_Recorded_Date,
                     Ztring().Date_From_String(user_data_start_SNC_Data[Pos][1].To_UTF8().c_str()));
            ...
            if (user_data_start_SNC_Data[Pos][0] == __T("CamPos") && user_data_start_SNC_Data[Pos][1].size() == 16) {
                Fill(Stream_Video, 0, "Pan / Tilt / Zoom / Status",
                     Ztring(user_data_start_SNC_Data[Pos][1].substr(3, 4)).To_int8u(16));
                Fill(Stream_Video, 0, "Pan / Tilt / Zoom / Status",
                     Ztring(user_data_start_SNC_Data[Pos][1].substr(7, 4)).To_int8u(16));
                Fill(Stream_Video, 0, "Pan / Tilt / Zoom / Status",
                     Ztring(user_data_start_SNC_Data[Pos][1].substr(11, 4)).To_int8u(16));
...
//---------------------------------------------------------------------------
    void File_Mpeg4v::Streams_Finish() {
        ...
        if (!IsSub && Time_End_Seconds != (int32u) -1 && Time_Begin_Seconds != (int32u) -1) {
            int32u Duration =
                    (Time_End_Seconds - Time_Begin_Seconds) * 1000 + Time_End_MilliSeconds - Time_Begin_MilliSeconds;
            if (fixed_vop_time_increment && vop_time_increment_resolution)
                Duration += float32_int32s(
                        ((float) 1000) / (((float) vop_time_increment_resolution) / fixed_vop_time_increment));
...
//---------------------------------------------------------------------------
    ...
    bool File_Mpeg4v::Demux_UnpacketizeContainer_Test() {
        if ((Demux_IntermediateItemFound && Buffer[Buffer_Offset + 3] == 0xB0) || Buffer[Buffer_Offset + 3] == 0xB3 ||
            Buffer[Buffer_Offset + 3] == 0xB6) {
            if (Demux_Offset == 0) {
    ...
    void File_Mpeg4v::Data_Parse() {
        ...
        switch (Element_Code) {
            ...
            case 0xBA:
                ...
                break;
            case 0xBB:
                fba_object_plane_start();
                break;
            case 0xBC:
                mesh_object_start();
                break;
            case 0xBD:
                mesh_object_plane_start();
                break;
            case 0xBE:
                still_texture_object_start();
                break;
            case 0xBF:
                texture_spatial_layer_start();
                break;
            case 0xC0:
                texture_snr_layer_start();
                break;
            case 0xC1:
                texture_tile_start();
                break;
            case 0xC2:
                texture_shape_layer_start();
                break;
            case 0xC3:
                stuffing_start();
                break;
...
// Packet "20"
    void File_Mpeg4v::video_object_layer_start() {
        ...
        if (profile_and_level_indication >= B8(11100001) &&
            profile_and_level_indication <= B8(11101000)) // Test if "Studio" profile
        {
            Get_S1(4, visual_object_verid, "video_object_layer_verid");
            Param_Info1(Mpeg4v_video_object_layer_verid[video_object_layer_verid]);
            ...
            if (shape != 2) //Shape!=BinaryOnly
            {
                ...
                Param_Info1(Mpeg4v_Colorimetry[chroma_format]);
            ...
            TEST_SB_SKIP("is_object_layer_identifier");
                    Get_S1(4, video_object_layer_verid, "video_object_layer_verid");
                    Param_Info1(Mpeg4v_video_object_layer_verid[video_object_layer_verid]);
            ...
            TEST_SB_SKIP("fixed_vop_rate");
                    Get_BS(time_size, fixed_vop_time_increment, "fixed_vop_time_increment");
                    Param_Info2C((vop_time_increment_resolution),
                                 fixed_vop_time_increment * 1000 / vop_time_increment_resolution, " ms");
            TEST_SB_END();
            if (shape != 2) //Shape!=BinaryOnly
            {
                if (shape == 0) //Shape=Rectangular
        ...
        //Coherancy
        if (shape == 0 && (object_layer_width == 0 || object_layer_height == 0 ||
                           ((float32) object_layer_width) / object_layer_height < ((float32) 0.1) ||
...
// Packet "B0"
    void File_Mpeg4v::visual_object_sequence_start() {
        ...
        //Parsing
        Get_B1(profile_and_level_indication, "profile_and_level_indication");
        Param_Info1(Mpeg4v_Profile_Level(profile_and_level_indication));
        ...
        FILLING_BEGIN() ;
            if (Temp.size() >= 4) {
                ...
                if (Library.find(__T("DivX50")) == 0) {
                    ...
                    Library_Version = MediaInfoLib::Config.Library_Get(InfoLibrary_Format_DivX, Version,
                                                                       InfoLibrary_Version);
                ...
                if (Library.find(__T("XviD")) == 0) {
                    ...
                    if (Library.find(__T("build=")) == std::string::npos) {
                        ...
                        Library_Version = MediaInfoLib::Config.Library_Get(InfoLibrary_Format_XviD, Version,
                                                                           InfoLibrary_Version);
                        if (Library_Version.empty())
                            Library_Version = Version;
                        Library_Date = MediaInfoLib::Config.Library_Get(InfoLibrary_Format_XviD, Version,
                                                                        InfoLibrary_Date);
                    } else {
...
// Packet "B5"
    void File_Mpeg4v::visual_object_start() {
        ...
        if (profile_and_level_indication >= B8(11100001) &&
            profile_and_level_indication <= B8(11101000)) // Test if "Studio" profile
        {
            Get_S1(4, visual_object_verid, "visual_object_verid");
            Param_Info1(Mpeg4v_visual_object_verid[visual_object_verid]);
        } else {
        ...
        Get_S1(4, visual_object_type, "visual_object_type");
        Param_Info1(Mpeg4v_visual_object_type[visual_object_type]);
        if (profile_and_level_indication<B8(11100001) || profile_and_level_indication>B8(11101000) &&
            (visual_object_type == 1 || visual_object_type == 2)) {
...
// Packet "B6"
    void File_Mpeg4v::vop_start() {
        Element_Info1C((FrameInfo.DTS != (int64u) -1), __T("DTS ") + Ztring().Duration_From_Milliseconds(
            ...
            profile_and_level_indication <= B8(11101000)) // Test if "Studio" profile
        {
            ...
            Get_S1(2, vop_coding_type, "vop_coding_type");
            Param_Info1(Mpeg4v_vop_coding_type[vop_coding_type]);
            ...
            Get_S4(time_size, vop_time_increment, "vop_time_increment");
            Param_Info2C((vop_time_increment_resolution), vop_time_increment * 1000 / vop_time_increment_resolution,
                         " ms");
            Mark_1();
            Get_SB(vop_coded, "vop_coded");
            if (vop_coded) {
        ...
        FILLING_BEGIN() ;
            ...
            if (!Mpeg4v_visual_object_type[visual_object_type][0] && vop_time_increment_resolution) {
                int16u Time =
                        modulo_time_base * 1000 + (int16u) vop_time_increment * 1000 / vop_time_increment_resolution;
                ...
                Element_Info1C((Time_End_Seconds != (int32u) -1), Ztring().Duration_From_Milliseconds(
                        (int64u) (Time_End_Seconds * 1000 + Time_End_MilliSeconds)));

                if (FrameInfo.DTS != (int64u) -1) {
                    if (fixed_vop_time_increment && vop_time_increment_resolution)
                        FrameInfo.DTS +=
                                ((int64u) fixed_vop_time_increment) * 1000000000 / vop_time_increment_resolution;
                    else
