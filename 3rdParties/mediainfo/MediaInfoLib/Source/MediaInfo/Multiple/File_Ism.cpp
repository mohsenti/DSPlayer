                        ...
                        while (Switch) {
                            if (string(Switch->Value()) == "switch") {
                                ...
                                while (Stream) {
                                    ...
                                    if (Value == "video" || Value == "videostream" || Value == "audio" ||
                                        Value == "audiostream" || Value == "text" || Value == "textstream") {
                                        ...
                                        if (!Sequence->FileNames.empty() && !Sequence->FileNames[0].empty() &&
                                            FileNames.find(Sequence->FileNames[0]) == FileNames.end()) {
