    ...
    static const char *Mpeg_Psi_ATSC_table_type(int16u ID) {
        switch (ID) {
            ...
            case 0x0005 :
                return "DCCSCT";
            case 0x0010 :
                return "Short-form Virtual Channel Table-VCM Subtyp";
            case 0x0011 :
                return "Short-form Virtual Channel Table-DCM Subtyp";
            case 0x0012 :
                return "Short-form Virtual Channel Table-ICM Subtyp";
            case 0x0020 :
                return "Network Information Table-CDS Table Subtype";
            case 0x0021 :
                return "Network Information Table-MMS Table Subtype";
            case 0x0030 :
                return "Network Text Tabl e-SNS Subtype";
            default :
                if (ID >= 0x0100
                    && ID <= 0x017F)
                ...
                if (ID >= 0x0200
                    && ID <= 0x027F)
                    return "Event Extended Text Table (EETT)";
                if (ID >= 0x0300
                    && ID <= 0x03FF)
                    return "Rating Region Table (RRT)";
                if (ID >= 0x0400
                    && ID <= 0x0FFF)
                    return "User private";
                if (ID >= 0x1000
                    && ID <= 0x10FF)
                    return "Aggregate Event Information Table (AEIT)";
                if (ID >= 0x1100
                    && ID <= 0x11FF)
                    return "Aggregate Extended Text Table (AETT)";
                if (ID >= 0x1400
                    && ID <= 0x14FF)
                    return "DCCT";
                return "Reserved";
...
//---------------------------------------------------------------------------
    const char *Mpeg_Psi_stream_type_Format(int8u stream_type, int32u format_identifier) {
        switch (stream_type) {
            case 0x01 :
                return "MPEG Video"; //Version 1
            case 0x02 :
                return "MPEG Video"; //Version 2
            case 0x03 :
                return "MPEG Audio"; //Version 1
            case 0x04 :
                return "MPEG Audio"; //Version 2
            case 0x0F :
                return "AAC";
            case 0x10 :
            ...
            case 0x1D :
                return "Timed Text";
            case 0x1E :
                return "MPEG Video"; //ISO/IEC 23002-3
            case 0x1F :
                return "AVC";
            case 0x20 :
                return "AVC";
                    ...
                    case Elements::HDMV : //Bluray
                        switch (stream_type) {
                            ...
                            case 0x91 :
                                return "PGS";
                            case 0x92 :
                                return "TEXTST"; //Blu-ray subtitle text
                            case 0xA1 :
                                return "AC-3";
                            case 0xA2 :
                                return "DTS";
...
//---------------------------------------------------------------------------
    const char *Mpeg_Psi_stream_type_Info(int8u stream_type, int32u format_identifier) {
        switch (stream_type) {
            ...
            case 0x1F :
                return "SVC video sub-bitstream of an AVC video stream conforming to one or more profiles defined in Annex G of ITU-T Rec. H.264 | ISO/IEC 14496-10";
            case 0x20 :
            ...
            case 0x24 :
            case 0x27 :
                return "ITU-T Rec. H.265 | ISO/IEC 23008-2 MPEG-H Part 2 / HEVC video stream";
            case 0x7F :
                return "IPMP stream";
            default :
                ...
                switch (format_identifier) {
                    ...
                    case Elements::SCTE : //SCTE
                        switch (stream_type) {
                            case 0x80 :
                                return "SCTE - MPEG Video";
                            case 0x81 :
                                return "ATSC - AC-3";
                            case 0x82 :
                                return "SCTE - Standard Subtitle";
                            case 0x83 :
                                return "SCTE - Isochronous Data";
                            case 0x84 :
                                return "ATSC - Reserved";
                            case 0x85 :
                                return "ATSC - Program Identifier";
                            case 0x86 :
                                return "SCTE - Splice";
                            case 0x87 :
                                return "ATSC - E-AC-3";
                    ...
                    case Elements::HDMV : //Bluray
                        switch (stream_type) {
                            ...
                            case 0x82 :
                                return "BluRay - DTS";
                            case 0x83 :
                                return "BluRay - AC-3 (TrueHD)";
                            case 0x84 :
                                return "BluRay - E-AC-3";
                            case 0x85 :
                                return "BluRay - DTS (HD-HRA)";
                            case 0x86 :
                                return "BluRay - DTS (HD-MA)";
                            case 0x90 :
                                return "BluRay - PGS";
                            case 0x91 :
                                return "BluRay - PGS";
                            case 0x92 :
                                return "BluRay - TEXTST";
                            case 0xA1 :
                                return "BluRay - AC-3";
                            case 0xA2 :
                                return "BluRay - DTS";
...
//---------------------------------------------------------------------------
    const char *Mpeg_Psi_table_id(int8u table_id) {
        switch (table_id) {
            ...
            case 0x39 :
                return "DSM-CC addressable section";
            case 0x3A :
                return "DSM-CC : return MPE";
            case 0x3B :
                return "DSM-CC : return U-N messages : return except DDM";
            case 0x3C :
                return "DSM-CC : return DDM";
            case 0x3D :
                return "DSM-CC : return stream descriptors";
            case 0x3E :
                return "DSM-CC : return private data : return IP-Datagram";
            case 0x3F :
                return "DSM-CC addressable section";
            case 0x40 :
                return "DVB - network_information_section - actual_network";
            case 0x41 :
                return "DVB - network_information_section - other_network";
            case 0x42 :
                return "DVB - service_description_section - actual_transport_stream";
            case 0x46 :
                return "DVB - service_description_section - other_transport_stream";
            case 0x4A :
                return "DVB - bouquet_association_section";
            case 0x4E :
                return "DVB - event_information_section - actual_transport_stream : return present/following";
            case 0x4F :
                return "DVB - event_information_section - other_transport_stream : return present/following";
            case 0x50 :
            case 0x51 :
            case 0x52 :
            case 0x53 :
            ...
            case 0x5E :
            case 0x5F :
                return "DVB - event_information_section - actual_transport_stream : return schedule";
            case 0x60 :
            case 0x61 :
            case 0x62 :
            case 0x63 :
            ...
            case 0x6E :
            case 0x6F :
                return "DVB - event_information_section - other_transport_stream : return schedule";
            case 0x70 :
                return "DVB - time_date_section";
            case 0x71 :
                return "DVB - running_status_section";
            case 0x72 :
                return "DVB - stuffing_section";
            case 0x73 :
                return "DVB - time_offset_section";
            case 0x74 :
                return "DVB - application information section";
            case 0x75 :
                return "DVB - container section";
            case 0x76 :
                return "DVB - related content section";
            case 0x77 :
                return "DVB - content identifier section";
            case 0x78 :
                return "DVB - MPE-FEC section";
            case 0x79 :
                return "DVB - resolution notification section";
            case 0x7E :
                return "DVB - discontinuity_information_section";
            case 0x7F :
                return "DVB - selection_information_section";
            case 0xC0 :
                return "ATSC - Program Information Message";
            case 0xC1 :
                return "ATSC - Program Name Message";
            case 0xC2 :
                return "ATSC/SCTE - Network Information Message";
            case 0xC3 :
                return "ATSC/SCTE - Network Text Table (NTT)";
            case 0xC4 :
                return "ATSC/SCTE - Short Form Virtual Channel Table (S-VCT)";
            case 0xC5 :
                return "ATSC/SCTE - System Time Table (STT)";
            case 0xC6 :
                return "ATSC/SCTE - Subtitle Message";
            case 0xC7 :
                return "ATSC - Master Guide Table (MGT)";
            case 0xC8 :
                return "ATSC - Terrestrial Virtual Channel Table (TVCT)";
            case 0xC9 :
                return "ATSC - Cable Virtual Channel Table (CVCT) / Long-form Virtual Channel Table (L-VCT)";
            case 0xCA :
                return "ATSC - Rating Region Table (RRT)";
            case 0xCB :
                return "ATSC - Event Information Table (EIT)";
            case 0xCC :
                return "ATSC - Extended Text Table (ETT)";
            case 0xCD :
                return "ATSC - System Time Table (STT)";
            case 0xCE :
                return "ATSC - Data Event Table (DET)";
            case 0xCF :
                return "ATSC - Data Service Table (DST)";
            case 0xD0 :
                return "ATSC - Program Identifier Table (PIT)";
            case 0xD1 :
                return "ATSC - Network Resource Table (NRT)";
            case 0xD2 :
                return "ATSC - Long-term Service Table (L-TST)";
            case 0xD3 :
                return "ATSC - Directed Channel Change Table (DCCT)";
            case 0xD4 :
                return "ATSC - DCC Selection Code Table (DCCSCT)";
            case 0xD5 :
                return "ATSC - Selection Information Table (SIT)";
            case 0xD6 :
                return "ATSC - Aggregate Event Information Table (AEIT)";
            case 0xD7 :
                return "ATSC - Aggregate Extended Text Table (AETT)";
            case 0xD8 :
                return "ATSC - Cable Emergency Alert";
            case 0xD9 :
                return "ATSC - Aggregate Data Event Table";
            case 0xDA :
                return "ATSC - Satellite VCT (SVCT)";
            case 0xFC :
                return "SCTE - Splice";
            default :
                if (table_id >= 0x06
    ...
    static string Mpeg_Psi_atsc_modulation_mode(int8u modulation_mode) {
        switch (modulation_mode) {
            ...
            case 0x05 :
                return "ATSC (16 VSB)";
            default   :
                return Ztring::ToZtring(modulation_mode).To_UTF8();
        }
    }
    ...
    static const char *Mpeg_Psi_table_id_extension(int8u table_id) {
        switch (table_id) {
            ...
            case 0x6F :
                return "service_id";
            case 0x7F :
                return "DVB_reserved_for_future_use";
            case 0xC8 :
            case 0xC9 :
                return "transport_stream_id";
            case 0xCA :
                return "reserved + rating_region";
            case 0xCB :
                return "source_id";
            case 0xCC :
                return "ETT_table_id_extension";
            case 0xD9 :
                return "AEIT_subtype + MGT_tag";
            case 0xDA :
                return "SVCT_subtype + SVCT_id";
            default :
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Header_Parse() {
        ...
        //Size
        if ((size_t) section_length <
            Element_Offset + (section_syntax_indicator ? 4 : 0)) //We must have 4 more byte for CRC
        {
        ...
        if (section_syntax_indicator || table_id == 0xC1) {
            ...
            while (CRC_32_Buffer < Buffer + Buffer_Offset + (size_t) Element_Offset +
                                   section_length) //from table_id to the end, CRC_32 included
            {
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Data_Parse() {
        ...
        if (section_syntax_indicator) {
            ...
            Get_B2(table_id_extension, Mpeg_Psi_table_id_extension(table_id));
            Element_Name(Ztring(Mpeg_Psi_table_id_extension(table_id)) + __T("=") +
                         Ztring::ToZtring_From_CC2(table_id_extension));
            BS_Begin();
            Skip_S1(2, "reserved");
            Get_S1(5, version_number, "version_number");
            Element_Info1(__T("Version=") + Ztring::ToZtring(version_number));
            Get_SB(current_next_indicator, "current_next_indicator");
            BS_End();
            Info_B1(section_number, "section_number");
            Element_Info1(__T("Section=") + Ztring::ToZtring(section_number));
...
#define ELEMENT_CASE(_NAME, _DETAIL) \
        ...
        switch (table_id) {
            ...
            default :
                if (table_id >= 0x06
                    && table_id <= 0x37) {
                    Element_Name("ITU-T Rec. H.222.0 | ISO/IEC 13818-1 reserved");
                    Skip_XX(Element_Size, "Unknown");
                    break;
                }
                if (table_id >= 0x40
                    && table_id <= 0x7F) {
                    Element_Name("DVB - reserved");
                    Skip_XX(Element_Size, "Unknown");
                    break;
                }
                if (table_id >= 0x80
                    && table_id <= 0x8F) {
                    Element_Name("CA message, EMM, ECM");
                    Skip_XX(Element_Size, "Unknown");
                    break;
                }
                if (table_id >= 0xC0
                    && table_id <= 0xDF) {
                    Element_Name("ATSC/SCTE - reserved");
                    Skip_XX(Element_Size, "Unknown");
                    break;
                }
                if (table_id <= 0xFE) {
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::program_stream_map() {
        ...
        while (Element_Offset < Element_Size && elementary_stream_map_Pos < elementary_stream_map_length) {
            ...
            Get_B1(stream_type, "stream_type");
            Param_Info1(Mpeg_Psi_stream_type_Info(stream_type, 0x00000000));
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_00() {
        ...
        if (!Complete_Stream->transport_stream_id_IsValid ||
            ...
            if (Complete_Stream->Transport_Streams.find(Complete_Stream->transport_stream_id) !=
        ...
        for (complete_stream::stream::table_id::table_id_extensions::iterator Table_ID_Extension = Complete_Stream->Streams[0x0000]->Table_IDs[0x00]->Table_ID_Extensions.begin();
             Table_ID_Extension !=
             Complete_Stream->Streams[0x0000]->Table_IDs[0x00]->Table_ID_Extensions.end(); ++Table_ID_Extension)
        ...
        while (Element_Offset < Element_Size) {
            ...
            BS_Begin();
            Skip_S1(3, "reserved");
            Get_S2(13, elementary_PID, program_number ? "program_map_PID" : "network_PID");
            Element_Info1(Ztring::ToZtring_From_CC2(elementary_PID));
            BS_End();
            Element_End0();
            ...
            FILLING_BEGIN() ;
                if (elementary_PID
                    ...
                    std::map<int16u, complete_stream::transport_stream::program>::iterator program_number_Previous = program_numbers_Previous.find(
                            program_number);
        ...
        FILLING_BEGIN() ;
            ...
            for (std::map<int16u, complete_stream::transport_stream::program>::iterator program_number_Previous = program_numbers_Previous.begin();
                 program_number_Previous != program_numbers_Previous.end(); ++program_number_Previous) {
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_02() {
        ...
        while (Element_Offset < Element_Size) {
            Element_Begin0();
            BS_Begin();
            Get_S1(8, stream_type, "stream_type");
            Element_Info1(Mpeg_Psi_stream_type_Info(stream_type,
                                                    Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Programs[program_number].registration_format_identifier));
            Param_Info1(Mpeg_Psi_stream_type_Info(stream_type,
                                                  Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Programs[program_number].registration_format_identifier));
            Skip_S1(3, "reserved");
            ...
            FILLING_BEGIN() ;
                ...
                if (stream_type == 0x20 && File_Name_WithoutDemux.size() >= 4 + 1 + 6 + 1 + 4 + 1 + 10 &&
                    ...
                    ZtringList List = Dir::GetAllFileNames(
                            Name + __T("BDMV") + PathSeparator + __T("PLAYLIST") + PathSeparator + __T("*.mpls"),
                            Dir::Include_Files);
                    ...
                    if (FileWithRightPID_Pos != (size_t) -1) {
                        ...
                        if (ID_List.size() == 2) {
                            ...
                            for (size_t Pos = 0;
                                 Pos < Complete_Stream->Streams[elementary_PID]->program_numbers.size(); Pos++)
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_40() {
        ...
        if (Element_Offset < Element_Size) {
            ...
            Element_Info1(transport_stream_id);
            Get_B2(original_network_id, "original_network_id");
    ...
    void File_Mpeg_Psi::Table_42() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            if (Test != 0xFFFFFFFFFFULL) {
                ...
                Info_S1(3, running_status, "running_status");
                Param_Info1(Mpeg_Psi_running_status[running_status]);
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_4E() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            Get_B2(date, "start_time (date)");
            Param_Info1(Date_MJD(date));
            Get_B3(time, "start_time (time)");
            Param_Info1(Time_BCD(time));
            Get_B3(duration, "duration");
            Param_Info1(Time_BCD(duration));
            BS_Begin();
            Get_S1(3, running_status, "running_status");
            Param_Info1(Mpeg_Psi_running_status[running_status]);
            Skip_SB("free_CA_mode");
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_70() {
        ...
        int32u time;
        int16u date;
        Get_B2(date, "UTC_time (date)");
        Param_Info1(Date_MJD(date));
        Get_B3(time, "UTC_time (time)");
        Param_Info1(Time_BCD(time));
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_C7() {
        ...
        for (int16u Pos = 0; Pos < tables_defined; Pos++) {
            ...
            Element_Begin0();
            Get_B2(table_type, "table_type");
            Param_Info1(Mpeg_Psi_ATSC_table_type(table_type));
            BS_Begin();
            Skip_S1(3, "reserved");
            ...
            FILLING_BEGIN() ;
                if (Complete_Stream->Streams[table_type_PID]->Kind == complete_stream::stream::unknown &&
                    table_type != 0x0001 && table_type != 0x0003) //Not activing current_next_indicator='0'
                {
                ...
                if (table_id != 0xFF && Complete_Stream->Streams[table_type_PID]->Table_IDs[table_id] == NULL)
                    Complete_Stream->Streams[table_type_PID]->Table_IDs[table_id] = new complete_stream::stream::table_id; //Master Guide Table
#endif //MEDIAINFO_MPEGTS_ALLSTREAMS_YES
                Complete_Stream->Streams[table_type_PID]->table_type = table_type - ((table_type & 0x200) ? 0x100
                                                                                                          : 0); //For having the same table_type for both EIT and ETT
            FILLING_END();
        }
        BS_Begin();
        Skip_S1(4, "reserved");
        ...
        for (int8u Pos = 0; Pos < num_channels_in_section; Pos++) {
            ...
            FILLING_BEGIN() ;
                ...
                if (minor_channel_number == 0 || program_number == 0xFFFF) {
                    ...
                    Complete_Stream->Transport_Streams[table_id_extension].Infos["ServiceType"] = Mpeg_Psi_atsc_service_type(
                            service_type);
                    ...
                    Complete_Stream->Transport_Streams[table_id_extension].Programs[program_number].Infos["ServiceType"] = Mpeg_Psi_atsc_service_type(
                            service_type);
                ...
                if (modulation_mode)
                    Complete_Stream->Transport_Streams[table_id_extension].Programs[program_number].Infos["ModulationMode"].From_UTF8(
                            Mpeg_Psi_atsc_modulation_mode(modulation_mode).c_str());
            FILLING_END();
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_CA() {
        ...
        for (int8u dimension_Pos = 0; dimension_Pos < dimensions_defined; dimension_Pos++) {
            ...
            ATSC_multiple_string_structure(dimension_name, "dimension_name");
            Element_Info1(dimension_name);
            BS_Begin();
            Skip_S1(3, "reserved");
            ...
            for (int8u value_Pos = 0; value_Pos < values_defined; value_Pos++) {
                ...
                ATSC_multiple_string_structure(abbrev_rating_value, "abbrev_rating_value");
                Element_Info1(abbrev_rating_value);
                Skip_B1("rating_value_length"); //Not used
                ATSC_multiple_string_structure(rating_value, "rating_value");
                Element_Info1(rating_value);
                Element_End0();
            }
            Element_End0();
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_CB() {
        ...
        for (int8u Pos = 0; Pos < num_events_in_section; Pos++) {
            ...
            BS_End();
            Get_B4(start_time, "start_time");
            Param_Info1(Ztring().Date_From_Seconds_1970(start_time + 315964800));
            Element_Info1(Ztring().Date_From_Seconds_1970(
                    start_time + 315964800 - Complete_Stream->GPS_UTC_offset)); //UTC 1980-01-06 00:00:00
            BS_Begin();
            Skip_S1(2, "reserved");
            ...
            FILLING_BEGIN() ;
                ...
                Ztring duration =
                        (length_in_seconds < 36000 ? __T("0") : __T("")) + Ztring::ToZtring(length_in_seconds / 3600) +
                        __T(":");
                length_in_seconds %= 3600;
                duration += (length_in_seconds < 600 ? __T("0") : __T("")) + Ztring::ToZtring(length_in_seconds / 60) +
                            __T(":");
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_CD() {
        ...
        Skip_B1("protocol_version");
        Get_B4(system_time, "system_time");
        Param_Info1(Ztring().Date_From_Seconds_1970(system_time + 315964800)); //UTC 1980-01-06 00:00:00
        ...
        FILLING_BEGIN() ;
            if (Complete_Stream->Duration_Start.empty())
                Complete_Stream->Duration_Start = Ztring().Date_From_Seconds_1970(
                        system_time + 315964800 - GPS_UTC_offset);
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::Table_FC() {
        ...
        Get_S1(8, splice_command_type, "splice_command_type");
        Param_Info1(Mpeg_Psi_splice_command_type(splice_command_type));
        BS_End();
...
#define ELEMENT_CASE(_NAME, _DETAIL) \
        ...
        switch (splice_command_type) {
            ...
            break;
            default   :
                Skip_XX(splice_command_length, "Unknown");
        }
        Element_End0();
    ...
    void File_Mpeg_Psi::program_number_Update() {
        ...
        if (program_number) {
            ...
            if (Complete_Stream->Streams[elementary_PID]->Table_IDs.size() < 0x100)
                Complete_Stream->Streams[elementary_PID]->Table_IDs.resize(
                        0x100); //TODO: find the reason this code is called
            ...
            if (Complete_Stream->Streams[elementary_PID]->Table_IDs[0x02]->Table_ID_Extensions.find(program_number) ==
                Complete_Stream->Streams[elementary_PID]->Table_IDs[0x02]->Table_ID_Extensions.end()) {
                ...
                Complete_Stream->Streams[elementary_PID]->Table_IDs[0x02]->Table_ID_Extensions[program_number].Section_Numbers.resize(
                        0x100);
            }
        }
        ...
        for (size_t Pos = 0; Pos < progItem.elementary_PIDs.size(); Pos++) {
            ...
            for (size_t Pos = 0; Pos < Complete_Stream->Streams[elementary_PID_Temp]->program_numbers.size(); Pos++)
                if (Complete_Stream->Streams[elementary_PID_Temp]->program_numbers[Pos] == program_number)
                    Complete_Stream->Streams[elementary_PID_Temp]->program_numbers.erase(
                            Complete_Stream->Streams[elementary_PID_Temp]->program_numbers.begin() + Pos);
            ...
            if (Complete_Stream->Streams[elementary_PID_Temp]->program_numbers.empty()) {
                ...
                if (Complete_Stream->Streams_NotParsedCount != (size_t) -1 && Complete_Stream->Streams_NotParsedCount &&
                    !Complete_Stream->Streams[elementary_PID_Temp]->IsParsed)
                    Complete_Stream->Streams_NotParsedCount--; //Not parsed, and no need to parse it now
                delete Complete_Stream->Streams[elementary_PID_Temp];
                Complete_Stream->Streams[elementary_PID_Temp] = new complete_stream::stream;
            }
        }

        //Removing related PCR
        std::map<int16u, int16u>::iterator PCR_PID = Complete_Stream->PCR_PIDs.find(
                Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Programs[program_number].PCR_PID);
        ...
        if (program_number_pid) {
            for (size_t Pos = 0; Pos < Complete_Stream->Streams[program_number_pid]->program_numbers.size(); Pos++)
                if (Complete_Stream->Streams[program_number_pid]->program_numbers[Pos] == program_number)
                    Complete_Stream->Streams[program_number_pid]->program_numbers.erase(
                            Complete_Stream->Streams[program_number_pid]->program_numbers.begin() + Pos);
            if (Complete_Stream->Streams[program_number_pid]->Table_IDs[0x02])
                Complete_Stream->Streams[program_number_pid]->Table_IDs[0x02]->Table_ID_Extensions.erase(
                        program_number);
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::elementary_PID_Update(int16u PCR_PID) {
        ...
        //stream_type
        if (stream_type != Complete_Stream->Streams[elementary_PID]->stream_type &&
            Complete_Stream->Streams[elementary_PID]->stream_type != (int8u) -1) {
            if (Complete_Stream->Streams_NotParsedCount != (size_t) -1 && Complete_Stream->Streams_NotParsedCount &&
                !Complete_Stream->Streams[elementary_PID]->IsParsed)
                Complete_Stream->Streams_NotParsedCount--; //Not parsed, and no need to parse it now
            delete Complete_Stream->Streams[elementary_PID];
            Complete_Stream->Streams[elementary_PID] = new complete_stream::stream;
        ...
        if (!IsAlreadyPresent) {
            ...
            progItem.elementary_PIDs.push_back(elementary_PID);
            Complete_Stream->Streams[elementary_PID]->program_numbers.push_back(program_number);
            if (ForceStreamDisplay || (progItem.registration_format_identifier == Elements::HDMV &&
                                       Complete_Stream->Streams[elementary_PID]->stream_type ==
                                       0x90)) //Testing if forcing display of all streams or if it is a PGS from Blu-ray
...
//---------------------------------------------------------------------------
    void File_Mpeg_Psi::elementary_PID_Remove() {
        ...
        for (size_t Pos = 0; Pos < Complete_Stream->Streams[elementary_PID]->program_numbers.size(); Pos++)
            if (Complete_Stream->Streams[elementary_PID]->program_numbers[Pos] == program_number)
                Complete_Stream->Streams[elementary_PID]->program_numbers.erase(
                        Complete_Stream->Streams[elementary_PID]->program_numbers.begin() + Pos);
