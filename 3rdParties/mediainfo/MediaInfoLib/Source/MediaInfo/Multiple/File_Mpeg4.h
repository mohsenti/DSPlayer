...
//***************************************************************************
    ...
    private :
        ...
        void moov_trak_mdia_minf_stbl_stts_Common(int32u SampleCount, int32u SampleDuration, int32u Pos = 0,
                                                  int32u NumberOfEntries = 1);
        ...
        static bool mdat_pos_sort(const File_Mpeg4::mdat_Pos_Type &i, const File_Mpeg4::mdat_Pos_Type &j) {
