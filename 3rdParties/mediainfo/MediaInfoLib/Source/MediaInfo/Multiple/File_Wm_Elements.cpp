...
#define UUID(NAME, PART1, PART2, PART3, PART4, PART5) \
    ...
    static const char *Wm_StreamType(const int128u &Kind) {
        switch (Kind.hi) {
            case Elements::Header_StreamProperties_Audio :
                return "Audio";
            case Elements::Header_StreamProperties_Video :
                return "Video";
            case Elements::Header_StreamProperties_Command :
                return "Command";
            case Elements::Header_StreamProperties_JFIF :
                return "JFIF";
            case Elements::Header_StreamProperties_DegradableJPEG :
                return "Degradable JPEG";
            case Elements::Header_StreamProperties_FileTransfer :
                return "File Transfer";
            case Elements::Header_StreamProperties_Binary :
                return "Binary";
            default :
                return "";
        }
...
//---------------------------------------------------------------------------
    void File_Wm::Header_FileProperties() {
        ...
        Skip_GUID("File ID");
        Skip_L8("File Size");
        Get_L8(CreationDate, "Creation Date");
        Param_Info1(Ztring().Date_From_Milliseconds_1601(CreationDate / 10000));
        Skip_L8("Data Packets Count");
        Get_L8(PlayDuration, "Play Duration");
        Param_Info_From_Milliseconds(PlayDuration / 10000);
        Get_L8(SendDuration, "Send Duration");
        Param_Info_From_Milliseconds(SendDuration / 10000);
        Get_L8(Preroll, "Preroll");
        Param_Info_From_Milliseconds(Preroll);
        Get_L4(Flags, "Flags");
...
//---------------------------------------------------------------------------
    void File_Wm::Header_StreamProperties() {
        ...
        Param_Info1(Wm_StreamType(StreamType));
        Element_Info1(Wm_StreamType(StreamType));
        ...
        switch (StreamType.hi) {
            case Elements::Header_StreamProperties_Audio :
                Element_Begin0(); //size is StreamTypeLength
    ...
    void File_Wm::Header_StreamProperties_Audio() {
        ...
        if (Data_Size > 0) {
            ...
            switch (CodecID) {
                ...
                case 0x0162 :
                case 0x0163 :
                    Header_StreamProperties_Audio_WMA();
                    break;
                case 0x7A21 :
                case 0x7A22 :
                    Header_StreamProperties_Audio_AMR();
                    break;
                default     :
...
//---------------------------------------------------------------------------
    void File_Wm::Header_StreamProperties_Audio_WMA() {
        ...
        switch (Config->Demux_InitData_Get()) {
            ...
            case 1 :    //In field
            {
                std::string Data_Raw((const char *) (Buffer + Buffer_Offset + Element_Offset),
                                     (size_t) 10);//Element_Size-(Element_Offset));
...
//---------------------------------------------------------------------------
    void File_Wm::Header_StreamProperties_Video() {
        ...
        Fill(Stream_Video, StreamPos_Last, Video_Codec,
             Ztring().From_CC4(Compression)); //May be replaced by codec parser
        Fill(Stream_Video, StreamPos_Last, Video_Codec_CC, Ztring().From_CC4(Compression));
        Fill(Stream_Video, StreamPos_Last, Video_Width, Width);
        Fill(Stream_Video, StreamPos_Last, Video_Height, Height);
        if (Resolution > 0)
            Fill(Stream_Video, StreamPos_Last, Video_BitDepth, (Resolution % 3) ? Resolution : (Resolution /
                                                                                                3)); //If not a multiple of 3, the total resolution is filled
        ...
        if (Header_ExtendedContentDescription_AspectRatioX && Header_ExtendedContentDescription_AspectRatioY) {
            if (Header_ExtendedContentDescription_AspectRatioX == 16 &&
                Header_ExtendedContentDescription_AspectRatioY == 9)
                Fill(Stream_Video, StreamPos_Last, Video_DisplayAspectRatio, ((float32) 16) / 9, 3);
            else if (Header_ExtendedContentDescription_AspectRatioX == 4 &&
                     Header_ExtendedContentDescription_AspectRatioY == 3)
                ...
                Fill(Stream_Video, StreamPos_Last, Video_PixelAspectRatio,
                     ((float32) Header_ExtendedContentDescription_AspectRatioX) /
                     Header_ExtendedContentDescription_AspectRatioY, 3, true);
        }
        ...
        if (0);
            ...
            if (Data_Size > 40) {
                ...
                switch (Config->Demux_InitData_Get()) {
                    ...
                    case 1 :    //In field
                    {
                        std::string Data_Raw((const char *) (Buffer + (size_t) Element_Offset),
                                             (size_t) (Data_Size - 40));
                        std::string Data_Base64(Base64::encode(Data_Raw));
                ...
                if (StreamItem.Parser->Status[IsFinished]) {
                    ...
                    delete StreamItem.Parser;
                    StreamItem.Parser = NULL;
                } else {
...
#endif
#if defined(MEDIAINFO_MPEGV_YES)
        else if (MediaInfoLib::Config.Codec_Get(Ztring().From_CC4(Compression), InfoCodec_KindofCodec).find(
                __T("MPEG-2")) == 0) {
            stream &StreamItem = Stream[Stream_Number];
...
//---------------------------------------------------------------------------
    void File_Wm::Header_HeaderExtension_ExtendedStreamProperties() {
        ...
        Info_L8(StartTime, "Start Time");
        Param_Info_From_Milliseconds(StartTime);
        Info_L8(EndTime, "End Time");
        Param_Info_From_Milliseconds(EndTime);
        ...
        if (Element_Offset < Element_Size) {
            ...
            if (Size >= 24 && Element_Offset + Size - 24 == Element_Size) {
                switch (Name.hi) {
                    case Elements::Header_StreamProperties :
                        Header_StreamProperties();
                        break;
                    default :
                        Skip_XX(Size - 24, "Unknown");
                }
            } else
...
//---------------------------------------------------------------------------
    void File_Wm::Header_HeaderExtension_AdvancedMutualExclusion() {
        ...
        //Parsing
        int16u Count;
        Info_GUID(ExclusionType, "Exclusion Type");
        Param_Info1(Wm_ExclusionType(ExclusionType));
        Get_L2(Count, "Stream Numbers Count");
        for (int16u Pos = 0; Pos < Count; Pos++) {
            Info_L2(StreamNumber, "Stream Number");
            Element_Info1(StreamNumber);
        }
    }
...
//---------------------------------------------------------------------------
    void File_Wm::Header_HeaderExtension_Metadata() {
        ...
        for (int16u Pos = 0; Pos < Count; Pos++) {
            ...
            switch (Data_Type) {
                case 0x00 :
                    Get_UTF16L(Data_Length, Data, "Data");
                    break;
                case 0x01 :
                    Skip_XX(Data_Length, "Data");
                    Data = __T("(Binary)");
                    break;
                case 0x02 : {
                    int16u Data_Int;
                    Get_L2(Data_Int, "Data");
                    Data = (Data_Int == 0) ? __T("No") : __T("Yes");
                    Data_Int64 = Data_Int;
                }
                    break;
                case 0x03 : {
                    int32u Data_Int;
                    Get_L4(Data_Int, "Data");
                    Data.From_Number(Data_Int);
                    Data_Int64 = Data_Int;
                }
                    break;
                case 0x04 : {
                    int64u Data_Int;
                    Get_L8(Data_Int, "Data");
                    Data.From_Number(Data_Int);
                    Data_Int64 = Data_Int;
                }
                    break;
...
//---------------------------------------------------------------------------
    void File_Wm::Header_CodecList() {
        ...
        for (int16u Pos = 0; Pos < Count; Pos++) {
            ...
            Get_L2(Type, "Type");
            Param_Info1(Wm_CodecList_Kind(Type));
...
//---------------------------------------------------------------------------
    void File_Wm::Header_Marker() {
        ...
        for (int32u Pos = 0; Pos < Markers_Count; Pos++) {
            ...
            Skip_L8("Offset");
            Info_L8(PresentationTime, "Presentation Time");
            Param_Info_From_Milliseconds(PresentationTime / 10000);
            Skip_L2("Entry Length");
            Info_L4(SendTime, "Send Time");
            Param_Info_From_Milliseconds(SendTime);
            Skip_L4("Flags");
...
//---------------------------------------------------------------------------
    void File_Wm::Header_ExtendedContentDescription() {
        ...
        for (int16u Pos = 0; Pos < Count; Pos++) {
            ...
            switch (Value_Type) {
                case 0x00 :
                    Get_UTF16L(Value_Length, Value, "Value");
                    break;
                case 0x01 :
                    if (Name == __T("ASFLeakyBucketPairs"))
                        Header_ExtendedContentDescription_ASFLeakyBucketPairs(Value_Length);
                    else {
                        Skip_XX(Value_Length, "Value");
                        Value = __T("(Binary)");
                    }
                    break;
                case 0x02 : {
                    int32u Value_Int;
                    Get_L4(Value_Int, "Value");
                    Value = (Value_Int == 0) ? __T("No") : __T("Yes");
                    Value_Int64 = Value_Int;
                }
                    break;
                case 0x03 : {
                    int32u Value_Int;
            ...
            if (!Value.empty()) {
                if (Name == __T("Agility FPS")) {}
                    ...
                    Fill(Stream_General, 0, General_Performer, Value,
                         true); //Clear last value, like Author (Content Description)
                    ...
                    Fill(Stream_General, 0, General_Encoded_Application,
                         Retrieve(Stream_General, 0, General_Encoded_Application) + __T(" ") + Value, true);
...
//---------------------------------------------------------------------------
    void File_Wm::Header_StreamBitRate() {
        ...
        for (int16u Pos = 0; Pos < Count; Pos++) {
            ...
            Get_L2(StreamNumber, "Stream Number");
            Element_Info1(StreamNumber);
            Get_L4(AverageBitRate, "Average Bitrate");
            Element_Info1(AverageBitRate);
            Element_End0();
...
//---------------------------------------------------------------------------
    void File_Wm::Header_ContentBranding() {
        ...
        Get_L4(BannerImageData_Type, "Banner Image Data Type");
        Param_Info1(Wm_BannerImageData_Type(BannerImageData_Type));
    ...
    void File_Wm::Data() {
        ...
        while (Temp != Stream.end()) {
            ...
            if (Temp->second.Parser ||
                Temp->second.StreamKind == Stream_Video) //We need Stream_Video for Frame_Rate computing
            {
...
//---------------------------------------------------------------------------
    void File_Wm::Data_Packet() {
        ...
        switch (PacketLengthType) {
            case 1 : {
                int8u Data;
                Get_L1(Data, "Packet Length");
                PacketLength = Data;
            }
                break;
            case 2 : {
                int16u Data;
                Get_L2(Data, "Packet Length");
                PacketLength = Data;
            }
                break;
            case 3 :
                Get_L4(PacketLength, "Packet Length");
                break;
            default:;
        }
        switch (SequenceType) {
        ...
        switch (PaddingLengthType) {
            case 1 : {
                int8u Data;
                Get_L1(Data, "Padding Length");
                Data_Parse_Padding = Data;
            }
                break;
            case 2 : {
                int16u Data;
                Get_L2(Data, "Padding Length");
                Data_Parse_Padding = Data;
            }
                break;
            case 3 :
                Get_L4(Data_Parse_Padding, "Padding Length");
                break;
            default:
        ...
        for (NumberPayloads_Pos = 0; NumberPayloads_Pos < NumberPayloads; NumberPayloads_Pos++) {
            ...
            switch (MediaObjectNumberLengthType) {
                case 1 :
                    Skip_L1("Media Object Number");
                    break;
                case 2 :
                    Skip_L2("Media Object Number");
                    break;
                case 3 :
                    Skip_L4("Media Object Number");
                    break;
                default:
                    Trusted_IsNot("Media Object Number");
                    return; //Problem
            }
            switch (OffsetIntoMediaObjectLengthType) {
                case 1 :
                    Skip_L1("Offset Into Media Object");
                    break;
                case 2 :
                    Skip_L2("Offset Into Media Object");
                    break;
                case 3 :
                    Skip_L4("Offset Into Media Object");
                    break;
                default:
                    Trusted_IsNot("Offset Into Media Object");
                    return; //Problem
            }
            switch (ReplicatedDataLengthType) {
                case 1 : {
                    int8u Data;
                    Get_L1(Data, "Replicated Data Length");
                    ReplicatedDataLength = Data;
                }
                    break;
                case 2 : {
                    int16u Data;
                    Get_L2(Data, "Replicated Data Length");
                    ReplicatedDataLength = Data;
                }
                    break;
                case 3 :
                    Get_L4(ReplicatedDataLength, "Replicated Data Length");
                    break;
                default:
                    Trusted_IsNot("Replicated Data Length");
                    return; //Problem
            }
            ...
            if (MultiplePayloadsPresent) {
                switch (PayloadLengthType) {
                    case 1 : {
                        int8u Data;
                        Get_L1(Data, "Payload Length");
                        PayloadLength = Data;
                    }
                        break;
                    case 2 : {
                        int16u Data;
                        Get_L2(Data, "Payload Length");
                        PayloadLength = Data;
                    }
                        break;
                    case 3 :
                        Get_L4(PayloadLength, "Payload Length");
                        break;
                    default:
                        Trusted_IsNot("Payload Length");
                        return; //Problem
                }
            ...
            if (Element_Offset + PayloadLength + Data_Parse_Padding > Element_Size) {
                ...
                if (StreamItem.Parser && StreamItem.SearchingPayload) {
                    ...
                    //Codec specific
#if defined(MEDIAINFO_VC1_YES)
                    if (Retrieve(StreamItem.StreamKind, StreamItem.StreamPos,
                                 Fill_Parameter(StreamItem.StreamKind, Generic_Format)) == __T("VC-1"))
    ...
    void File_Wm::Data_Packet_ReplicatedData(int32u Size) {
        ...
        for (size_t Pos = 0; Pos < StreamItem.Payload_Extension_Systems.size(); Pos++) {
            ...
            switch (StreamItem.Payload_Extension_Systems[Pos].ID.hi) {
                case Elements::Payload_Extension_System_TimeStamp :
                    Data_Packet_ReplicatedData_TimeStamp();
                    break;
