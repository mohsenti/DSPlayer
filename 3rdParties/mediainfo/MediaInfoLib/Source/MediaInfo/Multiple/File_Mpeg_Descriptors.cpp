...
//---------------------------------------------------------------------------
    ...
    const char *Mpeg_Descriptors_alignment_type(int8u alignment_type) {
        switch (alignment_type) {
            case 0x01 :
                return "Slice or video access unit (Video), or sync word (Audio)";
            case 0x02 :
    ...
    const char *Mpeg_Descriptors_teletext_type(int8u teletext_type) {
        switch (teletext_type) {
            case 0x01 :
                return "Teletext";
            case 0x02 :
                return "Teletext Subtitle";
            case 0x03 :
                return "Teletext"; //additional information page
            case 0x04 :
                return "Teletext"; //programme schedule page
            case 0x05 :
                return "Teletext Subtitle"; //for hearing impaired people
            default   :
    ...
    const char *Mpeg_Descriptors_teletext_type_more(int8u teletext_type) {
        switch (teletext_type) {
            ...
            case 0x05 :
                return "For hearing impaired people";
            default   :
                return "";
        }
    }
    ...
    const char *Mpeg_Descriptors_content_nibble_level_2(int8u content_nibble_level_1, int8u content_nibble_level_2) {
        switch (content_nibble_level_1) {
            case 0x00 :
                return "undefined";
            case 0x01 :
                return Mpeg_Descriptors_content_nibble_level_2_01(content_nibble_level_2);
            case 0x02 :
                return Mpeg_Descriptors_content_nibble_level_2_02(content_nibble_level_2);
            case 0x03 :
                return Mpeg_Descriptors_content_nibble_level_2_03(content_nibble_level_2);
            case 0x04 :
                return Mpeg_Descriptors_content_nibble_level_2_04(content_nibble_level_2);
            case 0x05 :
                return Mpeg_Descriptors_content_nibble_level_2_05(content_nibble_level_2);
            case 0x06 :
                return Mpeg_Descriptors_content_nibble_level_2_06(content_nibble_level_2);
            case 0x07 :
                return Mpeg_Descriptors_content_nibble_level_2_07(content_nibble_level_2);
            case 0x08 :
                return Mpeg_Descriptors_content_nibble_level_2_08(content_nibble_level_2);
            case 0x09 :
                return Mpeg_Descriptors_content_nibble_level_2_09(content_nibble_level_2);
            case 0x0A :
                return Mpeg_Descriptors_content_nibble_level_2_0A(content_nibble_level_2);
            case 0x0B :
                return Mpeg_Descriptors_content_nibble_level_2_0B(content_nibble_level_2);
            default   :
                if (content_nibble_level_1 == 0x0F)
                    return "user defined";
                else
    ...
    const char *Mpeg_Descriptors_linkage_type(int8u linkage_type) {
        switch (linkage_type) {
            ...
            case 0x02 :
                return "Electronic Programme Guide (EPG) service";
            case 0x03 :
                return "CA replacement service";
            case 0x04 :
                return "transport stream containing complete Network/Bouquet SI";
            case 0x05 :
    ...
    const char *Mpeg_Descriptors_dvb_service_type(int8u service_type) {
        switch (service_type) {
            ...
            case 0x16 :
                return "advanced codec SD digital television";
            case 0x17 :
                return "advanced codec SD NVOD time-shifted";
            case 0x18 :
                return "advanced codec SD NVOD reference";
            case 0x19 :
                return "advanced codec HD digital television";
            case 0x1A :
    ...
    const char *Mpeg_Descriptors_component_type_O1(int8u component_type) {
        switch (component_type) {
            case 0x01 :
                return "4:3 aspect ratio, 25 Hz";
            case 0x02 :
                return "16:9 aspect ratio with pan vectors, 25 Hz";
            case 0x03 :
                return "16:9 aspect ratio without pan vectors, 25 Hz";
            case 0x04 :
                return ">16:9 aspect ratio, 25 Hz";
            case 0x05 :
                return "4:3 aspect ratio, 30 Hz";
            case 0x06 :
                return "16:9 aspect ratio with pan vectors, 30 Hz";
            case 0x07 :
                return "16:9 aspect ratio without pan vectors, 30 Hz";
            case 0x08 :
                return ">16:9 aspect ratio, 30 Hz";
            case 0x09 :
                return "4:3 aspect ratio, 25 Hz (high definition)";
            case 0x0A :
                return "16:9 aspect ratio with pan vectors, 25 Hz (high definition)";
            case 0x0B :
                return "16:9 aspect ratio without pan vectors, 25 Hz (high definition)";
            case 0x0C :
                return ">16:9 aspect ratio, 25 Hz (high definition)";
            case 0x0D :
                return "4:3 aspect ratio, 30 Hz (high definition)";
            case 0x0E :
                return "16:9 aspect ratio with pan vectors, 30 Hz (high definition)";
            case 0x0F :
                return "16:9 aspect ratio without pan vectors, 30 Hz (high definition)";
            case 0x10 :
                return ">16:9 aspect ratio, 30 Hz (high definition)";
            default   :
    ...
    const char *Mpeg_Descriptors_component_type_O2(int8u component_type) {
        switch (component_type) {
            case 0x01 :
                return "single mono channel";
            case 0x02 :
                return "dual mono channel";
            case 0x03 :
                return "stereo (2 channel)";
            case 0x04 :
                return "multi-lingual, multi-channel";
            case 0x05 :
                return "surround sound";
            case 0x40 :
                return "description for the visually impaired";
            case 0x41 :
                return "for the hard of hearing";
            case 0x42 :
                return "receiver-mixed supplementary audio";
            default   :
                if (component_type >= 0xB0 && component_type <= 0xFE)
                    return "user defined";
                else
    ...
    const char *Mpeg_Descriptors_component_type_O3(int8u component_type) {
        switch (component_type) {
            ...
            case 0x03 :
                return "VBI data";
            case 0x10 :
                return "DVB subtitle (normal) with no monitor aspect ratio criticality";
            case 0x11 :
                return "DVB subtitle (normal) for display on 4:3 aspect ratio monitor";
            case 0x12 :
                return "DVB subtitle (normal) for display on 16:9 aspect ratio monitor";
            case 0x13 :
                return "DVB subtitle (normal) for display on 2.21:1 aspect ratio monitor";
            case 0x20 :
                return "DVB subtitle (for the hard of hearing) with no monitor aspect ratio criticality";
            case 0x21 :
                return "DVB subtitle (for the hard of hearing) for display on 4:3 aspect ratio monitor";
            case 0x22 :
                return "DVB subtitle (for the hard of hearing) for display on 16:9 aspect ratio monitor";
            case 0x23 :
                return "DVB subtitle (for the hard of hearing) for display on 2.21:1 aspect ratio monitor";
            default   :
                if (component_type >= 0xB0 && component_type <= 0xFE)
                    return "user defined";
                else
    ...
    const char *Mpeg_Descriptors_component_type_O6(int8u component_type) {
        switch (component_type) {
            ...
            case 0x43 :
                return "astereo (v2)";
            case 0x44 :
                return "description for the visually impaired (v2)";
            case 0x45 :
                return "for the hard of hearing (v2)";
            case 0x46 :
                return "receiver-mixed supplementary audio (v2)";
            default   :
                if (component_type >= 0xB0 && component_type <= 0xFE)
                    return "user defined";
                else
    ...
    const char *Mpeg_Descriptors_codepage_1(int8u codepage) {
        switch (codepage) {
            case 0x01 :
                return "ISO/IEC 8859-5 (Cyrillic)";
            case 0x02 :
                return "ISO/IEC 8859-6 (Arabic)";
            case 0x03 :
                return "ISO/IEC 8859-7 (Greek)";
            case 0x04 :
                return "ISO/IEC 8859-8 (Hebrew)";
            case 0x05 :
                return "ISO/IEC 8859-9 (Latin)";
            case 0x06 :
                return "ISO/IEC 8859-10 (Latin)";
            case 0x07 :
                return "ISO/IEC 8859-11 (Thai)";
            case 0x08 :
                return "ISO/IEC 8859-12 (Indian)";
            case 0x09 :
                return "ISO/IEC 8859-13 (Latin)";
            case 0x0A :
                return "ISO/IEC 8859-14 (Celtic)";
            case 0x0B :
                return "ISO/IEC 8859-15 (Latin)";
            case 0x11 :
                return "ISO/IEC 10646-1 (Basic Multilingual Plane)";
            case 0x12 :
                return "KSC5601-1987 (Korean)";
            case 0x13 :
                return "GB-2312-1980 (Simplified Chinese)";
            case 0x14 :
                return "Big5 (Traditional Chinese)";
            case 0x15 :
                return "UTF-8 (Basic Multilingual Plane)";
            default   :
                return "reserved for future use";
        }
    }
    ...
    const char *Mpeg_Descriptors_component_type(int8u stream_content, int8u component_type) {
        switch (stream_content) {
            case 0x01 :
                return Mpeg_Descriptors_component_type_O1(component_type);
            case 0x02 :
                return Mpeg_Descriptors_component_type_O2(component_type);
            case 0x03 :
                return Mpeg_Descriptors_component_type_O3(component_type);
            case 0x04 :
                return Mpeg_Descriptors_component_type_O4(component_type);
            case 0x05 :
                return Mpeg_Descriptors_component_type_O5(component_type);
            case 0x06 :
                return Mpeg_Descriptors_component_type_O6(component_type);
            case 0x07 :
                return Mpeg_Descriptors_component_type_O7(component_type);
            default   :
                if (component_type >= 0xB0 && component_type <= 0xFE)
                    return "user defined";
                else
    ...
    const char *Mpeg_Descriptors_registration_format_identifier_Format(int32u format_identifier) {
        switch (format_identifier) {
            ...
            case Elements::BSSD :
                return "PCM"; //AES3
            case Elements::CUEI :
                return "SCTE 35 2003 - Digital Program Insertion Cueing Message for Cable";
            case Elements::DTS1 :
                return "DTS"; //512
            case Elements::DTS2 :
                return "DTS"; //1024
            ...
            case Elements::SCTE :
                return "SCTE 54 2003 - DV Service Multiplex and Transport System for Cable Television";
            case Elements::TSHV :
                return "DV";
            case Elements::VC_1 :
                return "VC-1";
            case Elements::MANZ :
                return "Manzanita Systems"; //Manzanita Systems
            default :
                return "";
        }
    }
    ...
    const char *Mpeg_Descriptors_MPEG_4_audio_profile_and_level(int8u MPEG_4_audio_profile_and_level) {
        switch (MPEG_4_audio_profile_and_level) {
            ...
            case 0x2A :
                return "Synthesis@L3";
            case 0x30 :
                return "High quality audio@L1";
            case 0x31 :
                return "High quality audio@L2";
            case 0x32 :
                return "High quality audio@L3";
            case 0x33 :
                return "High quality audio@L4";
            case 0x34 :
                return "High quality audio@L5";
            case 0x35 :
                return "High quality audio@L6";
            case 0x36 :
                return "High quality audio@L7";
            case 0x37 :
                return "High quality audio@L8";
            case 0x38 :
                return "Low delay audio@L1";
            case 0x39 :
                return "Low delay audio@L2";
            case 0x3A :
                return "Low delay audio@L3";
            case 0x3B :
                return "Low delay audio@L4";
            case 0x3C :
                return "Low delay audio@L5";
            case 0x3D :
                return "Low delay audio@L6";
            case 0x3E :
                return "Low delay audio@L7";
            case 0x3F :
                return "Low delay audio@L8";
            case 0x40 :
                return "Natural audio@L1";
            case 0x41 :
                return "Natural audio@L2";
            case 0x42 :
                return "Natural audio@L3";
            case 0x43 :
                return "Natural audio@L4";
            case 0x48 :
                return "Mobile audio internetworking@L1";
            case 0x49 :
                return "Mobile audio internetworking@L2";
            case 0x4A :
                return "Mobile audio internetworking@L3";
            case 0x4B :
                return "Mobile audio internetworking@L4";
            case 0x4C :
                return "Mobile audio internetworking@L5";
            case 0x4D :
                return "Mobile audio internetworking@L6";
            case 0x50 :
                return "LC@L1";
            case 0x51 :
                return "LC@L2";
            ...
            case 0x53 :
                return "LC@L4";
            case 0x58 :
                return "HE-AAC@L2 / LC@L2";
            case 0x59 :
                return "HE-AAC@L3 / LC@L3";
            case 0x5A :
                return "HE-AAC@L4 / LC@L4";
            case 0x5B :
                return "HE-AAC@L5 / LC@L5";
            case 0x60 :
                return "HE-AACv2@L2 / HE-AAC@L2 / LC@L2";
            case 0x61 :
                return "HE-AACv2@L3 / HE-AAC@L3 / LC@L3";
            case 0x62 :
                return "HE-AACv2@L4 / HE-AAC@L4 / LC@L4";
            case 0x63 :
                return "HE-AACv2@L5 / HE-AAC@L5 / LC@L5";
            default   :
                return "";
        }
    }
...
//---------------------------------------------------------------------------
    const char *Mpeg_Descriptors_original_network_id(int16u original_network_id) {
        switch (original_network_id) {
            case 0x0001 :
                return "Astra Satellite Network 19,2'E";
            case 0x0002 :
                return "Astra Satellite Network 28,2'E";
            case 0x0003 :
                return "Astra 1";
            case 0x0004 :
                return "Astra 2";
            ...
            case 0x0020 :
                return "ASTRA";
            case 0x0021 :
                return "Hispasat Network 1";
            case 0x0022 :
                return "Hispasat Network 2";
            case 0x0023 :
                return "Hispasat Network 3";
            case 0x0024 :
                return "Hispasat Network 4";
            case 0x0025 :
                return "Hispasat Network 5";
            case 0x0026 :
                return "Hispasat Network 6";
            case 0x0027 :
                return "Hispasat 30'W (FSS)";
            case 0x0028 :
                return "Hispasat 30'W (DBS)";
            case 0x0029 :
                return "Hispasat 30'W (America)";
            case 0x0030 :
                return "Canal+ Satellite Network";
            case 0x0031 :
                return "Hispasat � VIA DIGITAL";
            case 0x0032 :
                return "Hispasat Network 7";
            case 0x0033 :
                return "Hispasat Network 8";
            case 0x0034 :
                return "Hispasat Network 9";
            case 0x0035 :
            ...
            case 0x0051 :
                return "Havas";
            case 0x0052 :
                return "Osaka Yusen Satellite";
            case 0x0055 :
                return "Sirius Satellite System";
            case 0x0058 :
                return "Thiacom 1 & 2 co-located 78.5'E (UBC Thailand)";
            case 0x005E :
                return "Sirius Satellite System (Nordic Coverage)";
            case 0x005F :
                return "Sirius Satellite System (FSS)";
            case 0x0060 :
                return "Deutsche Telekom";
            case 0x0069 :
                return "Optus B3 156'E";
            case 0x0070 :
                return "BONUM1 36 Degrees East (NTV+)";
            case 0x007E :
                return "Eutelsat Satellite System at 7'E";
            case 0x0073 :
            ...
            case 0x00CD :
                return "Canal+";
            case 0x0100 :
                return "ExpressVu Express";
            case 0x010E :
                return "Eutelsat Satellite System at 10'E";
            case 0x0110 :
                return "Mediaset";
            case 0x013E :
                return "Eutelsat Satellite System at 13'E";
            case 0x016E :
                return "Eutelsat Satellite System at 16'E";
            case 0x029E :
                return "Eutelsat Satellite System at 29'E";
            case 0x02BE :
                return "Arabsat Arabsat (Scientific Atlanta, Eutelsat)";
            case 0x036E :
                return "Eutelsat Satellite System at 36'E";
            case 0x03E8 :
                return "Telia";
            case 0x048E :
                return "Eutelsat Satellite System at 48'E";
            case 0x0800 :
                return "Nilesat 101";
            case 0x0801 :
                return "Nilesat 101";
            ...
            case 0x088F :
                return "MEASAT 3";
            case 0x1000 :
                return "Optus B3 156'E Optus Communications";
            case 0x1001 :
                return "DISH Network Echostar Communications";
            case 0x1002 :
                return "Dish Network 61.5 W Echostar Communications";
            case 0x1003 :
                return "Dish Network 83 W Echostar Communications";
            case 0x1004 :
                return "Dish Network 119 W Echostar Communications";
            case 0x1005 :
                return "Dish Network 121 W Echostar Communications";
            case 0x1006 :
                return "Dish Network 148 W Echostar Communications";
            case 0x1007 :
                return "Dish Network 175 W Echostar Communications";
            case 0x1008 :
                return "Dish Network W Echostar Communications";
            case 0x1009 :
                return "Dish Network X Echostar Communications";
            case 0x100A :
                return "Dish Network Y Echostar Communications";
            case 0x100B :
                return "Dish Network Z Echostar Communications";
            case 0x2000 :
                return "Thiacom 1 & 2 co-located 78.5'E";
            case 0x22D4 :
            ...
            case 0x2114 :
                return "German Digital Terrestrial Television";
            case 0x3000 :
                return "PanAmSat 4 68.5'E";
            case 0x5000 :
            ...
            case 0xFC10 :
                return "Rhone Vision Cable";
            case 0xFD00 :
                return "Lyonnaise Communications";
            case 0xFE00 :
...
//---------------------------------------------------------------------------
    const char *Mpeg_Descriptors_CA_system_ID(int16u CA_system_ID) {
        switch (CA_system_ID) {
            case 0x0100 :
                return "Seca Mediaguard 1/2";
            case 0x0101 :
                return "RusCrypto";
            case 0x0464 :
                return "EuroDec";
            case 0x0500 :
                return "TPS-Crypt  or Viaccess";
            case 0x0602 :
            case 0x0604 :
            case 0x0606 :
            case 0x0608 :
            ...
            case 0x0960 :
            case 0x0961 :
                return "NDS Videoguard 1/2";
            case 0x0B00 :
                return "Conax CAS 5 /7";
            case 0x0D00 :
            case 0x0D02 :
            case 0x0D03 :
            case 0x0D05 :
            ...
            case 0x0E00 :
                return "PowerVu";
            case 0x1000 :
                return "RAS (Remote Authorisation System)";
            case 0x1702 :
            case 0x1722 :
            case 0x1762 :
                return "BetaCrypt 1 or Nagravision";
            case 0x1710 :
                return "BetaCrypt 2";
            case 0x1800 :
            case 0x1801 :
            ...
            case 0x4A61 :
            case 0x4A63 :
                return "SkyCrypt or Neotioncrypt or Neotion SHL";
            case 0x4A70 :
                return "DreamCrypt";
            case 0x4A80 :
                return "ThalesCrypt";
    ...
    static bool Mpeg_Descriptors_CA_system_ID_MustSkipSlices(int16u CA_system_ID) {
        switch (CA_system_ID) {
            case 0x4B13 : // PlayReady
                return true;
            default     :
                return false; //We try, it is not sure
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_02() {
        ...
        Get_S1(4, frame_rate_code, "frame_rate_code");
        Param_Info1(Mpegv_frame_rate[frame_rate_code]);
        ...
        if (MPEG_1_only_flag == 0) {
            ...
            Get_S1(3, profile_and_level_indication_profile, "profile_and_level_indication_profile");
            Param_Info1(Mpegv_profile_and_level_indication_profile[profile_and_level_indication_profile]);
            Get_S1(4, profile_and_level_indication_level, "profile_and_level_indication_level");
            Param_Info1(Mpegv_profile_and_level_indication_level[profile_and_level_indication_level]);
            Get_S1(2, chroma_format, "chroma_format");
            Param_Info1(Mpegv_Colorimetry_format[chroma_format]);
                ...
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        if (!multiple_frame_rate_flag && !frame_rate_extension_flag && frame_rate_code)
                            Complete_Stream->Streams[elementary_PID]->Infos["FrameRate"] = Ztring::ToZtring(
                                    Mpegv_frame_rate[frame_rate_code]);
                        Complete_Stream->Streams[elementary_PID]->Infos["Format_Version"] = MPEG_1_only_flag ? __T(
                                "Version 1") : __T("Version 2");
                        ...
                        if (profile_and_level_indication_profile) {
                            Complete_Stream->Streams[elementary_PID]->Infos["Format_Profile"] = Ztring().From_Local(
                                    Mpegv_profile_and_level_indication_profile[profile_and_level_indication_profile]) +
                                                                                                __T("@") +
                                                                                                Ztring().From_Local(
                                                                                                        Mpegv_profile_and_level_indication_level[profile_and_level_indication_level]);
                            Complete_Stream->Streams[elementary_PID]->Infos["Codec_Profile"] = Ztring().From_Local(
                                    Mpegv_profile_and_level_indication_profile[profile_and_level_indication_profile]) +
                                                                                               __T("@") +
                                                                                               Ztring().From_Local(
                                                                                                       Mpegv_profile_and_level_indication_level[profile_and_level_indication_level]);
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_03() {
        ...
        Get_S1(1, ID, "ID");
        Param_Info1(Mpega_Version[2 + ID]); //Mpega_Version is with MPEG2.5 hack
        Get_S1(2, layer, "layer");
        Param_Info1(Mpega_Layer[layer]);
        ...
        FILLING_BEGIN() ;
            if (elementary_PID_IsValid) {
                Complete_Stream->Streams[elementary_PID]->Infos["BitRate_Mode"] = variable_rate_audio_indicator ? __T(
                        "VBR") : __T("CBR");
                Complete_Stream->Streams[elementary_PID]->Infos["Codec"] =
                        Ztring(Mpega_Version[ID]) + Ztring(Mpega_Layer[layer]);
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_05() {
        ...
        Element_Info1(Mpeg_Descriptors_registration_format_identifier_Format(format_identifier));
        Param_Info1(Mpeg_Descriptors_registration_format_identifier_Format(format_identifier));
            ...
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        if (infosItem.size() != 4) {
                            Ztring Temp;
                            Temp.From_Number(format_identifier, 16);
                            if (Temp.size() < 8)
                        ...
                        //Coherency
                        if (stream_type == 0x81 &&
                            Complete_Stream->Streams[elementary_PID]->registration_format_identifier == Elements::BSSD)
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_06() {
        //Parsing
        Info_B1(alignment_type, "alignment_type");
        Param_Info1(Mpeg_Descriptors_alignment_type(alignment_type));
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_09() {
        ...
        Get_B2(CA_system_ID, "CA_system_ID");
        Param_Info1(Mpeg_Descriptors_CA_system_ID(CA_system_ID));
        BS_Begin();
        Skip_S1(3, "reserved");
        ...
        FILLING_BEGIN() ;
            switch (table_id) {
                case 0x01 : //conditional_access_section
                    if (Complete_Stream->Streams[CA_PID]->Kind ==
                        complete_stream::stream::unknown) //Priority to PES, if this is a PES, we skip the CA
                    {
                ...
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        Complete_Stream->Streams[elementary_PID]->CA_system_ID_MustSkipSlices = Mpeg_Descriptors_CA_system_ID_MustSkipSlices(
                                CA_system_ID);
                        if (CA_PID < Complete_Stream->Streams.size() && Complete_Stream->Streams[CA_PID]->Kind ==
                                                                        complete_stream::stream::unknown) //Priority to PES, if this is a PES, we skip the CA
                        {
                            Complete_Stream->Streams[CA_PID]->Kind = complete_stream::stream::psi;
                            Complete_Stream->Streams[CA_PID]->Table_IDs.resize(0x100);
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_0A() {
        ...
        Get_B1(audio_type, "audio_type");
        Param_Info1(Mpeg_Descriptors_audio_type(audio_type));
            ...
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        Complete_Stream->Streams[elementary_PID]->Infos["Language"] = ISO_639_1.empty() ? ISO_639_2
                                                                                                        : ISO_639_1;
                        if (audio_type)
                            Complete_Stream->Streams[elementary_PID]->Infos["Language_More"] = Mpeg_Descriptors_audio_type(
                                    audio_type);
                    }
                    break;
                default    :;
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_0B() {
        ...
        Get_S1(3, clock_accuracy_exponent, "clock_accuracy_exponent");
        Param_Info1(Ztring::ToZtring(clock_accuracy_integer * (int64u) pow(10.0, clock_accuracy_exponent)));
        Skip_S1(5, "reserved");
        BS_End();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_0D() {
        ...
        if (copyright_identifier == Elements::MANZ) {
            ...
            Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Infos["Encoded_Library"] = __T(
                    "Manzanita Systems");
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_0E() {
        ...
        Param_Info2(maximum_bitrate * 400, " bps");
        BS_End();
        ...
        FILLING_BEGIN() ;
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid)
                        Complete_Stream->Streams[elementary_PID]->Infos["BitRate_Maximum"] = Ztring::ToZtring(
                                maximum_bitrate * 400);
                    else
                        Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Programs[table_id_extension].Infos["BitRate_Maximum"] = Ztring::ToZtring(
                                maximum_bitrate * 400);
                    break;
                default    :;
            }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_0F() {
        ...
        if ((private_data_indicator & 0xFF000000) >= 0x41000000 && (private_data_indicator & 0xFF000000) <= 0x7A000000
            && (private_data_indicator & 0x00FF0000) >= 0x00410000 &&
            (private_data_indicator & 0x00FF0000) <= 0x007A0000
            && (private_data_indicator & 0x0000FF00) >= 0x00004100 &&
            (private_data_indicator & 0x0000FF00) <= 0x00007A00
            && (private_data_indicator & 0x000000FF) >= 0x00000041 &&
            (private_data_indicator & 0x000000FF) <= 0x0000007A) {
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_10() {
        ...
        BS_Begin();
        Skip_S1(2, "reserved");
        Info_S3(22, sb_leak_rate, "sb_leak_rate");
        Param_Info2(sb_leak_rate * 400, " bps");
        Skip_S1(2, "reserved");
        Info_S3(22, sb_size, "sb_size");
        Param_Info2(sb_size, " bytes");
        BS_End();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_1C() {
        ...
        Get_B1(Profile_and_level, "Profile_and_level");
        Param_Info1(Mpeg_Descriptors_MPEG_4_audio_profile_and_level(Profile_and_level));

        FILLING_BEGIN() ;
            Complete_Stream->Streams[elementary_PID]->Infos["Format_Profile"] = Mpeg_Descriptors_MPEG_4_audio_profile_and_level(
                    Profile_and_level);
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_28() {
        ...
        Param_Info1(Avc_profile_idc(profile_idc));
        BS_Begin();
            ...
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        Complete_Stream->Streams[elementary_PID]->Infos["Format_Profile"] =
                                Ztring().From_Local(Avc_profile_idc(profile_idc)) + __T("@L") +
                                Ztring().From_Number(((float) level_idc) / 10, 1);
                    }
                    break;
                default    :;
            }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_41() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            Element_Info1(Ztring::ToZtring(service_id, 16));
            Get_B1(service_type, "service_type");
            Param_Info1(Mpeg_Descriptors_dvb_service_type(service_type));
            Element_End1(Ztring::ToZtring(service_id));

            FILLING_BEGIN() ;
                Complete_Stream->Transport_Streams[table_id_extension].Programs[service_id].Infos["ServiceType"] = Mpeg_Descriptors_dvb_service_type(
                        service_type);
            FILLING_END();
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_43() {
        ...
        Get_B4(frequency, "frequency");
        Param_Info1(Frequency_DVB__BCD(frequency));
        Get_B2(orbital_position, "orbital_position");
        Param_Info1(OrbitalPosition_DVB__BCD(orbital_position));
        BS_Begin();
        Get_SB(west_east_flag, "west_east_flag");
        Param_Info1(west_east_flag ? "E" : "W");
        ...
        FILLING_BEGIN() ;
            ...
            transportStream.Infos["OrbitalPosition"] =
                    OrbitalPosition_DVB__BCD(orbital_position) + (west_east_flag ? __T('E') : __T('W'));
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_4A() {
        ...
        Param_Info1(Mpeg_Descriptors_original_network_id(original_network_id));
        Skip_B2("service_id");
        Get_B1(linkage_type, "linkage_type");
        Param_Info1(Mpeg_Descriptors_linkage_type(linkage_type));
        if (Element_Size > 7)
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_4D() {
        ...
        Get_DVB_Text(event_name_length, event_name, "event_name");
        Element_Info1(event_name);
        ...
        FILLING_BEGIN() ;
            if (table_id >= 0x4E && table_id <= 0x6F) //event_information_section
            {
                if (event_id_IsValid) {
                    ...
                    eventItem.short_event.event_name =
                            (ISO_639_1.empty() ? ISO_639_2 : ISO_639_1) + __T(':') + event_name;
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_50() {
        ...
        Get_S1(4, stream_content, "stream_content");
        Param_Info1(Mpeg_Descriptors_stream_content(stream_content));
        Element_Info1(Mpeg_Descriptors_stream_content(stream_content));
        BS_End();
        Info_B1(component_type, "component_type");
        Param_Info1(Mpeg_Descriptors_component_type(stream_content, component_type));
        Element_Info1(Mpeg_Descriptors_component_type(stream_content, component_type));
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_54() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            Get_S1(4, content_nibble_level_1, "content_nibble_level_1");
            Param_Info1(Mpeg_Descriptors_content_nibble_level_1(content_nibble_level_1));
            Element_Info1(Mpeg_Descriptors_content_nibble_level_1(content_nibble_level_1));
            Get_S1(4, content_nibble_level_2, "content_nibble_level_2");
            Param_Info1(Mpeg_Descriptors_content_nibble_level_2(content_nibble_level_1, content_nibble_level_2));
            Element_Info1C((content_nibble_level_1 == 0xB || content_nibble_level_2 != 0),
                           Mpeg_Descriptors_content_nibble_level_2(content_nibble_level_1, content_nibble_level_2));
            ...
            FILLING_BEGIN() ;
                if (event_id_IsValid) {
                    complete_stream::transport_stream::program &progItem = Complete_Stream->Transport_Streams[transport_stream_id].Programs[table_id_extension];
                    progItem.DVB_EPG_Blocks[table_id].Events[event_id].content = Ztring().From_UTF8(
                            Mpeg_Descriptors_content_nibble_level_2(content_nibble_level_1, content_nibble_level_2)) +
                                                                                 __T(", ");
                    progItem.DVB_EPG_Blocks_IsUpdated = true;
                    Complete_Stream->Programs_IsUpdated = true;
        ...
        FILLING_BEGIN() ;
            if (event_id_IsValid) {
                ...
                if (!eventItem.content.empty()) {
                    eventItem.content.resize(
                            Complete_Stream->Transport_Streams[transport_stream_id].Programs[table_id_extension].DVB_EPG_Blocks[table_id].Events[event_id].content.size() -
                            2);
                    progItem.DVB_EPG_Blocks_IsUpdated = true;
                    Complete_Stream->Programs_IsUpdated = true;
                }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_55() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            Info_B1(rating, "rating");
            Param_Info2(rating + 3, " years old");
            Element_Info2(rating + 3, " years old");
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_56() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            BS_Begin();
            Get_S1(5, teletext_type, "teletext_type");
            Param_Info1(Mpeg_Descriptors_teletext_type(teletext_type));
            ...
            FILLING_BEGIN() ;
                switch (table_id) {
                    case 0x02 : //program_map_section
                        ...
                        {
                            int16u ID = (teletext_magazine_number == 0 ? 8 : teletext_magazine_number) * 100 +
                                        teletext_page_number_1 * 10 + teletext_page_number_2;
                            Complete_Stream->Streams[elementary_PID]->descriptor_tag = 0x56;
                            Complete_Stream->Streams[elementary_PID]->Teletexts[ID].Infos["Language"] = MediaInfoLib::Config.Iso639_1_Get(
                                    ISO_639_language_code);
                            Complete_Stream->Streams[elementary_PID]->Teletexts[ID].Infos["Language_More"] = Mpeg_Descriptors_teletext_type_more(
                                    teletext_type);
                            Complete_Stream->Streams[elementary_PID]->Teletexts[ID].Infos["Format"] = Mpeg_Descriptors_teletext_type(
                                    teletext_type);
                            Complete_Stream->Streams[elementary_PID]->Teletexts[ID].Infos["Codec"] = Mpeg_Descriptors_teletext_type(
                                    teletext_type);
                        }
                        break;
                    default    :;
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_58() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            Skip_SB("reserved");
            Get_SB(local_time_offset_polarity, "local_time_offset_polarity");
            Param_Info1(local_time_offset_polarity ? "-" : "+");
            BS_End();
            Get_B2(local_time_offset, "local_time_offset");
            Param_Info1(TimeHHMM_BCD(local_time_offset));
            Info_B2(date, "time_of_change (date)");
            Param_Info1(Date_MJD(date));
            Info_B3(time, "time_of_change (time)");
            Param_Info1(Time_BCD(time));
            Info_B2(next_time_offset, "next_time_offset");
            Param_Info1(TimeHHMM_BCD(next_time_offset));

            FILLING_BEGIN() ;
                Ztring Country;
                Country.From_CC3(country_code);
                if (country_region_id)
                    Country += __T(" (") + Ztring::ToZtring(country_region_id) + __T(")");
                Complete_Stream->TimeZones[Country] =
                        (local_time_offset_polarity ? __T('-') : __T('+')) + TimeHHMM_BCD(local_time_offset);
            FILLING_END();
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_59() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            int32u ISO_639_language_code;
            Get_C3(ISO_639_language_code, "ISO_639_language_code");
            Info_B1(subtitling_type, "subtitling_type");
            Param_Info1(Mpeg_Descriptors_component_type_O3(subtitling_type));
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_5A() {
        //Parsing
        Info_B4(centre_frequency, "centre_frequency");
        Param_Info2(((int64u) centre_frequency) * 10, " Hz");
        BS_Begin();
        Info_S1(3, bandwidth, "bandwidth");
        Param_Info1(Mpeg_Descriptors_bandwidth[bandwidth]);
        Info_SB(priority, "priority");
        Param_Info1(priority ? "HP" : "LP");
        Skip_SB("Time_Slicing_indicator");
        Skip_SB("MPE-FEC_indicator");
        Skip_S1(2, "reserved");
        Info_S1(2, constellation, "constellation");
        Param_Info1(Mpeg_Descriptors_constellation[constellation]);
        Info_S1(3, hierarchy_information, "hierarchy_information");
        Param_Info1(Mpeg_Descriptors_hierarchy_information[hierarchy_information]);
        Info_S1(3, code_rate_HP, "code_rate-HP_stream");
        Param_Info1(Mpeg_Descriptors_code_rate[code_rate_HP]);
        Info_S1(3, code_rate_LP, "code_rate-LP_stream");
        Param_Info1(Mpeg_Descriptors_code_rate[code_rate_LP]);
        Info_S1(2, guard_interval, "guard_interval");
        Param_Info1(Mpeg_Descriptors_guard_interval[guard_interval]);
        Info_S1(2, transmission_mode, "transmission_mode");
        Param_Info1(Mpeg_Descriptors_transmission_mode[transmission_mode]);
    ...
    void File_Mpeg_Descriptors::Descriptor_5D() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            FILLING_BEGIN() ;
                ...
                const Ztring &ISO_639_1 = MediaInfoLib::Config.Iso639_1_Get(ISO_639_2);
                ServiceProvider +=
                        (ISO_639_1.empty() ? ISO_639_2 : ISO_639_1) + __T(':') + service_provider_name + __T(" - ");
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_5F() {
        //Parsing
        Info_B4(private_data_specifier, "private_data_specifier");
        Param_Info1(Ztring().From_CC4(private_data_specifier));
    }
    ...
    void File_Mpeg_Descriptors::Descriptor_63() {
        ...
        FILLING_BEGIN() ;
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid)
                        Complete_Stream->Streams[elementary_PID]->Infos["OverallBitRate_Maximum"] = Ztring::ToZtring(
                                peak_rate * 400);
                    break;
                case 0x7F : //selection_information_section
                    Complete_Stream->Transport_Streams[Complete_Stream->transport_stream_id].Infos["OverallBitRate_Maximum"] = Ztring::ToZtring(
                            peak_rate * 400);
                    break;
                default    :;
            }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_6A() {
        ...
        if (component_type_flag) {
            ...
            Get_S1(3, service_type, "service_type");
            Param_Info1(AC3_Mode[service_type]);
            Get_S1(3, number_of_channels, "number_of_channels");
            Param_Info2(Mpeg_Descriptors_AC3_Channels[number_of_channels], " channels");
            BS_End();
                ...
                switch (table_id) {
                    case 0x02 : //program_map_section
                        if (elementary_PID_IsValid) {
                            ...
                            Complete_Stream->Streams[elementary_PID]->Infos["Channel(s)"] = Ztring().From_Local(
                                    Mpeg_Descriptors_AC3_Channels[number_of_channels]);
                        }
                        break;
                    default    :;
                }
            ...
            switch (table_id) {
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        Complete_Stream->Streams[elementary_PID]->Infos["Format"] = enhanced_ac3 ? __T("E-AC-3") : __T(
                                "AC-3");
    ...
    void File_Mpeg_Descriptors::Descriptor_7F_0F() {
        ...
        FILLING_BEGIN() ;
            if (elementary_PID_IsValid) {
                ...
                Complete_Stream->Streams[elementary_PID]->Infos["Matrix_ChannelPositions"] =
                        __T("DTS Neural Audio ") + Ztring::ToZtring(config_id);
            }
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_81() {
        ...
        BS_Begin();
        Get_S1(3, sample_rate_code, "sample_rate_code");
        if (sample_rate_code < 4) { Param_Info2(AC3_SamplingRate[sample_rate_code], " Hz"); }
        Skip_S1(5, "bsid");
        Get_S1(6, bit_rate_code, "bit_rate_code");
        Param_Info2(AC3_BitRate[bit_rate_code] * 1000, " Kbps");
        Get_S1(2, surround_mode, "surround_mode");
        Param_Info1(AC3_Surround[surround_mode]);
        Get_S1(3, bsmod, "bsmod");
        Get_S1(4, num_channels, "num_channels");
        if (num_channels < 8) { Param_Info2(AC3_Channels[num_channels], " channels"); }
        Skip_SB("full_svc");
        BS_End();
                ...
                case 0x02 : //program_map_section
                    if (elementary_PID_IsValid) {
                        ...
                        if (sample_rate_code < 4)
                            Complete_Stream->Streams[elementary_PID]->Infos["SamplingRate"] = Ztring::ToZtring(
                                    AC3_SamplingRate[sample_rate_code]);
                        Complete_Stream->Streams[elementary_PID]->Infos["BitRate"] = Ztring::ToZtring(
                                AC3_BitRate[bit_rate_code] * 1000);
                        if (num_channels < 8)
                            Complete_Stream->Streams[elementary_PID]->Infos["Channel(s)"] = Ztring::ToZtring(
                                    AC3_Channels[num_channels]);
                    }
            }
        FILLING_END();
        ...
        if (bsmod < 2) {
            BS_Begin();
            Skip_S1(3, "mainid");
            Info_BS(2, priority, "priority");
            Param_Info1(Mpeg_Descriptors_AC3_Priority[priority]);
            Skip_S1(3, "reserved");
            BS_End();
        } else
            Skip_B1("asvcflags");
        ...
        Get_S1(1, text_code, "text_code");
        Param_Info1C((text_code), "Unicode");
        BS_End();
        if (textlen)
        ...
        for (int8u Pos = 0; Pos < number_of_services; Pos++) {
            ...
            if (event_id_IsValid) {
                if (digital_cc) {
                    ...
                    string &Value = Complete_Stream->Sources[table_id_extension].ATSC_EPG_Blocks[Complete_Stream->Streams[pid]->table_type].Events[event_id].ServiceDescriptors->ServiceDescriptors608[line21_field
                                                                                                                                                                                                       ? 1
                                                                                                                                                                                                       : 0].language;
                    if (!Value.empty())
                        Value += ", ";
...
#if defined(MEDIAINFO_EIA608_YES)
                    string &Value = Complete_Stream->Streams[elementary_PID]->ServiceDescriptors.ServiceDescriptors608[line21_field
                                                                                                                       ? 1
                                                                                                                       : 0].language;
                    if (!Value.empty())
                        Value += ", ";
...
#if defined(MEDIAINFO_EIA608_YES)
                    string &Value = Complete_Stream->Transport_Streams[transport_stream_id].Programs[program_number].ServiceDescriptors->ServiceDescriptors608[line21_field
                                                                                                                                                               ? 1
                                                                                                                                                               : 0].language;
                    if (!Value.empty())
                        Value += ", ";
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_A1() {
        ...
        for (int8u Pos = 0; Pos < number_elements; Pos++) {
            ...
            //Filling
            if (elementary_PID < Complete_Stream->Streams.size() &&
                Complete_Stream->Streams[elementary_PID]->Infos["Language"].empty()) //We use only the first detected value
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Descriptor_E9() {
        ...
        for (int8u i = 0; i < num_partitions; ++i) {
            ...
            FILLING_BEGIN() ;
                Complete_Stream->Streams[elementary_PID]->Infos["EBP_Mode"] = EBP_data_explicit_flag ? __T("Explicit")
                                                                                                     : __T("Implicit");
                if (EBP_distance != (int64u) -1)
                    Complete_Stream->Streams[elementary_PID]->Infos["EBP_Distance"] =
                            ticks_per_second == 1 ? Ztring::ToZtring(EBP_distance) : Ztring::ToZtring(
                                    ((float64) EBP_distance) / ticks_per_second, 3);
            FILLING_END();
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::CUEI_02() {
        ...
        if (!segmentation_event_cancel_indicator) {
            ...
            FILLING_BEGIN() ;
                for (size_t Program_Pos = 0;
                     Program_Pos < Complete_Stream->Streams[pid]->program_numbers.size(); Program_Pos++) {
                    ...
                    if (Scte35) {
                        ...
                        switch (segmentation_type_id) {
                            case 0x11 :
                                ...
                                Status = 1;
                                break; //Program Start/End
                            case 0x12 :
                                segmentation_type_id = 0x10;
                                Status = 2;
                                break; //Program Start/Early Termination
                            case 0x14 :
                                segmentation_type_id = 0x13;
                                Status = 1;
                                break; //Program Breakaway/Resumption
                            case 0x21 :
                                segmentation_type_id = 0x20;
                                Status = 1;
                                break; //Chapter Start/End
                            case 0x31 :
                                segmentation_type_id = 0x30;
                                Status = 1;
                                break; //Provider Advertisement Start/End
                            case 0x33 :
                                segmentation_type_id = 0x32;
                                Status = 1;
                                break; //Distributor Advertisement Start/End
                            case 0x41 :
                                segmentation_type_id = 0x40;
                                Status = 1;
                                break; //Unscheduled Event Start/End
                            default   :;
                        }
            ...
            for (int8u segment_Pos = 0; segment_Pos < number_segments; segment_Pos++) {
                ...
                switch (compression_type) {
                    case 0x00 :
                        switch (mode) {
                            case 0x00 :
                                Get_Local(number_bytes, segment, "string");
                                break;
                            case 0x3F :
                                Get_UTF16B(number_bytes, segment, "string");
                                break;
                            default   :
                                Skip_XX(number_bytes, "Unknown");
                                segment = __T("(Encoded with mode=0x") + Ztring::ToZtring(mode, 16) + __T(')');
                        }
                        break;
                    default   :
                        Skip_XX(number_bytes, "(Compressed)");
...
//---------------------------------------------------------------------------
    void File_Mpeg_Descriptors::Get_DVB_Text(int64u Size, Ztring &Value, const char *Info) {
        ...
        if (CodePage1 < 0x20) {
            Skip_B1("CodePage");
            Param_Info1(Mpeg_Descriptors_codepage_1(CodePage1));
            if (CodePage1 != 0x10) {
...
//Form: HHMMSS, BCD
    Ztring File_Mpeg_Descriptors::Time_BCD(int32u Time) {
        return (((Time >> 16) & 0xFF) < 10 ? __T("0") : __T("")) + Ztring::ToZtring((Time >> 16) & 0xFF, 16) +
               __T(":") //BCD
               + (((Time >> 8) & 0xFF) < 10 ? __T("0") : __T("")) + Ztring::ToZtring((Time >> 8) & 0xFF, 16) +
               __T(":") //BCD
...
//Form: HHMM, BCD
    Ztring File_Mpeg_Descriptors::TimeHHMM_BCD(int16u Time) {
        return (((Time >> 8) & 0xFF) < 10 ? __T("0") : __T("")) + Ztring::ToZtring((Time >> 8) & 0xFF, 16) +
               __T(":") //BCD
