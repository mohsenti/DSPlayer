    ...
    static const char *Mpeg4_Meta_Kind(int32u Kind) {
        switch (Kind) {
            ...
            case 0x0E :
                return "Jpeg";
            case 0x15 :
                return "Signed Integer"; //the size of the integer is derived from the container size
            case 0x16 :
                return "Float 32";
            case 0x17 :
                return "Float 64";
    ...
    const char *Mpeg4_chan(int16u Ordering) {
        ...
        switch (Ordering) {
            ...
            case 101 :
                return "Front: L R";
            case 102 :
                return "Front: L R (Headphones)"; //With headphones
            case 103 :
                return "Front: L R (Matrix)"; //With matrix
            case 104 :
                return "Front: C S";
            case 105 :
                return "Front: X Y";
            case 106 :
                return "Front: L R (Binaural)";
            case 107 :
                return "Front: W X Y Z";
            case 108 :
                return "Front: L R, Side: L R";
            case 109 :
                return "Front: L C R, Rear: L R";
            case 110 :
                return "Front: L C R, Rear: L C R";
            case 111 :
                return "Front: L C R, Side: L R, Rear: L C R";
            case 112 :
                return "Front: L R, TopFront: L R, Rear: L R, TopRear: L R";
            case 113 :
                return "Front: L C R";
            case 114 :
                return "Front: L C R";
            case 115 :
                return "Front: L C R, Rear: C";
            case 116 :
                return "Front: L C R, Rear: C";
            case 117 :
            ...
            case 124 :
                return "Front: L C R, Side: L R, LFE";
            case 125 :
                return "Front: L C R, Side: L C R";
            case 126 :
                return "Front: L Lc C Rc R, Side: L R";
            case 127 :
                return "Front: L Lc Rc R, Side: L R, LFE";
            case 128 :
                return "Front: L C R, Side: L R, Rear: L R, LFE";
            case 129 :
                return "Front: L C R, Side: L R, Rear: L R, LFE";
            case 130 :
                return "Front: L C R, Side: L R, LF, Front: L R (Matrix)";
            case 131 :
                return "Front: L R, Rear: C";
            case 132 :
                return "Front: L R, Side: L R";
            case 133 :
                return "Front: L R, LFE";
            case 134 :
                return "Front: L R, Rear: C, LFE";
            case 135 :
                return "Front: L C R, Side: L R, LFE";
            case 136 :
                return "Front: L C R, LFE";
            case 137 :
                return "Front: L C R, Rear: C, LFE";
            case 138 :
                return "Front: L R, Rear: L R, LFE";
            case 139 :
                return "Front: L C R, Rear: L R, LFE";
            case 140 :
                return "Front: L C R, Side: L R, Rear: L R";
            case 141 :
                return "Front: L C R, Side: L R, Rear: C";
            case 142 :
                return "Front: L C R, Side: L R, Rear: C, LFE";
            case 143 :
                return "Front: L C R, Side: L R, Rear: L R";
            case 144 :
                return "Front: L C R, Side: L R, Rear: L C R";
            case 145 :
                return "Front: Lw L C R Rw, TopFront: L C R, Side: L R, Rear: L C Cd R, LFE: L R"; //d=direct, all must be confirmed
            case 146 :
                return "Front: Lw L Lc C Rc R Rw, TopFront: L C R, Side: L R, Rear: L C Cd R, LFE: L R, HI, VI, Haptic"; //d=direct, all must be confirmed
            default  :
                return "";
        }
    }
    ...
    const char *Mpeg4_chan_Layout(int16u Ordering) {
        ...
        switch (Ordering) {
            ...
            case 101 :
                return "L R";
            case 102 :
                return "L R"; //With headphones
            case 103 :
                return "Lt Rt"; //L R with matrix
            case 104 :
                return "M S";
            case 105 :
                return "X Y";
            ...
            case 108 :
                return "L R Ls Rs";
            case 109 :
                return "L R Lrs Rrs C";
            case 110 :
                return "L R Lrs Rrs C Cs";
            case 111 :
                return "L R Lrs Rrs C Crs, Ls, Rs";
            case 112 :
                return "L R Lrs Rrs Vhl Vhr, Vhlrs, Vhrrs";
            case 113 :
                return "L R C";
            case 114 :
                return "C L R";
            ...
            case 127 :
                return "C Lc Rc L R Ls Rs LFE";
            case 128 :
                return "L R C LFE Ls R Rls Rrs";
            case 129 :
                return "L R Ls Rs C LFE Lc Rc";
            case 130 :
                return "L R C LFE Ls Rs Lt Rt";
            case 131 :
                return "L R Cs";
            case 132 :
                return "L R Ls Rs";
            ...
            case 137 :
                return "L R C LFE Cs";
            case 138 :
                return "L R Ls Rs LFE";
            case 139 :
                return "L R Ls Rs C Cs";
            case 140 :
                return "L R Ls Rs C Rls Rrs";
            case 141 :
                return "C L R Ls Rs Cs ";
            case 142 :
                return "C L R Ls Rs Cs LFE";
            case 143 :
                return "C L R Ls Rs Rls Rrs";
            case 144 :
                return "C L R Ls Rs Rls Rrs Cs";
            case 145 :
                return "L R C Vhc Lsd Rsd Ls Rs Vhl Vhr Lw Rw Csd Cs LFE1 LFE2";
            case 146 :
                return "L R C Vhc Lsd Rsd Ls Rs Vhl Vhr Lw Rw Csd Cs LFE1 LFE2 Lc Rc HI VI Haptic";
            case 147 :
                return "";
            default  :
                return "";
    ...
    static const char *Mpeg4_chan_ChannelBitmap_Layout(int32u ChannelBitmap) {
        switch (ChannelBitmap) {
            ...
            case 2 :
                return "C";      // Center
            case 3 :
                return "LFE";    // LFEScreen
            case 4 :
                return "Ls";     // LeftSurround / Back Left
            case 5 :
                return "Rs";     // RightSurround / Back Right
            case 6 :
                return "?";      // LeftCenter
            case 7 :
                return "?";      // RightCenter
            case 8 :
                return "Cs";     // CenterSurround / Back Center
            case 9 :
                return "Lsd";    // LeftSurroundDirect / Side Left
            case 10 :
                return "Rsd";    // RightSurroundDirect / Side Right
            case 11 :
                return "?";      // TopCenterSurround
            case 12 :
                return "?";      // VerticalHeightLeft / Top Front Left
            case 13 :
                return "?";      // VerticalHeightCenter / Top Front Center
            case 14 :
                return "?";      // VerticalHeightRight / Top Front Right"
            case 15 :
                return "?";      // TopBackLeft
            case 16 :
...
// DTS
    ...
    extern std::string
    DTS_HD_SpeakerActivityMask(int16u SpeakerActivityMask, bool AddCs = false, bool AddLrsRrs = false);

    extern std::string
    DTS_HD_SpeakerActivityMask2(int16u SpeakerActivityMask, bool AddCs = false, bool AddLrsRrs = false);
...
//---------------------------------------------------------------------------
    static const char *Mpeg4_Description(int32u Description) {
        switch (Description) {
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_atom :
                return "Classic atom structure";
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_qtat :
                return "QT atom structure";
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_fxat :
                return "Effect";
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_priv :
                return "Private";
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_subs :
                return "Substitute if main codec not available";
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm_cspc :
                                                        ...
                                                        ATOM_BEGIN
                                                                ...
                                                                ATOM_BEGIN
                                                                        ...
                                                                        ATOM_BEGIN
                                                                                ...
                                                                                ATOM_DEFAULT(
                                                                                        moov_trak_mdia_minf_stbl_stsd_xxxx_wave_xxxx)
                                                                        ATOM_END_DEFAULT
                                                                ATOM_END
                                                        ATOM_END_DEFAULT
...
//---------------------------------------------------------------------------
    void File_Mpeg4::cdat() {
        ...
        while (Element_Offset + 2 <= Element_Size) {
            for (size_t Pos = 0; Pos < Streams[(int32u) Element_Code].Parsers.size(); Pos++)
                Open_Buffer_Continue(Streams[(int32u) Element_Code].Parsers[Pos],
                                     Buffer + Buffer_Offset + (size_t) Element_Offset, 2);
            Element_Offset += 2;
        }
    }
            ...
            for (size_t Pos = 0; Pos < ftyps.size(); Pos++)
                switch (ftyps[Pos]) {
                    case Elements::ftyp_dash :
                        if (Config->File_Names.size() == 1)TestContinuousFileNames(1, __T("m4s"));
                        break;
                    case Elements::ftyp_caqv :
                        Fill(StreamKind_Last, StreamPos_Last, "Encoded_Application", "Casio Digital Camera");
                        break;
                    default :;
                }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::jp2c() {
        ...
        File_Jpeg MI;
        if (IsSub ||
            Config->File_Names.size() > 1) //If contained in another container or several files, this is a video stream
...
//---------------------------------------------------------------------------
    void File_Mpeg4::jp2h_colr() {
        ...
        //Parsing
        int8u METH;
        Get_B1(METH, "METH - Specification method");
        Param_Info1(Mpeg4_jp2h_METH(METH));
        Skip_B1("PREC - Precedence");
        Skip_B1("APPROX - Colourspace approximation");
        switch (METH) {
            case 0x01 : {
                int32u EnumCS;
                Get_B4(EnumCS, "EnumCS - Enumerated colourspace");
                Param_Info1(Mpeg4_jp2h_EnumCS(EnumCS));
                Fill(StreamKind_Last, 0, "ColorSpace", Mpeg4_jp2h_EnumCS(EnumCS));
            }
                break;
            case 0x02 :
                Skip_XX(Element_Size - Element_Offset, "PROFILE");
                break;
            default   :
    ...
    void File_Mpeg4::mdat() {
        ...
        if (Retrieve(Stream_General, 0, General_HeaderSize).empty()) {
            ...
            if (File_Size != (int64u) -1 && File_Offset + Buffer_Offset + Element_TotalSize_Get() <= File_Size)
                Fill(Stream_General, 0, General_FooterSize,
                     File_Size - (File_Offset + Buffer_Offset + Element_TotalSize_Get()));
        ...
        if (IsSecondPass && !mdat_Pos.empty() &&
            mdat_Pos.begin()->Offset < File_Offset + Buffer_Offset + Element_TotalSize_Get()) {
            //Next piece of data
    ...
    void File_Mpeg4::mdat_xxxx() {
        ...
        if (Stream_Temp.StreamKind != Stream_Other && Stream_Temp.StreamKind != Stream_Max) {
            ...
            if (Stream_Temp.stts_Durations_Pos < Stream_Temp.stts_Durations.size()) {
                stream::stts_durations::iterator stts_Duration =
                        Stream_Temp.stts_Durations.begin() + Stream_Temp.stts_Durations_Pos;
                int64u stts_Offset = stts_Duration->DTS_Begin + (((int64u) stts_Duration->SampleDuration) *
                                                                 (Frame_Count_NotParsedIncluded -
                                                                  stts_Duration->Pos_Begin));
                if (!Stream_Temp.edts.empty()) {
                    ...
                    switch (Stream_Temp.edts.size()) {
                        case 0 :
                            break;
                        case 1 :
                            if (Stream_Temp.edts[0].Duration == Stream_Temp.tkhd_Duration &&
                                Stream_Temp.edts[0].Rate == 0x00010000 && moov_mvhd_TimeScale) {
                                Delay = -((int64s) Stream_Temp.edts[0].Delay);
                            }
                            break;
                        case 2 :
                            if (Stream_Temp.edts[0].Delay == (int32u) -1 &&
                                Stream_Temp.edts[0].Duration + Stream_Temp.edts[1].Duration ==
                                Stream_Temp.tkhd_Duration && Stream_Temp.edts[0].Rate == 0x00010000 &&
                                Stream_Temp.edts[1].Rate == 0x00010000 && moov_mvhd_TimeScale) {
                ...
                FrameInfo.DTS = Stream_Temp.mdhd_TimeScale ? (TimeCode_DtsOffset +
                                                              stts_Offset * 1000000000 / Stream_Temp.mdhd_TimeScale)
                                                           : ((int64u) -1);
                FrameInfo.PTS = Stream_Temp.PtsDtsAreSame ? FrameInfo.DTS : (int64u) -1;
                FrameInfo.DUR = Stream_Temp.mdhd_TimeScale ? (((int64u) stts_Duration->SampleDuration) * 1000000000 /
                                                              Stream_Temp.mdhd_TimeScale) : ((int64u) -1);
                ...
                if (!ShouldDemux) {
                    if (Stream_Temp.CodecID == 0x4156696E) //AVin
                    {
                        ...
                        if (Stream_Temp.stts.size() == 1)
                            ...
                            SampleDuration = 0;
                        Stream_Temp.CodecID = File_Avc::AVC_Intra_CodecID_FromMeta(Height, Fields, SampleDuration,
                                                                                   Stream_Temp.mdhd_TimeScale,
                                                                                   Stream_Temp.stsz_Sample_Size);
                    }
                    ...
                    memcpy(Buffer_Temp_Data + AvcIntraHeader.Size, Buffer + Buffer_Offset + Stream_Temp.Demux_Offset,
                           (size_t) (Element_Size - Stream_Temp.Demux_Offset));
            ...
            if (ShouldDemux) {
                Demux_Level = Stream_Temp.Demux_Level;
                Demux(Buffer + Buffer_Offset + Stream_Temp.Demux_Offset,
                      (size_t) (Element_Size - Stream_Temp.Demux_Offset), ContentType_MainStream);
            }
        }
#endif //MEDIAINFO_DEMUX
                    ...
                    if (((File_Mpeg4_TimeCode *) Stream_Temp.Parsers[Pos])->Pos != (int32u) -1) {
                        for (std::map<int32u, stream>::iterator StreamTemp = Streams.begin();
                            ...
                            if (StreamTemp->second.TimeCode_TrackID == (int32u) Element_Code) {
                                ...
                                TimeCode_DtsOffset = float64_int64s(((float64) TimeCode_FrameOffset) * 1000000000 *
                                                                    Stream_Temp.TimeCode->FrameDuration /
                                                                    Stream_Temp.TimeCode->TimeScale);
                            }
                    }
                }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moof_traf_sdtp() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            BS_Begin();
            Skip_S1(2, "reserved");
            Info_S1(2, sample_depends_on, "sample_depends_on");
            Param_Info1(Mpeg4_sample_depends_on[sample_depends_on]);
            Info_S1(2, sample_is_depended_on, "sample_is_depended_on");
            Param_Info1(Mpeg4_sample_is_depended_on[sample_is_depended_on]);
            Info_S1(2, sample_has_redundancy, "sample_has_redundancy");
            Param_Info1(Mpeg4_sample_has_redundancy[sample_has_redundancy]);
            BS_End();
            Element_End0();
        }
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moof_traf_trun() {
        ...
        int64u data_offset_Final =
                moof_traf_base_data_offset != (int64u) -1 ? moof_traf_base_data_offset : moof_base_data_offset;
    ...
    void File_Mpeg4::moov() {
        if (!Status[IsAccepted]) {
            ...
            Fill(Stream_General, 0, General_Format,
                 "QuickTime"); //If there is no ftyp atom, this is an old Quictime file
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_cmov_cmvd() {
        ...
        switch (moov_cmov_dcom_Compressor) {
            case Elements::moov_cmov_dcom_zlib :
                moov_cmov_cmvd_zlib();
                break;
            default:
                Skip_XX(Element_Size, "Data");
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_meta_ilst_xxxx_data() {
        ...
        Ztring Value;
        Get_B4(Kind, "Kind");
        Param_Info1(Mpeg4_Meta_Kind(Kind));
        ...
        switch (Kind) {
            case 0x00 : //Binary
                ...
                switch (Element_Code_Get(Element_Level - 1)) {
                    ...
                    case Elements::moov_meta__covr : {
                        std::string Data_Raw((const char *) (Buffer + (size_t) (Buffer_Offset + Element_Offset)),
            ...
            case 0x15 : //Signed Integer
            {
                ...
                switch (Element_Size - Element_Offset) {
                    case 1 : {
                        int8u ValueI;
                        Get_B1(ValueI, "Value");
                        Value.From_Number((int8s) ValueI);
                    };
                        break;
                    case 2 : {
                        int16u ValueI;
                        Get_B2(ValueI, "Value");
                        Value.From_Number((int16s) ValueI);
                    };
                        break;
                    case 4 : {
                        int32u ValueI;
                        Get_B4(ValueI, "Value");
                        Value.From_Number((int32s) ValueI);
                    };
                        break;
                    case 8 : {
                        int64u ValueI;
                        Get_B8(ValueI, "Value");
                        Value.From_Number((int64s) ValueI);
                    };
                        break;
                    default  :
                        Value = __T("Unknown kind of integer value!");
                }
            }
                break;
            case 0x16 : //Float 32
            ...
            case 0x17 : //Float 64
                ...
                break;
            default:
                Value = __T("Unknown kind of value!");
        }
                ...
                FILLING_BEGIN() ;
                    ...
                    if (Parameter == "cdec") {
                        if (Value.find(__T("ndaudio ")) == 0) {
                            ...
                            List.Write(Value);
                            Element_Info1(Parameter.c_str());
                            Fill(Stream_Audio, StreamPos_Last, Audio_Encoded_Library_Name, "Nero AAC codec", Unlimited,
                                 true, true);
                            Fill(Stream_Audio, StreamPos_Last, Audio_Encoded_Library_Name,
                                 List(0).substr(8, string::npos), true);
                            Fill(Stream_Audio, StreamPos_Last, Audio_Encoded_Library_Settings, List(1), true);
                            Parameter.clear(); //Set as already filled
                        }
                    }
                    if (Parameter == "Compilation" || Parameter == "HDVideo" || Parameter == "iTunesU" ||
                        Parameter == "Podcast") {
                        if (Value == __T("1"))
                            Value = __T("Yes");
                        else
                ...
                if (!moov_udta_meta_keys_List.empty()) {
                    FILLING_BEGIN() ;
                        ...
                        Metadata_Get(Parameter, moov_udta_meta_keys_List[moov_udta_meta_keys_ilst_Pos <
                                                                         moov_udta_meta_keys_List.size()
                                                                         ? moov_udta_meta_keys_ilst_Pos :
                                                                         moov_udta_meta_keys_List.size() - 1]);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_mvhd() {
        ...
        Get_B4(moov_mvhd_TimeScale, "Time scale");
        Param_Info1(Ztring::ToZtring(moov_mvhd_TimeScale) + __T(" Hz"));
        Get_B_DEPENDOFVERSION(Duration, "Duration");
        Param_Info1C(moov_mvhd_TimeScale,
                     Ztring::ToZtring((int64u) Duration * 1000 / moov_mvhd_TimeScale) + __T(" ms"));
        Get_B4(Rate, "Preferred rate");
        Param_Info1(Ztring::ToZtring(((float32) Rate) / 0x10000));
        Get_B2(Volume, "Preferred volume");
        Param_Info1(Ztring::ToZtring(((float32) Volume) / 0x100));
        Skip_XX(10, "Reserved");
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_edts_elst() {
        ...
        for (int32u Pos = 0; Pos < Count; Pos++) {
            ...
            Element_Begin1("Entry");
            Get_B_DEPENDOFVERSION(edts.Duration, "Track duration");
            Param_Info2C(moov_mvhd_TimeScale, (int64u) edts.Duration * 1000 / moov_mvhd_TimeScale, " ms");
            Get_B_DEPENDOFVERSION(edts.Delay, "Media time");
            Param_Info2C(moov_mvhd_TimeScale && (edts.Delay != (int32u) -1),
                         (int64u) edts.Delay * 1000 / moov_mvhd_TimeScale, " ms");
            Get_B4(edts.Rate, "Media rate");
            Param_Info1(((float) edts.Rate) / 0x10000);
            Element_End0();
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_load() {
        ...
        //Parsing
        Info_B4(PreloadTime, "Preload time");
        Param_Info2C(moov_mvhd_TimeScale, PreloadTime * 1000 / moov_mvhd_TimeScale, " ms");
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_hdlr() {
        ...
        if (Element_Offset < Element_Size) {
            ...
            if (Title.find(__T("Handler")) != std::string::npos || Title.find(__T("handler")) != std::string::npos ||
                Title.find(__T("vide")) != std::string::npos || Title.find(__T("soun")) != std::string::npos ||
                Title == Ztring().From_CC4(SubType))
        ...
        FILLING_BEGIN() ;
            ...
            switch (SubType) {
                ...
                case Elements::moov_trak_mdia_hdlr_hint :
                    if (StreamKind_Last ==
                        Stream_Max) //Note: some files have both vmhd and hmhd, I don't know the meaning of such header, so skipping hmhd for the moment
                    {
                        Stream_Prepare(Stream_Other);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_imap_sean___in___ty() {
        ...
        //Parsing
        Info_B4(TypeModifierName, "Type modifier name");
        Param_Info1(Mpeg4_TypeModifierName(TypeModifierName));
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_mdhd() {
        ...
        Get_B_DEPENDOFVERSION(Duration, "Duration");
        Param_Info2C(TimeScale, Duration * 1000 / TimeScale, " ms");
        Get_B2(Language, "Language");
        Param_Info1(Language_Get(Language));
        Skip_B2("Quality");
        ...
        FILLING_BEGIN() ;
            ...
            //Coherency tests
            if (Streams[moov_trak_tkhd_TrackID].tkhd_Duration * 1.01 >= Duration * 0.99 &&
                Streams[moov_trak_tkhd_TrackID].tkhd_Duration * 0.99 <= Duration * 1.01 && TimeScale &&
                moov_mvhd_TimeScale != TimeScale && moov_mvhd_TimeScale) {
                float64 Ratio = ((float64) TimeScale) / ((float64) moov_mvhd_TimeScale);
                Streams[moov_trak_tkhd_TrackID].tkhd_Duration = float64_int64s(
                        Streams[moov_trak_tkhd_TrackID].tkhd_Duration / Ratio);
                Clear(StreamKind_Last, StreamPos_Last, "Duration_Source");
                Fill(StreamKind_Last, StreamPos_Last, "Duration", float64_int64s(
                        ((float64) Streams[moov_trak_tkhd_TrackID].tkhd_Duration) * 1000 /
                        ((float64) moov_mvhd_TimeScale)), 10, true);
            }
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_dinf_dref_alis() {
        ...
        Get_B2(alias_kind, "alias kind");
        Param_Info1(alias_kind ? "directory" : "file");
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_stpp() {
        ...
        FILLING_BEGIN() ;
            ...
            Fill(StreamKind_Last, StreamPos_Last, Fill_Parameter(StreamKind_Last, Generic_Codec), "stpp", Unlimited,
                 true, true);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_text() {
        ...
        FILLING_BEGIN() ;
            ...
            Fill(StreamKind_Last, StreamPos_Last, Fill_Parameter(StreamKind_Last, Generic_Codec), "text", Unlimited,
                 true, true);
            Fill(StreamKind_Last, StreamPos_Last, Fill_Parameter(StreamKind_Last, Generic_Format), "Timed Text",
                 Unlimited, true, true);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_tmcd() {
        ...
        if (Element_Size == Element_Offset + 3 || (Element_Size >= Element_Offset + 7 && Element_Size >=
                                                                                         Element_Offset + 7 +
                                                                                         BigEndian2int32u(Buffer +
                                                                                                          Buffer_Offset +
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_tx3g() {
        ...
        Element_Begin1("default-text-box");
        if (Element_Size > 42 &&
            CC4(Buffer + Buffer_Offset + 38) == Elements::moov_trak_mdia_minf_stbl_stsd_tx3g_ftab) {
        ...
        FILLING_BEGIN() ;
            ...
            Fill(StreamKind_Last, StreamPos_Last, Fill_Parameter(StreamKind_Last, Generic_Codec), "tx3g", Unlimited,
                 true, true);
            Fill(StreamKind_Last, StreamPos_Last, Fill_Parameter(StreamKind_Last, Generic_Format), "Timed Text",
                 Unlimited, true, true);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_tx3g_ftab() {
        ...
        if (Element_Size == 0x17 - 8 && (BigEndian2int16u(Buffer + Buffer_Offset) != 1 ||
                                         BigEndian2int16u(Buffer + Buffer_Offset + 4) != 0x17 - 8 - 5)) {
            Skip_XX(Element_Size, "Unknown");
            return;
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx() {
        ...
        FILLING_BEGIN()
            if (StreamKind_Last == Stream_Max) {
                switch (Element_Code) {
                    case Elements::moov_trak_mdia_minf_stbl_stsd_mp4a :
                        Stream_Prepare(Stream_Audio);
                        break;
                    case Elements::moov_trak_mdia_minf_stbl_stsd_mp4v :
                        Stream_Prepare(Stream_Video);
                        break;
                    case Elements::moov_trak_mdia_minf_stbl_stsd_mp4s :
                        Stream_Prepare(Stream_Other);
                        break;
                    default                                           :;
                }
            ...
            switch (StreamKind_Last) {
                case Stream_Video :
                    moov_trak_mdia_minf_stbl_stsd_xxxxVideo();
                    break;
                case Stream_Audio :
                    moov_trak_mdia_minf_stbl_stsd_xxxxSound();
                    break;
                case Stream_Text  :
                    moov_trak_mdia_minf_stbl_stsd_xxxxText();
                    break;
                default           :
                    CodecID_Fill(Ztring().From_CC4((int32u) Element_Code), StreamKind_Last, StreamPos_Last,
                                 InfoCodecID_Format_Mpeg4);
                    switch (Element_Code) {
                        case Elements::moov_trak_mdia_minf_stbl_stsd_mp4s :
                            moov_trak_mdia_minf_stbl_stsd_xxxxStream();
                            break;
                        default                                           :
            ...
            if (Streams[moov_trak_tkhd_TrackID].Parsers.size() == 1 &&
                !Retrieve(StreamKind_Last, StreamPos_Last, "Encryption").empty()) {
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxxSound() {
        ...
        if (Version < 2) // Version 0 or 1
        {
            ...
            Skip_B2("Packet size");
            Get_B2(SampleRate16, "Sample rate");
            Param_Info2(SampleRate16, " Hz");
            Skip_B2("Reserved");
            if (Version >= 1) {
        ...
        FILLING_BEGIN() ;
...
#if defined(MEDIAINFO_AAC_YES)
            if (Version == 2 && Element_Code ==
                                Elements::moov_trak_mdia_minf_stbl_stsd_mp4a) //This is not normal, but I don't know where is audioObjectType, default to 2 (AAC LC)
            {
...
#endif
#if defined(MEDIAINFO_AMR_YES)
            if (MediaInfoLib::Config.CodecID_Get(Stream_Audio, InfoCodecID_Format_Mpeg4, Ztring(Codec.c_str()),
                                                 InfoCodecID_Format) == __T("AMR")) {
                //Creating the parser
                File_Amr MI;
            ...
            if (MediaInfoLib::Config.CodecID_Get(Stream_Audio, InfoCodecID_Format_Mpeg4, Ztring(Codec.c_str()),
                ...
                if ((Channels == 1 && (StreamPos_Last % 2) == 0)
                    || (Streams.find(moov_trak_tkhd_TrackID - 1) != Streams.end() &&
                        Streams[moov_trak_tkhd_TrackID - 1].IsPcmMono)) {
                    ...
                    if (StreamPos_Last % 2 && !Streams[moov_trak_tkhd_TrackID - 1].Parsers.empty()) {
                        ...
                        Parser->Common = ((File_ChannelGrouping *) Streams[moov_trak_tkhd_TrackID -
                                                                           1].Parsers[0])->Common;
                ...
                //Specific cases
#if defined(MEDIAINFO_SMPTEST0337_YES)
                if (Channels == 2 && SampleSize <= 32 &&
                    SampleRate == 48000) //Some SMPTE ST 337 streams are hidden in PCM stream
                {
...
#if defined(MEDIAINFO_MPEGA_YES)
            if (MediaInfoLib::Config.CodecID_Get(Stream_Audio, InfoCodecID_Format_Mpeg4, Ztring(Codec.c_str()),
                                                 InfoCodecID_Format) == __T("MPEG Audio")) {
                //Creating the parser
            ...
            if (Element_Code == 0x6F776D61) //"owma"
            {
                ...
                FILLING_BEGIN() ;
                    ...
                    if (0);
#if defined(MEDIAINFO_MPEGA_YES)
                    else if (MediaInfoLib::Config.CodecID_Get(Stream_Audio, InfoCodecID_Format_Riff,
                                                              Ztring::ToZtring(CodecID, 16)) == __T("MPEG Audio")) {
                        File_Mpega *Parser = new File_Mpega;
                        Streams[moov_trak_tkhd_TrackID].Parsers.push_back(Parser);
                    }
#endif
                ...
                //Demux
#if MEDIAINFO_DEMUX
                if (!((MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4,
                                                        Ztring().From_CC4((int32u) Element_Code), InfoCodecID_Format) ==
                       __T("AVC") && Config->Demux_Avc_Transcode_Iso14496_15_to_Iso14496_10_Get())
                      || (MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4,
                                                           Ztring().From_CC4((int32u) Element_Code),
                                                           InfoCodecID_Format) == __T("HEVC") &&
                          Config->Demux_Hevc_Transcode_Iso14496_15_to_AnnexB_Get())))
                    switch (Config->Demux_InitData_Get()) {
                        case 0 :    //In demux event
                            Demux_Level = 2; //Container
                            Demux(Buffer + Buffer_Offset + Element_Offset - (18 + Data_Size), (size_t) (18 + Data_Size),
                                  ContentType_Header);
                            break;
                        case 1 :    //In field
                        {
                            std::string Data_Raw(
                                    (const char *) (Buffer + Buffer_Offset + Element_Offset - (18 + Data_Size)),
                                    (size_t) (18 + Data_Size));
                            std::string Data_Base64(Base64::encode(Data_Raw));
                            Fill(Stream_Audio, StreamPos_Last, "Demux_InitBytes", Data_Base64);
                            (*Stream_More)[Stream_Audio][StreamPos_Last](Ztring().From_Local("Demux_InitBytes"),
            ...
            Fill(Stream_Audio, StreamPos_Last, Audio_Channel_s_, Channels, 10, true);
            if (SampleSize != 0 && Element_Code != 0x6D703461 && (Element_Code & 0xFFFF0000) != 0x6D730000 &&
                Retrieve(Stream_Audio, StreamPos_Last, Audio_BitDepth).empty()) //if not mp4a, and not ms*
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxxText() {
        ...
        FILLING_BEGIN() ;
            Ztring CodecID;
            CodecID.From_CC4((int32u) Element_Code);
            CodecID_Fill(CodecID, Stream_Text, StreamPos_Last, InfoCodecID_Format_Mpeg4);

            if (MediaInfoLib::Config.CodecID_Get(Stream_Text, InfoCodecID_Format_Mpeg4, CodecID, InfoCodecID_Format) ==
                __T("EIA-608")) {
                //Creating the parser
            ...
            if (MediaInfoLib::Config.CodecID_Get(Stream_Text, InfoCodecID_Format_Mpeg4, CodecID, InfoCodecID_Format) ==
                ...
                Parser->AspectRatio =
                        ((float) 16) / 9; //TODO: this is hardcoded, must adapt it to the real video aspect ratio
                Streams[moov_trak_tkhd_TrackID].Parsers.push_back(Parser);
            }
#endif
#if defined(MEDIAINFO_TTML_YES)
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxxVideo() {
        ...
        FILLING_BEGIN() ;
            ...
            if (moov_trak_tkhd_DisplayAspectRatio && Height &&
                moov_trak_tkhd_DisplayAspectRatio != ((float32) Width) / Height) {
                Fill(Stream_Video, StreamPos_Last, Video_DisplayAspectRatio, moov_trak_tkhd_DisplayAspectRatio, 3,
                     true);
                Fill(Stream_Video, StreamPos_Last, Video_PixelAspectRatio,
                     moov_trak_tkhd_DisplayAspectRatio / Width * Height, 3, true);
            }
            Fill(Stream_Video, StreamPos_Last, Video_Rotation, moov_trak_tkhd_Rotation, 3);
            if (moov_trak_tkhd_Rotation)
                Fill(Stream_Video, StreamPos_Last, Video_Rotation_String,
                     Ztring::ToZtring(moov_trak_tkhd_Rotation, 0) + __T("\xB0")); //degree sign

            //Specific cases
            if (Streams[moov_trak_tkhd_TrackID].Parsers.empty()) {
#if defined(MEDIAINFO_DVDIF_YES)
                if (MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4, Ztring(Codec.c_str()),
                                                     InfoCodecID_Format) == __T("DV")) {
                    File_DvDif *Parser = new File_DvDif;
                    Streams[moov_trak_tkhd_TrackID].Parsers.push_back(Parser);
                }
#endif
#if defined(MEDIAINFO_MXF_YES)
                if (Element_Code == 0x6D78336E || Element_Code == 0x6D783370 || Element_Code == 0x6D78356E ||
                    Element_Code == 0x6D783570) //mx3n, mx3p, mx5n, mx5p
                {
                    File_Mxf *Parser = new File_Mxf;
                    Streams[moov_trak_tkhd_TrackID].Parsers.push_back(
                            Parser); // Note: MXF parser is set first but MPEG Video parser is still active because some IMX files have no MXF header
                ...
                if (MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4,
                    ...
                    switch ((int32u) Element_Code) {
                        ...
                        case 0x4156696E: //AVin
                            Streams[moov_trak_tkhd_TrackID].Demux_Level |= (1
                                    << 7); //Add the flag, SPS/PPS must be sent
                            Streams[moov_trak_tkhd_TrackID].CodecID = ((int32u) Element_Code);
                            switch ((Element_Code >> 8) & 0xF) {
                                case 1 :
                                    Fill(Stream_Video, StreamPos_Last, Video_Format_Commercial_IfAny, "AVC-Intra 100");
                                    break;
                                case 2 :
                                    Fill(Stream_Video, StreamPos_Last, Video_Format_Commercial_IfAny, "AVC-Intra 200");
                                    break;
                                case 5 :
                                    Fill(Stream_Video, StreamPos_Last, Video_Format_Commercial_IfAny, "AVC-Intra 50");
                                    break;
                                default:
                                    Fill(Stream_Video, StreamPos_Last, Video_Format_Commercial_IfAny, "AVC-Intra");
                                    break;
                            }
                            break;
                        default       :
...
#endif
#if defined(MEDIAINFO_VC1_YES)
                if (Element_Code != 0x76632D31 &&
                    MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4,
                                                     Ztring().From_CC4((int32u) Element_Code), InfoCodecID_Format) ==
                    __T("VC-1")) // If "vc-1" CodecID, there is a dvc1 atom, not using the hack with Sequence Header direct search
                {
                ...
                if (MediaInfoLib::Config.CodecID_Get(Stream_Video, InfoCodecID_Format_Mpeg4, Ztring(Codec.c_str()),
                                                     InfoCodecID_Format) == __T("JPEG 2000")) {
                    File_Mpeg4 *Parser = new File_Mpeg4;
                    Streams[moov_trak_tkhd_TrackID].Parsers.push_back(Parser);
            ...
            if (Element_Offset + 8 <= Element_Size
                && ((CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 0) >= 'A' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 0) <= 'z') ||
                    (CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 0) >= '0' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 0) <= '9'))
                && ((CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 1) >= 'A' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 1) <= 'z') ||
                    (CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 1) >= '0' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 1) <= '9'))
                && ((CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 2) >= 'A' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 2) <= 'z') ||
                    (CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 2) >= '0' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 2) <= '9'))
                && ((CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 3) >= 'A' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 3) <= 'z') ||
                    (CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 3) >= '0' &&
                     CC1(Buffer + Buffer_Offset + (size_t) Element_Offset + 4 + 3) <= '9')))
                Element_ThisIsAList();
            else if (Element_Offset < Element_Size)
                Descriptors();
        FILLING_END();
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_APRG() {
        ...
        Skip_C4("Tag");
        Skip_C4("Version");
        Get_B4(ScanType, "Number of fields");
        Param_Info1(ScanType == 1 ? "Progressive" : ScanType == 2 ? "Interlaced" : "");
        Skip_B4("Reserved"); // Must be 0
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_ARES() {
        ...
        Get_B4(x1, "Number of fields");
        Param_Info1(x1 == 1 ? "Progressive" : x1 == 2 ? "Interlaced" : "");
        ...
        switch (x1) {
            case 0x01 :
                Fill(Stream_Video, StreamPos_Last, Video_ScanType, "Progressive", Unlimited, true, true);
                break;
            case 0x02 :
    ...
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_avcC() {
        ...
        if (moov_trak_mdia_minf_stbl_stsd_Pos > 1) {
            ...
            for (size_t Pos = 0; Pos <
                                 Streams[moov_trak_tkhd_TrackID].Parsers.size(); Pos++) //Removing any previous parser (in case of multiple streams in one track, or dummy parser for demux)
            ...
            if (!Config->Demux_Avc_Transcode_Iso14496_15_to_Iso14496_10_Get())
                switch (Config->Demux_InitData_Get()) {
                    ...
                    case 1 :    //In field
                    {
                        ...
                        (*Stream_More)[Stream_Video][StreamPos_Last](Ztring().From_Local("Demux_InitBytes"),
                                                                     Info_Options) = __T("N NT");
                    }
                        break;
                    default :;
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_chan() {
        ...
        FILLING_BEGIN() ;
            if (ChannelLayoutTag == 0) //UseChannelDescriptions
            {
                Fill(Stream_Audio, StreamPos_Last, Audio_ChannelLayout, ChannelDescription_Layout.c_str(), Unlimited,
                     true, true);
                if (ChannelLabels_Valid)
                    Fill(Stream_Audio, StreamPos_Last, Audio_ChannelPositions,
                         Mpeg4_chan_ChannelDescription(ChannelLabels), true, true);
                else
            ...
            } else if (ChannelLayoutTag == 0x10000) //UseChannelBitmap
            {
                ...
                if (Channels) {
                    ...
                    Fill(Stream_Audio, StreamPos_Last, Audio_ChannelPositions, Mpeg4_chan_ChannelBitmap(ChannelBitmap),
                         true, true);
                    if (!ChannelDescription_Layout.empty()) {
                        ChannelDescription_Layout.resize(ChannelDescription_Layout.size() - 1);
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_colr() {
        ...
        switch (ColorParameterType) {
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_colr_clcn:
                moov_trak_mdia_minf_stbl_stsd_xxxx_colr_nclc(true);
                break;
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_colr_nclc:
                moov_trak_mdia_minf_stbl_stsd_xxxx_colr_nclc();
                break;
            case Elements::moov_trak_mdia_minf_stbl_stsd_xxxx_colr_prof:
                moov_trak_mdia_minf_stbl_stsd_xxxx_colr_prof();
                break;
            default                                                    :
                Skip_XX(Element_Size - Element_Offset, "Unknown");
        }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_colr_nclc(bool LittleEndian) {
        ...
        FILLING_BEGIN() ;
            if (Retrieve(Stream_Video, StreamPos_Last,
                         Video_colour_description_present).empty()) //Using only the first one met
            {
                Fill(Stream_Video, StreamPos_Last, Video_colour_description_present, "Yes");
                Fill(Stream_Video, StreamPos_Last, Video_colour_primaries,
                     Mpegv_colour_primaries((int8u) colour_primaries));
                Fill(Stream_Video, StreamPos_Last, Video_transfer_characteristics,
                     Mpegv_transfer_characteristics((int8u) transfer_characteristics));
                Fill(Stream_Video, StreamPos_Last, Video_matrix_coefficients,
                     Mpegv_matrix_coefficients((int8u) matrix_coefficients));
            }
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_d263() {
        ...
        switch (H263_Profile) {
            case 0x00 :
                ProfileLevel = __T("BaseLine");
                break;
            default   :
                ProfileLevel.From_Number(H263_Profile);
        }
        ProfileLevel += __T('@');
        ...
        Fill(Stream_Video, StreamPos_Last, Video_Encoded_Library,
             Retrieve(Stream_Video, StreamPos_Last, Video_Encoded_Library_Name) + __T(' ') + Ztring::ToZtring(Version));
        Ztring Encoded_Library_String = Retrieve(Stream_Video, StreamPos_Last, Video_Encoded_Library_Name) +
                                        (Version ? (__T(" Revision ") + Ztring::ToZtring(Version)) : Ztring());
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_dac3() {
        ...
        Fill(Stream_Audio, StreamPos_Last, Audio_Channel_s_, "", Unlimited, true,
             true); //Remove the value (is always wrong in the stsd atom)
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_damr() {
        ...
        Fill(Stream_Audio, StreamPos_Last, Audio_Encoded_Library,
             Retrieve(Stream_Audio, StreamPos_Last, Audio_Encoded_Library_Name) + __T(' ') + Ztring::ToZtring(Version));
        Ztring Encoded_Library_String = Retrieve(Stream_Audio, StreamPos_Last, Audio_Encoded_Library_Name) +
                                        (Version ? (__T(" Revision ") + Ztring::ToZtring(Version)) : Ztring());
    ...
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_ddts() {
        ...
        FILLING_BEGIN() ;
            if (DTSSamplingFrequency)
                Fill(StreamKind_Last, StreamPos_Last, Audio_SamplingRate, DTSSamplingFrequency, 10,
                     true); //This is the maximum sampling frequency
            if (avgBitrate)
            ...
            if (ChannelLayout) {
                ...
                Fill(Stream_Audio, 0, Audio_ChannelPositions_String2,
                     DTS_HD_SpeakerActivityMask2(ChannelLayout).c_str());
            }
                ...
                case 0x02 :
                    ...
                    switch (detail) {
                        ...
                        case 6 :   // Separated fields, BFF
                            ...
                            Fill(Stream_Video, StreamPos_Last, Video_ScanType_StoreMethod, "SeparatedFields", Unlimited,
                                 true, true);
                            break;
                        case 9  :  // Interleaved fields, TFF
                        case 14 :   // Interleaved fields, BFF
                            Fill(Stream_Video, StreamPos_Last, Video_ScanType_StoreMethod, "InterleavedFields",
                                 Unlimited, true, true);
                            break;
                        default  :;
                    }
                    ...
                    if (Retrieve(Stream_Video, StreamPos_Last, Video_Format) == __T("JPEG") &&
                        Streams[moov_trak_tkhd_TrackID].Parsers.size() == 1)
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_glbl() {
        ...
        //Parsing
        for (size_t Pos = 0; Pos < Streams[moov_trak_tkhd_TrackID].Parsers.size(); Pos++)
            Open_Buffer_OutOfBand(Streams[moov_trak_tkhd_TrackID].Parsers[Pos], Buffer + Buffer_Offset,
                                  (size_t) Element_Size);
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsd_xxxx_idfm() {
        ...
        Info_C4(Description, "Description");
        Param_Info1(Mpeg4_Description(Description));
    }
...
#if defined(MEDIAINFO_SMPTEST0337_YES)
                    ((File_ChannelGrouping *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Endianness = Endianness ? 'L'
                                                                                                                   : 'B';
#endif // MEDIAINFO_SMPTEST0337_YES
    ...
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stsz() {
        ...
        if (Sample_Size > 0) {
            ...
            if (StreamKind_Last == Stream_Audio) {
                ...
                if (Codec == __T("raw ")
                    ||
                    MediaInfoLib::Config.CodecID_Get(Stream_Audio, InfoCodecID_Format_Mpeg4, Codec).find(__T("PCM")) ==
                    0
                    ...
                    int64u Stream_Size_Real = Sample_Size;
                    Stream_Size_Real *= Sample_Count;
                    for (int64u Multiplier = 1; Multiplier <= 32; Multiplier++)
                        if (Stream_Size_Real * Multiplier > Stream_Size_Theory * 0.995 &&
                            Stream_Size_Real * Multiplier < Stream_Size_Theory * 1.005) {
            ...
            Stream->second.stsz_StreamSize = Sample_Size;
            Stream->second.stsz_StreamSize *= Sample_Count;
            if (Sample_Size == 1)
            ...
            */
                ...
                switch (FieldSize) {
                    case 4 :
                        ...
                        break;
                    case 8 :
                        Size = BigEndian2int8u(Buffer + Buffer_Offset + (size_t) Element_Offset);
                        Element_Offset++;
                        break;
                    case 16 :
                        Size = BigEndian2int16u(Buffer + Buffer_Offset + (size_t) Element_Offset);
                        Element_Offset += 2;
                        break;
                    case 32 :
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stts() {
        ...
        if (StreamKind_Last == Stream_Video && Retrieve(Stream_Video, StreamPos_Last, "Format") == __T("DV") &&
            Streams[moov_trak_tkhd_TrackID].Parsers[0] &&
            ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts == NULL)
        ...
        FILLING_BEGIN() ;
            if (StreamKind_Last == Stream_Video) {
                ...
                if (StreamKind_Last == Stream_Video && Retrieve(Stream_Video, StreamPos_Last, "Format") == __T("DV")) {
                    ...
                    for (size_t Pos = 0;
                         Pos < ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts->size(); Pos++) {
                        if (((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts->at(Pos).Duration ==
                            Duration_FrameCount_Max_Duration) {
                            ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts->erase(
                                    ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts->begin() +
                                    Pos);
                            Pos--;
                        }
                    }
                    ...
                    if (((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts->empty()) {
                        delete ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts;
                        ((File_DvDif *) Streams[moov_trak_tkhd_TrackID].Parsers[0])->Mpeg4_stts = NULL;
                    }
                }
#endif //MEDIAINFO_DVDIF_ANALYZE_YES
    ...
    void File_Mpeg4::moov_trak_mdia_minf_stbl_stts_Common(int32u SampleCount, int32u SampleDuration, int32u Pos,
                                                          int32u NumberOfEntries) {
        FILLING_BEGIN() ;
            ...
            if (Pos == 1 && NumberOfEntries >= 2 && NumberOfEntries <= 3 && Stream->second.stts_FrameCount == 1 &&
                Stts.SampleDuration != Stream->second.stts_Max && Stream->second.mdhd_TimeScale) {
            ...
            if (NumberOfEntries >= 2 && NumberOfEntries <= 3 && Pos + 1 == NumberOfEntries && Stts.SampleCount == 1 &&
                Stream->second.stts_Min == Stream->second.stts_Max && Stts.SampleDuration != Stream->second.stts_Max &&
                Stream->second.mdhd_TimeScale) {
            ...
            if (Stts.SampleDuration < 0x80000000)
                ...
                Stream->second.stts_Duration -=
                        Stts.SampleCount * (((int32u) -1) - Stts.SampleDuration + 1); //Negative value
            ...
            if (Streams[moov_trak_tkhd_TrackID].stts_Durations.empty())
                ...
                stream::stts_durations::iterator Previous = Streams[moov_trak_tkhd_TrackID].stts_Durations.end();
                --Previous;
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_trak_tkhd() {
        ...
        Element_Info1(moov_trak_tkhd_TrackID);
        Skip_B4("Reserved");
        Get_B_DEPENDOFVERSION(Duration, "Duration");
        if (moov_mvhd_TimeScale) {
            Param_Info2(Duration * 1000 / moov_mvhd_TimeScale, " ms");
            Element_Info2(Duration * 1000 / moov_mvhd_TimeScale, " ms");
        }
        Skip_B4("Reserved");
        Skip_B4("Reserved");
        Skip_B2("Layer");
        Get_B2(Alternate_Group, "Alternate group");
        Get_B2(Volume, "Volume");
        Param_Info1(Ztring::ToZtring(((float) Volume) / 256));
        Skip_B2("Reserved");
        Element_Begin1("Matrix structure");
        Get_BFP4(16, a, "a (width scale)");
        Get_BFP4(16, b, "b (width rotate)");
        ...
        FILLING_BEGIN() ;
            ...
            if (moov_mvhd_TimeScale)
                Fill(StreamKind_Last, StreamPos_Last, "Duration",
                     float64_int64s(((float64) Duration) * 1000 / moov_mvhd_TimeScale));
            Fill(StreamKind_Last, StreamPos_Last, "Encoded_Date", Date_Created);
            Fill(StreamKind_Last, StreamPos_Last, "Tagged_Date", Date_Modified);
            ...
            if (StreamIDs_Size > 1 && Config->File_ID_OnlyRoot_Get())
                StreamIDs_Width[StreamIDs_Size - 1] = Streams.size() <= 1 ? 0
                                                                          : 8; //If referenced file and more than 1 stream, referenced ID is discarded, else referenced ID is used
#endif //MEDIAINFO_EVENTS
        FILLING_END();
    }
...
//---------------------------------------------------------------------------
    void File_Mpeg4::moov_udta_chpl() {
        ...
        while (Element_Offset < Element_Size) {
            ...
            FILLING_BEGIN() ;
                Fill(Stream_Menu, StreamPos_Last, Ztring().Duration_From_Milliseconds(Time / 10000).To_Local().c_str(),
                     Value);
            FILLING_END();
                    ...
                    FILLING_BEGIN() ;
                        if (moov_trak_tkhd_TrackID == (int32u) -1) {
                            ...
                            if (Parameter != "Omud" // Some complex data is in Omud, but nothing interessant found
                                && Parameter !=
                                   "_SGI" // Found "_SGIxV4" with DM_IMAGE_PIXEL_ASPECT, in RLE, ignoring it for the moment
...
//---------------------------------------------------------------------------
    void File_Mpeg4::pnot() {
        ...
        //Parsing
        Info_B4(Date_Modified, "Modification date");
        Param_Info1(Ztring().Date_From_Seconds_1904(Date_Modified));
