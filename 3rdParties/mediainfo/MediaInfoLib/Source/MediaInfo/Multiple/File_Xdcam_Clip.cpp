...

        {
            ...
            if (Root) {
                ...
                if (Duration_Frames && EditUnit_Denominator)
                    Fill(Stream_General, 0, General_Duration, ((float32) Duration_Frames) * 1000 / EditUnit_Denominator,
                         0);
                ...
                if (File_Name.size() > 12
                    ...
                    if (MI.Open(MXF_File)) {
                        ...
                        Fill(Stream_General, 0, General_Format_Commercial_IfAny,
                             MI.Get(Stream_General, 0, General_Format_Commercial_IfAny));
                        ...
                        if (!Format_Commercial.empty()) {
                            ...
                            Fill(Stream_General, 0, General_Format_Commercial, __T("XDCAM Clip ") + Format_Commercial,
                                 true);
                        }
                    }
                    //else
