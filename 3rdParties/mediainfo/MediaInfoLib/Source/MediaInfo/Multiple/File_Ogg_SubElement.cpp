...
#define ELEMENT_CASE(_NAME) \
        ...
        if (0);
        ELEMENT_CASE(CELT)ELEMENT_CASE(CMML)ELEMENT_CASE(BBCD)ELEMENT_CASE(FLAC)ELEMENT_CASE(JNG)ELEMENT_CASE(
                kate)ELEMENT_CASE(KW_DIRAC)ELEMENT_CASE(OggMIDI)ELEMENT_CASE(MNG)ELEMENT_CASE(OpusHead)ELEMENT_CASE(
                PCM)ELEMENT_CASE(PNG)ELEMENT_CASE(Speex)ELEMENT_CASE(theora)ELEMENT_CASE(vorbis)ELEMENT_CASE(
                YUV4MPEG)ELEMENT_CASE(video)ELEMENT_CASE(audio)ELEMENT_CASE(text)ELEMENT_CASE(fLaC)ELEMENT_CASE(
                fishead)ELEMENT_CASE(fisbone)
        else {
            Skip_XX(Element_Size, "Unknown");
        ...
        if (0);
        ELEMENT_CASE(fishead)ELEMENT_CASE(fisbone)
        else
            Identified = true;
        Accept("OggSubElement");
        Element_Show();
...
//---------------------------------------------------------------------------
    void File_Ogg_SubElement::Identification_video() {
        ...
        if (0);
                                                  ...
                                                  Ztring().From_CC4(fccHandler)) == __T("MPEG-4 Visual")) {
