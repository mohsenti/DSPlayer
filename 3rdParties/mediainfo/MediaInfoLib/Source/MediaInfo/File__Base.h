...
//***************************************************************************
    ...
    public :
        ...
        void
        Init(MediaInfo_Config_MediaInfo *Config, string *Details, std::vector<std::vector<ZtringList> > *Stream_ = NULL,
             std::vector<std::vector<ZtringListList> > *Stream_More = NULL);
        ...
        virtual const Ztring &
        Get(stream_t StreamKind, size_t StreamNumber, const Ztring &Parameter, info_t KindOfInfo = Info_Text,
            info_t KindOfSearch = Info_Name);

        //Set information
        int Set(stream_t StreamKind, size_t StreamNumber, size_t Parameter, const Ztring &ToSet,
                const Ztring &OldValue = __T(""));

        int Set(stream_t StreamKind, size_t StreamNumber, const Ztring &Parameter, const Ztring &ToSet,
                const Ztring &OldValue = __T(""));
    ...
    protected :
        ...
        //Write
        virtual int
        Write(stream_t /*StreamKind*/, size_t /*StreamNumber*/, const Ztring &/*Parameter*/, const Ztring &/*ToSet*/,
              const Ztring &/*OldValue*/) { return -1; } //Write the value in memory
